...
**Result:** 🔴 0 · 🟡 153 · 🟢 2  
**Design Debt Score:** `3288`  
**Token Coverage:** `83.3%` (279 distinct colors / 88 tokens / 863 files)  
...
| 4 | 373 | web_app | `frontend\web_app\src\styles\globals.css` | 572 | 61 | 0 | off-color×61, px×899 |
| 5 | 372 | web_app | `frontend\web_app\src\components\BannerCanvasEditor.tsx` | 133 | 54 | 33 | inline×33, off-color×54, tw-arb-size×45, z-magic, px×10 |
...
| 8 | 288 | mobile_app | `frontend\mobile_app\app\invoice.tsx` | 0 | 0 | 77 | inline×77, px×43 |
| 9 | 288 | mobile_app | `frontend\mobile_app\app\logistics-partner\dashboard.tsx` | 20 | 2 | 83 | inline×83, off-color×2, px×23 |
| 10 | 274 | mobile_app | `frontend\mobile_app\app\(tabs)\products\index.tsx` | 6 | 0 | 68 | inline×68, px×62 |
| 11 | 273 | web_app | `frontend\web_app\src\components\admin\commandCenter\hud.tsx` | 12 | 8 | 62 | inline×62, off-color×8, tw-arb-size×43, px×2 |
...
| 39 | 131 | mobile_app | `frontend\mobile_app\components\MobileBackgroundEffect.tsx` | 36 | 9 | 15 | inline×15, off-color×9, px×36 |
...
| 45 | 118 | mobile_app | `frontend\mobile_app\app\(tabs)\_layout.tsx` | 18 | 1 | 34 | inline×34, off-color×1, px×8 |
...
| 48 | 111 | mobile_app | `frontend\mobile_app\app\admin\products.tsx` | 10 | 0 | 26 | inline×26, px×21 |
| 49 | 108 | mobile_app | `frontend\mobile_app\components\ProductCard.tsx` | 26 | 7 | 26 | inline×26, off-color×7, px×2 |
| 50 | 107 | mobile_app | `frontend\mobile_app\app\supplier\orders.tsx` | 0 | 0 | 35 | inline×35, px×2 |
| 51 | 106 | shared | `frontend\shared\src\components\ui\ErrorBoundary.tsx` | 17 | 10 | 11 | inline×11, off-color×10, px×21 |
| 52 | 106 | mobile_app | `frontend\mobile_app\app\tickets.tsx` | 6 | 0 | 34 | inline×34, px×4 |
| 53 | 106 | mobile_app | `frontend\mobile_app\app\admin\banners.tsx` | 6 | 0 | 32 | inline×32, px×8 |
| 54 | 105 | mobile_app | `frontend\mobile_app\app\supplier\invoices.tsx` | 6 | 0 | 33 | inline×33, px×4 |
| 55 | 105 | mobile_app | `frontend\mobile_app\app\returns\[id].tsx` | 0 | 0 | 25 | inline×25, px×22 |
| 56 | 101 | mobile_app | `frontend\mobile_app\app\supplier\reports.tsx` | 7 | 0 | 33 | inline×33, px×2 |
| 57 | 100 | web_app | `frontend\web_app\src\app\supplier\upload\bg-compare\page.tsx` | 16 | 16 | 9 | inline×9, off-color×16, tw-arb-size×9 |
| 58 | 99 | mobile_app | `frontend\mobile_app\app\help.tsx` | 1 | 0 | 31 | inline×31, px×4 |
| 59 | 99 | mobile_app | `frontend\mobile_app\app\admin\invoices.tsx` | 13 | 0 | 30 | inline×30, px×7 |
| 60 | 98 | web_app | `frontend\web_app\src\app\admin\treasury\_components\treasury-content.tsx` | 0 | 0 | 3 | inline×3, tw-arb-size×89 |

## Color Inventory (most used first)

| Color | Hex | Usage | Files | Palette status |
|---|---|---:|---:|---|
| ![#ffffff](https://via.placeholder.com/14/ffffff/ffffff) | `#ffffff` | 559 | 98 | ✅ token |
| ![#000000](https://via.placeholder.com/14/000000/000000) | `#000000` | 254 | 59 | ✅ token |
...
| ![#f59e0b](https://via.placeholder.com/14/f59e0b/f59e0b) | `#f59e0b` | 65 | 33 | ✅ token |
...
| ![#2563eb](https://via.placeholder.com/14/2563eb/2563eb) | `#2563eb` | 13 | 7 | ✅ token |
| ![#0ea5e9](https://via.placeholder.com/14/0ea5e9/0ea5e9) | `#0ea5e9` | 12 | 4 | ✅ token |
...
- `#2a7006` ×7 ≈ `#2d6a04` ×1
- `#e5e5e5` ×1 ≈ `#e5e7eb` ×7
- `#f1f5f9` ×3 ≈ `#f3f4f6` ×1 ≈ `#f5f5f5` ×4
- `#ca8a04` ×2 ≈ `#d08c00` ×5
- `#eeeeee` ×5 ≈ `#efefef` ×1 ≈ `#f0f0f0` ×1
- `#f8c400` ×6 ≈ `#ffc400` ×1
- `#060e1c` ×2 ≈ `#080d18` ×3 ≈ `#080d1a` ×1
...
|---|---|---|---|---|---|
| 🟡 | DS03 | design | `frontend\web_app\src\styles\globals.css` | off-palette color #2fb43d used 24× in 2 file(s): frontend\web_app\src\styles\globals.css, frontend\web_app\src\styles\glow.css | replace with the nearest design token, or add it to the palette with an ADR if it is a new brand color |
...
| 🟡 | DS03 | design | `frontend\web_app\src\app\supplier\bulk\draftUtils.ts` | off-palette color #1e3a8a used 3× in 2 file(s): frontend\web_app\src\app\supplier\bulk\draftUtils.ts, frontend\web_app\src\styles\globals.css | replace with the nearest design token, or add it to the palette with an ADR if it is a new brand color |
...
| 🟡 | DS13 | mobile_app/shared/web_app | `frontend\web_app\src\components\BannerCanvasEditor.tsx, frontend\web_app\src\styles\globals.css` | color drift (8× total): #f1f5f9 (×3) ≈ #f3f4f6 (×1) ≈ #f5f5f5 (×4) | web and mobile disagree on this color — unify in shared tokens |
...
| 🟡 | DS13 | mobile_app/shared | `frontend\mobile_app\app\supplier\label.tsx, frontend\mobile_app\lib\printStyles.ts` | color drift (7× total): #eeeeee (×5) ≈ #efefef (×1) ≈ #f0f0f0 (×1) | web and mobile disagree on this color — unify in shared tokens |
...
| 🟡 | DS13 | mobile_app/web_app | `frontend\web_app\src\styles\globals.css, frontend\web_app\src\styles\glow.css` | color drift (6× total): #060e1c (×2) ≈ #080d18 (×3) ≈ #080d1a (×1) | web and mobile disagree on this color — unify in shared tokens |
...
- 🟢 **DSI2** `frontend` — token coverage: 83.3% of color occurrences match the palette (1840/2208, 279 distinct colors)
- 🟡 **DS03** `frontend\web_app\src\styles\globals.css` — off-palette color #2fb43d used 24× in 2 file(s): frontend\web_app\src\styles\globals.css, frontend\web_app\src\styles\glow.css → *replace with the nearest design token, or add it to the palette with an ADR if it is a new brand color*
...
- 🟡 **DS03** `frontend\web_app\src\app\supplier\bulk\draftUtils.ts` — off-palette color #1e3a8a used 3× in 2 file(s): frontend\web_app\src\app\supplier\bulk\draftUtils.ts, frontend\web_app\src\styles\globals.css → *replace with the nearest design token, or add it to the palette with an ADR if it is a new brand color*
...
- 🟢 **DSI1** `frontend` — top colors in use: #ffffff×559, #000000×254, #ef4444×108, #22c55e×81, #f59e0b×65, #0f172a×52, #3b82f6×47, #32cd32×35, #d4af37×31, #6b7280×30
...
- 🟡 **DS08** `frontend\web_app\src\components\banner-effects.css` — 23 raw px value(s) — hardcoded spacing/sizing → *use the spacing scale (p-2/gap-4...) or RN spacing tokens*
