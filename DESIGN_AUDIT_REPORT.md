...
**Result:** 🔴 0 · 🟡 158 · 🟢 2  
**Design Debt Score:** `3403`  
**Token Coverage:** `83.1%` (279 distinct colors / 88 tokens / 835 files)  
...
| 4 | 397 | web_app | `frontend\web_app\src\styles\globals.css` | 594 | 67 | 0 | off-color×67, px×924 |
...
| 49 | 110 | mobile_app | `frontend\mobile_app\app\supplier\label.tsx` | 12 | 3 | 27 | inline×27, off-color×3, px×9 |
...
|---|---|---:|---:|---|
| ![#ffffff](https://via.placeholder.com/14/ffffff/ffffff) | `#ffffff` | 559 | 95 | ✅ token |
...
| ![#32cd32](https://via.placeholder.com/14/32cd32/32cd32) | `#32cd32` | 36 | 14 | ✅ token |
...
| ![#111111](https://via.placeholder.com/14/111111/111111) | `#111111` | 17 | 10 | ✅ token |
...
| ![#2563eb](https://via.placeholder.com/14/2563eb/2563eb) | `#2563eb` | 13 | 6 | ✅ token |
...
| ![#cccccc](https://via.placeholder.com/14/cccccc/cccccc) | `#cccccc` | 8 | 5 | 🔴 OFF-PALETTE |
...
- `#1a1a1a` ×6 ≈ `#1c1917` ×5
- `#ffd440` ×4 ≈ `#ffd740` ×7
- `#eeeeee` ×6 ≈ `#efefef` ×1 ≈ `#f0f0f0` ×2
- `#f1f5f9` ×3 ≈ `#f3f4f6` ×1 ≈ `#f5f5f5` ×5
- `#2a7006` ×7 ≈ `#2d6a04` ×1
- `#e5e5e5` ×1 ≈ `#e5e7eb` ×7
...
| 🟡 | DS03 | design | `frontend\mobile_app\lib\invoiceService.ts` | off-palette color #cccccc used 8× in 5 file(s): frontend\mobile_app\lib\invoiceService.ts, frontend\mobile_app\lib\invoice_print.css, frontend\web_app\src\app\supplier\bulk\components\ColorPickerField.tsx, frontend\web_app\src\app\supplier\products\add\page.tsx +1 more | replace with the nearest design token, or add it to the palette with an ADR if it is a new brand color |
...
| 🟡 | DS03 | design | `frontend\mobile_app\app\supplier\label.tsx` | off-palette color #666666 used 4× in 4 file(s): frontend\mobile_app\app\supplier\label.tsx, frontend\mobile_app\app\supplier\label_print.css, frontend\mobile_app\lib\invoiceService.ts, frontend\mobile_app\lib\invoice_print.css | replace with the nearest design token, or add it to the palette with an ADR if it is a new brand color |
...
| 🟡 | DS13 | mobile_app/shared | `frontend\mobile_app\app\supplier\label.tsx, frontend\mobile_app\lib\invoiceService.ts, frontend\mobile_app\lib\invoice_p` | color drift (9× total): #eeeeee (×6) ≈ #efefef (×1) ≈ #f0f0f0 (×2) | web and mobile disagree on this color — unify in shared tokens |
| 🟡 | DS13 | mobile_app/shared/web_app | `frontend\web_app\src\components\BannerCanvasEditor.tsx, frontend\web_app\src\styles\globals.css` | color drift (9× total): #f1f5f9 (×3) ≈ #f3f4f6 (×1) ≈ #f5f5f5 (×5) | web and mobile disagree on this color — unify in shared tokens |
...
- 🟢 **DSI2** `frontend` — token coverage: 83.1% of color occurrences match the palette (1845/2220, 279 distinct colors)
...
- 🟡 **DS03** `frontend\shared\src\components\logo\LogoAnimation.tsx` — off-palette color #3d8018 used 4× in 2 file(s): frontend\shared\src\components\logo\LogoAnimation.tsx, frontend\shared\src\logo\LogoAnimation.tsx → *replace with the nearest design token, or add it to the palette with an ADR if it is a new brand color*
- 🟡 **DS03** `frontend\web_app\src\components\BannerCanvasEditor.tsx` — off-palette color #60a5fa used 4× in 2 file(s): frontend\web_app\src\components\BannerCanvasEditor.tsx, frontend\web_app\src\components\admin\commandCenter\hud.tsx → *replace with the nearest design token, or add it to the palette with an ADR if it is a new brand color*
- 🟡 **DS03** `frontend\mobile_app\app\supplier\label.tsx` — off-palette color #666666 used 4× in 4 file(s): frontend\mobile_app\app\supplier\label.tsx, frontend\mobile_app\app\supplier\label_print.css, frontend\mobile_app\lib\invoiceService.ts, frontend\mobile_app\lib\invoice_print.css → *replace with the nearest design token, or add it to the palette with an ADR if it is a new brand color*
...
- 🟡 **DS07** `frontend` — 59 distinct hardcoded font sizes: 0.75rem, 0.7rem, 0.875rem, 1.05rem, 1.125rem, 1.15rem, 1.25rem, 1.35rem, 1.5rem, 1.6rem, 1.7rem, 1.875rem ... → *collapse onto a type scale (text-xs/sm/base/lg/xl...); max ~8 steps*
...
- 🟢 **DSI1** `frontend` — top colors in use: #ffffff×559, #000000×254, #ef4444×108, #22c55e×81, #f59e0b×65, #0f172a×52, #3b82f6×47, #32cd32×36, #d4af37×31, #6b7280×30
...
- 🟡 **DS08** `frontend\web_app\src\styles\globals.css` — 924 raw px value(s) — hardcoded spacing/sizing → *use the spacing scale (p-2/gap-4...) or RN spacing tokens*
...
- 🟡 **DS08** `frontend\mobile_app\app\supplier\label_print.css` — 22 raw px value(s) — hardcoded spacing/sizing → *use the spacing scale (p-2/gap-4...) or RN spacing tokens*
