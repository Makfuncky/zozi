"""Q1 rescue test — logistics controller.
...
_LOGISTICS_FILE = "controllers/logistics_controller.py"


def test_logistics_controller_has_no_session_reads() -> None:
    """Q1: the controller must not call db.query/execute/get directly."""
    assert_no_session_reads(_LOGISTICS_FILE)


def test_logistics_controller_delegates_to_db_read() -> None:
    """Read helpers must be imported from the shared services.db_read layer."""
    assert_imports_db_read(_LOGISTICS_FILE)
