"""Q1 rescue test — cross_border router.
...
_MODULE = "routers.public_cross_border_access"
_ROUTER_FILE = _BACKEND_ROOT / "routers" / "public_cross_border_access.py"
...
def test_router_has_no_session_reads() -> None:
    ...
    assert not violations, f"cross_border still reads via db: {violations}"
...
def test_router_delegates_to_db_read() -> None:
    ...
    assert imported, "cross_border does not import from services.db_read"
