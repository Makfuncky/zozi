"""Q1 rescue test — employees_controller.
...
def test_no_session_reads():
    assert_no_session_reads("controllers/employees_controller.py")


def test_delegates_to_db_read():
    assert_imports_db_read("controllers/employees_controller.py")
