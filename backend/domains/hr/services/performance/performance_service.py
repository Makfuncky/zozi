...
def create_objective(
    ...
    # Add key results if provided (single executemany round-trip)
...
# === Merged from accounts/services/performance_service.py ===
...
def compute_health_endpoint(employee_id: int, db: Session, current_user: dict):
    ...
    from domains.governance.services.performance_service import compute_performance_health
...
def create_kpi_endpoint(body: KpiCreate, db: Session, current_user: dict):
    ...
    from domains.governance.services.performance_service import create_kpi_metric
...
def create_objective_endpoint(body: ObjectiveCreate, db: Session, current_user: dict):
    ...
    from domains.governance.services.performance_service import create_objective
...
def get_employee_reviews_endpoint(employee_id: int, review_cycle: Optional[str], db: Session, current_user: dict):
    ...
    from domains.governance.services.performance_service import get_employee_reviews
...
def get_kpi_dashboard_endpoint(employee_id: int, db: Session, current_user: dict):
    ...
    from domains.governance.services.performance_service import get_kpi_dashboard
...
def get_objective_tree_endpoint(objective_id: int, db: Session, current_user: dict):
    ...
    from domains.governance.services.performance_service import get_objective_tree
...
def health_board_endpoint(manager_employee_id: int, department: Optional[str], db: Session, current_user: dict):
    ...
    from domains.governance.services.performance_service import get_performance_health_board
...
def record_kpi_value_endpoint(kpi_id: int, body: KpiValueUpdate, db: Session, current_user: dict):
    ...
    from domains.governance.services.performance_service import record_kpi_value
...
def submit_review_endpoint(body: ReviewSubmit, db: Session, current_user: dict):
    ...
    from domains.governance.services.performance_service import submit_performance_review
...
def update_objective_progress_endpoint(objective_id: int, body: ObjectiveProgressUpdate, db: Session, current_user: dict):
    ...
    from domains.governance.services.performance_service import update_objective_progress
