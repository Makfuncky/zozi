...
def _handle_background_check_step(
    ...
    from domains.hr.services.background_check import run_background_check
    from domains.hr.services.background_check import BACKGROUND_CHECK_FLAGGED
    from domains.hr.services.background_check import BACKGROUND_CHECK_CLEAR
