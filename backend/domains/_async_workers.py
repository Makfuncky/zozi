...
Usage:
    from domains._async_workers import (
...
Canonical home relocated from ``infrastructure.utils.async_workers`` (P6
infrastructure->providers inversion cleanup). The domain layer is permitted
to wrap ``providers.*`` leaf services below.
"""
...
__all__ = [
    "remove_background_async",
    "batch_remove_background_async",
    "analyze_product_image_async",
    "batch_analyze_images_async",
    "embed_text_async",
    "batch_embed_text_async",
    "parse_bill_async",
    "search_products_async",
    "parallel_process_product_async",
    "full_supplier_pipeline_async",
    "ConcurrencyManager",
    "concurrency",
    "process_large_batch_async",
]
