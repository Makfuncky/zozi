...
# -------------------------------------------------------------------
# FROM: logistics_partner_routers_service.py
# -------------------------------------------------------------------
...
from domains.orders.services.logistics_partner_service import (
    review_logistics_partner_service_area, create_logistics_partner_service_area,
    update_logistics_partner_service_area, delete_logistics_partner_service_area,
)

# Constants defined locally in this module
