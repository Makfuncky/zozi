"""Returns sub-domain — return request management, refunds, and supplier review.

Merged from: returns_service.py, returns_legacy_service.py, returns_write_service.py
"""
