...
# Allow `from domains.orders.services.trading_service import trading_service`
# to resolve to this module object (routers call it as `trading.create_*`).
trading_service = _sys.modules[__name__]
