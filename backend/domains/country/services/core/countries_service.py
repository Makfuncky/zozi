...
from domains.country.services.core.country_service import auto_populate_async as _auto_populate_async
...
async def auto_populate_country(body: AutoPopulateBody, current_user: dict, db: Session):
    ...
    return await _auto_populate_async(body.search_term)
