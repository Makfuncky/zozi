...
class CountryFeatureFlag(Base):
    ...
    __table_args__ = (UniqueConstraint('country_code', 'feature_key', name='uq_country_feature'), Index('ix_country_feature_flags_country_created', 'country_code', 'created_at'), {'schema': 'country'})
...
class CountryStaffAssignment(Base):
    ...
    created_by = Column(Integer, nullable=True, index=True)
    updated_by = Column(Integer, nullable=True, index=True)
    __table_args__ = (UniqueConstraint('user_id', 'country_code', name='uq_staff_country'), Index('ix_staff_user', 'user_id'), Index('ix_country_staff_assignments_country_created', 'country_code', 'created_at'), {'schema': 'country'})
    id = Column(Integer, primary_key=True, index=True)
...
class CountryConfigVersion(Base):
    ...
    created_by = Column(Integer, nullable=True, index=True)
    updated_by = Column(Integer, nullable=True, index=True)
    __table_args__ = (Index('ix_country_config_version_type', 'config_type'), Index('ix_country_config_version_status', 'status'), Index('ix_country_config_versions_country_created', 'country_code', 'created_at'), {'schema': 'country'})
    id = Column(Integer, primary_key=True, index=True)
    country_code = Column(String(2), nullable=False)
...
class CountryLocalization(Base):
    ...
    created_by = Column(Integer, nullable=True, index=True)
    updated_by = Column(Integer, nullable=True, index=True)
    __table_args__ = (UniqueConstraint('country_code', name='uq_country_localization'), Index('ix_country_localization_country_created', 'country_code', 'created_at'), {'schema': 'country'})
    id = Column(Integer, primary_key=True, index=True)
...
class CountryPaymentAlias(Base):
    ...
    created_by = Column(Integer, nullable=True, index=True)
    updated_by = Column(Integer, nullable=True, index=True)
    __table_args__ = (UniqueConstraint('country_code', 'alias_type', name='uq_country_payment_alias'), Index('ix_country_payment_aliases_country_created', 'country_code', 'created_at'), {'schema': 'country'})
    id = Column(Integer, primary_key=True, index=True)
    country_code = Column(String(2), nullable=False)
...
class CountryLegalContract(Base):
    ...
    created_by = Column(Integer, nullable=True, index=True)
    updated_by = Column(Integer, nullable=True, index=True)
    __table_args__ = (UniqueConstraint('country_code', 'contract_type', name='uq_country_legal_contract'), Index('ix_country_legal_contracts_country_created', 'country_code', 'created_at'), {'schema': 'country'})
    id = Column(Integer, primary_key=True, index=True)
    country_code = Column(String(2), nullable=False)
...
class CountryCategoryTaxRate(Base):
    ...
    created_by = Column(Integer, nullable=True, index=True)
    updated_by = Column(Integer, nullable=True, index=True)
    __table_args__ = (UniqueConstraint('country_code', 'category_id', name='uq_country_category_tax'), Index('ix_country_category_tax_rates_country_created', 'country_code', 'created_at'), {'schema': 'country'})
    id = Column(Integer, primary_key=True, index=True)
    country_code = Column(String(2), nullable=False)
...
class CountryHolidayCalendar(Base):
    ...
    created_by = Column(Integer, nullable=True, index=True)
    updated_by = Column(Integer, nullable=True, index=True)
    __table_args__ = (Index('ix_country_holiday_date', 'holiday_date'), Index('ix_country_holiday_calendars_country_created', 'country_code', 'created_at'), {'schema': 'country'})
    id = Column(Integer, primary_key=True, index=True)
    country_code = Column(String(2), nullable=False)
...
class CountryGatewayConfig(Base):
    ...
    created_by = Column(Integer, nullable=True, index=True)
    updated_by = Column(Integer, nullable=True, index=True)
    __table_args__ = (UniqueConstraint('country_code', 'gateway_id', name='uq_country_gateway'), Index('ix_country_gateway_configs_country_created', 'country_code', 'created_at'), {'schema': 'country'})
    id = Column(Integer, primary_key=True, index=True)
    country_code = Column(String(2), nullable=False)
...
class CountryCommunicationThread(Base):
    ...
    created_by = Column(Integer, nullable=True, index=True)
    updated_by = Column(Integer, nullable=True, index=True)
    __table_args__ = (Index('ix_comm_thread_entity', 'entity_type', 'entity_id'), Index('ix_country_communication_threads_country_created', 'country_code', 'created_at'), {'schema': 'country'})
    id = Column(Integer, primary_key=True, index=True)
    country_code = Column(String(2), nullable=False)
...
class CountryCommissionRateHistory(Base):
    ...
    created_by = Column(Integer, nullable=True, index=True)
    updated_by = Column(Integer, nullable=True, index=True)
    __table_args__ = (Index('ix_comm_rate_effective', 'effective_from'), Index('ix_country_commission_rate_history_country_created', 'country_code', 'created_at'), {'schema': 'country'})
    id = Column(Integer, primary_key=True, index=True)
    country_code = Column(String(2), nullable=False)
...
class CountryLogisticsZone(Base):
    ...
    created_by = Column(Integer, nullable=True, index=True)
    updated_by = Column(Integer, nullable=True, index=True)
    __table_args__ = (UniqueConstraint('country_code', 'zone_code', name='uq_zone_code'), Index('ix_country_logistics_zones_country_created', 'country_code', 'created_at'), {'schema': 'country'})
    id = Column(Integer, primary_key=True, index=True)
    country_code = Column(String(2), nullable=False)
...
class CountryPayoutRule(Base):
    ...
    created_by = Column(Integer, nullable=True, index=True)
    updated_by = Column(Integer, nullable=True, index=True)
    __table_args__ = (Index('ix_payout_supplier', 'supplier_tier'), Index('ix_country_payout_rules_country_created', 'country_code', 'created_at'), {'schema': 'country'})
    id = Column(Integer, primary_key=True, index=True)
    country_code = Column(String(2), nullable=False)
