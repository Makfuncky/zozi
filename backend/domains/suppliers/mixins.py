"""suppliers domain — ORM mixin columns (Law 6 schema discipline).

Shared column contracts for supplier-domain models. Mirrors the comms-domain
mixin set but lives here so the suppliers domain has no upward dependency on
comms for its own model definitions.
"""
