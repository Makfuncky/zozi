...
from domains.customers.services.cart_write_service import get_cart_item_by_variant
from domains.customers.services.cart_write_service import get_products_by_ids
