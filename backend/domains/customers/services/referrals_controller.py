...
from domains.customers.services.referrals_service import get_or_create_referral_code as svc_get_or_create_referral_code
from domains.customers.services.referrals_service import get_referral_config as svc_get_referral_config
import structlog
