...
class AdvancedFilterService:
    ...
    def _get_ratings(self, base_query) -> List[Dict[str, Any]]:
        ...
        return [
            {"min_rating": 4, "label": "4â˜… & up", "count": distribution.get("4_stars", 0)},
            {"min_rating": 3, "label": "3â˜… & up", "count": distribution.get("3_stars", 0)},
            {"min_rating": 2, "label": "2â˜… & up", "count": distribution.get("2_stars", 0)},
            {"min_rating": 1, "label": "1â˜… & up", "count": distribution.get("1_star", 0)},
        ]
