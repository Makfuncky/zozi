...
NOTE: moved from ``infrastructure/utils/category_tree.py`` to comply with
ARCHITECTURE_DIAGRAM.md Law 1 (no infrastructure → domain imports). The
old shim is kept under ``infrastructure/utils`` for backward compatibility
and re-exports from this canonical location.
"""
