# Live BOGO promotion engine (merged from _parked/promotion_bogo_service.py).
# Historical archive retained at domains/_parked/promotion_bogo_service.py.
# See RESOLVER.md PART 5 / Sec 37.5 (PARKED-BOGO merge).
# Imports already resolve to the live catalog.ports.BOGOPromotion model.
