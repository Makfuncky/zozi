...
class Category(Base):
    ...
    parent_id = Column(Integer, ForeignKey("catalog.categories.id", ondelete='CASCADE'), nullable=True)
...
class Product(Base):
    ...
    category_id = Column(Integer, ForeignKey("catalog.categories.id", ondelete='RESTRICT'), nullable=True)
