...
class OnboardingStep(Base):
    ...
    __table_args__ = ({"schema": "hr"},)
    id = Column(Integer, primary_key=True, index=True)
    pipeline_id = Column(Integer, ForeignKey("hr.onboarding_pipelines.id", ondelete='CASCADE'), nullable=False)
...
class DocumentVerification(Base):
    ...
    verifier_id = Column(Integer, ForeignKey("governance.users.id", ondelete='SET NULL'), nullable=True)
...
class OCRResult(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    document_verification_id = Column(Integer, ForeignKey("security.document_verifications.id", ondelete='CASCADE'), nullable=False, unique=True)
...
class KYCVerification(Base):
    ...
    reviewer_id = Column(Integer, ForeignKey("governance.users.id", ondelete='SET NULL'), nullable=True)
