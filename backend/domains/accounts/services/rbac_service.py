...
class RBACService:
    ...
    def can_approve_resource(
        ...
        from domains.accounts.services.approval_matrix_service import can_approve as _can_approve
    ...
    def resolve_resource_approvers(
        ...
        from domains.accounts.services.approval_matrix_service import resolve_approvers as _resolve
    ...
    def get_resource_approval_chain(
        ...
        from domains.accounts.services.approval_matrix_service import get_approval_chain as _chain
