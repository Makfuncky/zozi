"""Business logic extracted from routers/public_commerce_validation.py."""
from __future__ import annotations
from domains.orders.services.coupons_write_service import _to_int
from domains.orders.services.coupons_write_service import _to_decimal
