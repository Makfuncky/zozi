"""Auto-migrated service logic from routers/country_maps.py."""
...
from models import CountryCity, CountryConfig, CountryMapConfig

logger = logging.getLogger(__name__)

def get_country_map(country_code: str, include_cities: bool, db: Session):
...
def get_country_map_config(country_code: str, db: Session):
