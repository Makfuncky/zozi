"""Auto-migrated service logic from routers/supplier_products.py."""
...
def update_product_discount(product_id: int, payload: dict, current_user, db: Session):
...
def update_supplier_product(product_id: int, payload: dict, current_user, db: Session):
