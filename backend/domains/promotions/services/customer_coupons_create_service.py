"""Customer coupon lifecycle controller (promotions domain).

Thin facade used by the promotions coupon service. Coupon storage lives in
governance; this module provides the `delete_coupon` symbol the promotions
package expects, delegating to the governance coupons surface. Degrades
gracefully (Law 30) if the backing coupon record is unavailable.
"""
