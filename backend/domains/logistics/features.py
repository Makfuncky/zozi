...
FEATURES: dict[str, dict] = {
    ...
    "logistics.profile.read": {
        "label": "View Logistics Profile",
        "risk": "low",
        "actions": ["read"],
        "description": "View logistics partner / driver / vehicle profile details.",
    },
    "logistics.profile.write": {
        "label": "Update Logistics Profile",
        "risk": "medium",
        "actions": ["read", "create", "update"],
        "description": "Create or update logistics partner / driver / vehicle profiles.",
    },
}
