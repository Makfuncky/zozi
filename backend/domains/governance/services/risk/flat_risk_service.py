...
from domains.hr.models.employee_models import Employee, EmployeeAttendance, GeoFenceLog, EmployeeRelation, COIReport
...
def update_flight_risk_score(employee_id: int, metric: str, score: float, db: Session) -> dict:
    ...
    """
    from domains.governance.services.risk.risk_write_service import update_flight_risk_score as _svc
