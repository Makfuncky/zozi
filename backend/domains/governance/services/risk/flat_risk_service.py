...
_LAZY_CROSS_DOMAIN_MODELS: dict[str, tuple[str, str]] = {
    ...
    "EmployeeAttendance": ("domains.hr.models.employee_models", "EmployeeAttendance"),
    "GeoFenceLog": ("domains.hr.models.employee_models", "GeoFenceLog"),
    "EmployeeRelation": ("domains.hr.models.employee_models", "EmployeeRelation"),
    "COIReport": ("domains.hr.models.employee_models", "COIReport"),
}
...
def update_flight_risk_score(employee_id: int, metric: str, score: float, db: Session) -> dict:
    ...
    """
    from domains.governance.ports import update_flight_risk_score as _svc
