"""Misc write operations — moved from infrastructure/utils/misc_write.py.

Provides generic soft-delete, restore, hard-delete, and demo-data reset.
Lives in governance domain because it imports governance, catalog, finance, and comms models.
"""
