...
Cross-cutting technical utility (infrastructure/utils/) used by module routers to
execute configurable business-process workflows. Lives in infrastructure because
it is domain-agnostic and depends only on governance ports (SystemSetting).
"""
