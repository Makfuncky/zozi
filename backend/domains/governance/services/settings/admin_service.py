...
from domains.governance.services.logistics.admin_logistics_operations_service import BulkOrderStatusBody
from domains.governance.services.logistics.admin_logistics_operations_service import PromotionTierBody
from domains.governance.services.logistics.admin_logistics_operations_service import BulkToggleActiveBody
from domains.governance.services.logistics.admin_logistics_operations_service import BulkProductDeleteBody
from domains.governance.services.logistics.admin_logistics_operations_service import BulkSupplierVerifyBody
from domains.governance.services.logistics.admin_logistics_operations_service import ResetPasswordBody
from domains.governance.services.logistics.admin_logistics_operations_service import UpdateRolePermissionsIn
from domains.governance.services.logistics.admin_logistics_operations_service import PromotionTierUpdateBody
from domains.governance.services.logistics.admin_logistics_operations_service import BulkSupplierLifecycleBody
from domains.governance.services.logistics.admin_logistics_operations_service import PromotionConfigBody
from domains.governance.services.logistics.admin_logistics_operations_service import AdminDisputeBulkActionBody
from domains.governance.services.logistics.admin_logistics_operations_service import BulkOrderDeleteBody
from domains.governance.services.logistics.admin_logistics_operations_service import BulkProductModerationBody
from domains.governance.services.logistics.admin_logistics_operations_service import ResourceApprovalCheckIn
...
from domains.governance.services.products.products_service import (
...
from domains.governance.services.orders.orders_service import (
...
from domains.governance.services.commerce.admin_commerce_configuration_service import (
    create_coupon,
    list_coupons,
)
...
from domains.governance.services.analytics.analytics_service import (
    get_analytics,
...
from accounts.ports import download_export_job_result
from accounts.ports import export_audit_logs_csv
from accounts.ports import export_coupons_csv
from accounts.ports import export_orders_csv
from accounts.ports import export_products_csv
from accounts.ports import export_transfer_csv
from accounts.ports import export_users_csv
from accounts.ports import queue_export_job
from domains.orders.ports import get_promotion_config, list_promotion_tiers, preview_order_tier_discount
from orders.ports import get_promotion_config, list_promotion_tiers, preview_order_tier_discount
...
from domains.orders.ports import create_promotion_tier, delete_promotion_tier, get_promotion_config, list_promotion_tiers, preview_order_tier_discount, update_promotion_config, update_promotion_tier
...
from domains.hr.ports import backfill_authority_levels
...
from domains.hr.ports import reassign_manager
from domains.hr.ports import can_manage
...
from domains.orders.ports import get_all_flash_sales
from domains.orders.ports import create_flash_sale, delete_flash_sale, get_all_flash_sales, update_flash_sale
...
from domains.governance.ports import set_user_role
...
from domains.governance.services.logistics.admin_logistics_operations_service import verify_payout_route
from domains.governance.services.country.admin_geography_audit_service import generate_legal_contract
from domains.governance.services.country.admin_geography_audit_service import list_staff

from domains.governance.services.commerce.admin_commerce_configuration_service import list_flash_sales



# === Merged from accounts/services/admin_service.py ===
