...
def get_all_products(
    ...
    if filter_value == "deleted":
        ...
        if filter_value == "pending":
            query = query.filter(Product.moderation_status.in_(["pending", ""]))
        elif filter_value == "approved":
            query = query.filter(Product.moderation_status == "approved")
        elif filter_value == "rejected":
            query = query.filter(Product.moderation_status == "rejected")
