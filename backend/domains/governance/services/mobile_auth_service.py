...
from domains.accounts.services.iam_service import generate_qr_code
...
class MobileAuthService:
    ...
    def validate_biometric(
        ...
        from domains.governance.services.biometric_auth import BiometricAuthService
    ...
    def geo_fenced_check_in(
        ...
        from domains.logistics.services.geo_fence_service import GeoFenceService
