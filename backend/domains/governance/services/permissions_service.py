...
from infrastructure.utils.staff_permissions import (
    DEFAULT_ROLE_PERMISSION_MAP,
    KNOWN_ROLE_PERMISSIONS,
    default_permissions_for_role,
)

# Runtime-overridable singleton (mutated by load_role_permission_settings).
ROLE_PERMISSION_MAP: dict[str, set[str]] = {
    role: set(permissions) for role, permissions in DEFAULT_ROLE_PERMISSION_MAP.items()
}
