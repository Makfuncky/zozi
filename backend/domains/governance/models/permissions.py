...
class Permission(Base):
    ...
    __table_args__ = ({"schema": "governance"},)
    id = Column(Integer, primary_key=True, index=True)
    category_id = Column(Integer, ForeignKey("governance.permission_categories.id"), nullable=False)
...
class RolePermissionAssignment(Base):
    ...
    permission_id = Column(Integer, ForeignKey("governance.permissions.id"), nullable=False)
...
class PermissionAuditLog(Base):
    ...
    permission_id = Column(Integer, ForeignKey("governance.permissions.id"), nullable=True)
