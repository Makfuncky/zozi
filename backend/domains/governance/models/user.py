...
class User(Base):
    ...
    referred_by_user_id = Column(Integer, ForeignKey("governance.users.id", ondelete='SET NULL'), nullable=True)
...
class UserLoginHistory(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    user_id = Column(Integer, ForeignKey("governance.users.id", ondelete='CASCADE'), nullable=False)
