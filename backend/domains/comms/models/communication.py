...
class ProxyMessage(Base):
    ...
    __table_args__ = ({'schema': 'comms'},)
    id = Column(Integer, primary_key=True, index=True)
    session_id = Column(Integer, ForeignKey('communication.proxy_sessions.id', ondelete='RESTRICT'), nullable=False, index=True)
    sender_id = Column(Integer, nullable=False)
...
class InternalChannelMember(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    channel_id = Column(Integer, ForeignKey('communication.internal_channels.id', ondelete='RESTRICT'), nullable=False, index=True)
    user_id = Column(Integer, nullable=False)
...
class InternalEmail(Base, TenantMixin):
    ...
    in_reply_to_id = Column(Integer, ForeignKey('communication.internal_emails.id', ondelete='RESTRICT'), nullable=True, index=True)
    folder_id = Column(Integer, ForeignKey('communication.email_folders.id', ondelete='RESTRICT'), nullable=True, index=True)
    created_at = Column(DateTime, default=utcnow)
    updated_at = Column(DateTime, default=utcnow, onupdate=utcnow)
