...
class Notification(Base, TenantMixin):
    ...
    __table_args__ = (Index('ix_notifications_user_id', 'user_id'), Index('ix_notifications_is_read', 'is_read'), Index('ix_notifications_user_read', 'user_id', 'is_read'), Index('ix_notifications_variables_gin', 'variables', postgresql_using='gin'), Index('ix_notifications_country_created', 'country_code', 'created_at'), {'schema': 'communication'})
...
class TicketMessage(Base, TenantMixin):
    ...
    created_by = Column(Integer, nullable=True, index=True)
    updated_by = Column(Integer, nullable=True, index=True)
    __table_args__ = (Index('ix_ticket_messages_country_created', 'country_code', 'created_at'), {'schema': 'communication'})
    id = Column(Integer, primary_key=True, index=True)
...
class FAQ(Base, TenantMixin):
    ...
    created_by = Column(Integer, nullable=True, index=True)
    updated_by = Column(Integer, nullable=True, index=True)
    __table_args__ = (Index('ix_faqs_country_created', 'country_code', 'created_at'), {'schema': 'communication'})
    id = Column(Integer, primary_key=True, index=True)
...
class ProxyChannel(Base):
    ...
    updated_at = Column(DateTime, default=utcnow, onupdate=utcnow)
    __table_args__ = (Index('idx_proxy_entity', 'entity_type', 'entity_id'), Index('ix_proxy_channels_participants_gin', 'participants', postgresql_using='gin'), {'schema': 'communication'})
...
class ProxySession(Base):
    ...
    created_by = Column(Integer, nullable=True, index=True)
    updated_by = Column(Integer, nullable=True, index=True)
    __table_args__ = (Index('ix_proxy_sessions_session_metadata_gin', 'session_metadata', postgresql_using='gin'), {'schema': 'communication'})
    id = Column(Integer, primary_key=True, index=True)
...
class EmployeeCommunicationThread(Base, TenantMixin):
    ...
    created_by = Column(Integer, nullable=True, index=True)
    updated_by = Column(Integer, nullable=True, index=True)
    __table_args__ = (Index('ix_emp_comm_entity', 'entity_type', 'entity_id'), Index('ix_emp_comm_country_created', 'country_code', 'created_at'), {'schema': 'communication'})
    id = Column(Integer, primary_key=True, index=True)
    entity_id = Column(Integer, nullable=False)
...
class ExternalContactMasking(Base):
    ...
    created_by = Column(Integer, nullable=True, index=True)
    updated_by = Column(Integer, nullable=True, index=True)
    __table_args__ = (UniqueConstraint('user_id', 'external_contact_type', 'external_contact_id', name='uq_masking_contact'), Index('ix_masking_user', 'user_id'), {'schema': 'communication'})
    id = Column(Integer, primary_key=True, index=True)
    user_id = Column(Integer, nullable=False)
...
class CommunicationAuditTrail(Base):
    ...
    created_by = Column(Integer, nullable=True, index=True)
    updated_by = Column(Integer, nullable=True, index=True)
    __table_args__ = (Index('ix_comm_entity', 'entity_type', 'entity_id'), Index('ix_comm_user', 'user_id', 'created_at'), Index('ix_communication_audit_trail_metadata_json_gin', 'metadata_json', postgresql_using='gin'), {'schema': 'communication'})
    id = Column(Integer, primary_key=True, index=True)
    entity_type = Column(String(50), nullable=False)
    entity_id = Column(Integer, nullable=False)
...
class InternalChannelMember(Base):
    ...
    created_by = Column(Integer, nullable=True, index=True)
    updated_by = Column(Integer, nullable=True, index=True)
    __table_args__ = (UniqueConstraint('channel_id', 'user_id', name='uq_channel_member'), {'schema': 'communication'})
    id = Column(Integer, primary_key=True, index=True)
...
class InternalMessage(Base):
    ...
    created_by = Column(Integer, nullable=True, index=True)
    updated_by = Column(Integer, nullable=True, index=True)
    __table_args__ = (Index('ix_internal_msg_channel', 'channel_id'), Index('ix_internal_msg_user', 'user_id'), {'schema': 'communication'})
    id = Column(Integer, primary_key=True, index=True)
    channel_id = Column(Integer, ForeignKey('communication.internal_channels.id', ondelete='RESTRICT'), nullable=False, index=True)
    user_id = Column(Integer, nullable=False)
    message = Column(Text, nullable=False)
...
class ChatReadReceipt(Base):
    ...
    created_by = Column(Integer, nullable=True, index=True)
    updated_by = Column(Integer, nullable=True, index=True)
    __table_args__ = (UniqueConstraint('message_id', 'message_type', 'employee_id', name='uq_chat_read_receipt'), Index('ix_chat_read_receipts_employee', 'employee_id'), {'schema': 'communication'})
    id = Column(Integer, primary_key=True, index=True)
...
class InternalEmail(Base, TenantMixin):
    ...
    created_by = Column(Integer, nullable=True, index=True)
    updated_by = Column(Integer, nullable=True, index=True)
    __table_args__ = (Index('ix_internal_emails_thread_id', 'thread_id'), Index('ix_internal_emails_sender_id', 'sender_id'), Index('ix_internal_emails_folder_id', 'folder_id'), Index('ix_internal_emails_country_created', 'country_code', 'created_at'), {'schema': 'communication'})
    id = Column(Integer, primary_key=True, index=True)
    sender_id = Column(Integer, nullable=False)
...
class MaskedMessage(Base, TenantMixin):
    ...
    created_by = Column(Integer, nullable=True, index=True)
    updated_by = Column(Integer, nullable=True, index=True)
    __table_args__ = (Index('ix_masked_messages_sender', 'sender_id'), Index('ix_masked_messages_recipient', 'recipient_ref'), Index('ix_masked_messages_hash', 'message_hash'), Index('ix_masked_messages_country_created', 'country_code', 'created_at'), {'schema': 'communication'})
    id = Column(Integer, primary_key=True, index=True)
    sender_id = Column(Integer, nullable=False)
