...
from __future__ import annotations
from domains.comms.services.shared.admin.public_comms_status_service import ConnectionManager
from domains.comms.services.shared.admin.public_comms_status_service import UserConnectionManager
from domains.comms.services.shared.admin.public_comms_status_service import websocket_chat
from domains.comms.services.shared.admin.public_comms_status_service import _decode_ws_token
...
# TODO: Use messaging.chat service directly
...
async def websocket_user(
    ...
    try:
        ...
        logger.warning("WebSocket connection error in system status", exc_info=True)
    finally:
        if scope == "staff":
