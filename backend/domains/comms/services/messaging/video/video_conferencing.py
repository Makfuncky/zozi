...
class VideoConferenceRoom:
    def __init__(self, db: Session):
        ...
        self.transcripts: Dict[str, VideoConferencingMeetingTranscript] = {}
    ...
    def create_room(
        ...
        self.transcripts[room_id] = VideoConferencingMeetingTranscript(
            meeting_id=room_id,
            language="en",
            segments=[],
            action_items=[],
    ...
    async def add_transcript_segment(
        ...
        if not transcript:
            transcript = VideoConferencingMeetingTranscript(meeting_id=room_id, language=language)
