...
from services.comms.connection_manager_base import UserConnectionManagerBase
...
class UserConnectionManager(UserConnectionManagerBase):
...
def get_online_users(room_id: str) -> dict:
