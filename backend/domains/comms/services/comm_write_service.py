"""Communication write service.

Owns the DB write operations for enterprise communication (video rooms,
entity chat threads, masked messages, incident war rooms). These were moved
out of controllers/comm_controller.py to satisfy the W1 layer contract
(read-only orchestration layers must not write to the DB).
"""
