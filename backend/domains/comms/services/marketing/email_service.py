...
from __future__ import annotations
from domains.comms.services.marketing.email_management_service import _serialize_template
...
from domains.comms.services.marketing.email_gateway import EmailGateway

from domains.comms.services.marketing.transactional_email_service import enqueue_invoice_email
from domains.comms.services.marketing.transactional_email_service import enqueue_low_stock_alert_email
...
async def track_open(email_id: str, user_id: int):
    ...
    try:
        ...
        logger.warning("Failed to track email open", email_id=email_id, user_id=user_id, exc_info=True)
