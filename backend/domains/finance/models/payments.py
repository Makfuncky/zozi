...
class Payment(Base):
    ...
    order_id = Column(Integer, ForeignKey("orders.orders.id", ondelete='CASCADE'), nullable=False)
...
class Payout(Base):
    ...
    supplier_id = Column(Integer, ForeignKey("accounts.users.id", ondelete='RESTRICT'), nullable=False)
