...
from domains.finance.services.ledger.general_ledger_service import seed_chart_of_accounts as gl_seed_chart_of_accounts
from domains.finance.services.ledger.general_ledger_service import get_trial_balance as gl_get_trial_balance
...
class TreasuryEngine:
    ...
    def post_journal_entry(
        ...
        missing_code = [i for i, c in enumerate(account_codes) if not c]
        if missing_code:
