...
re-export handler functions from `domains.finance.services.payments.disputes_controller`, which
...
_REEXPORTS: dict[str, tuple[str, str]] = {
    "create_supplier_dispute": ("domains.finance.services.payments.disputes_controller", "create_supplier_dispute"),
}
