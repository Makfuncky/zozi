"""Auto-migrated service logic from routers/public_treasury_payments.py."""
...
def get_pending_payouts(page: int, page_size: int, current_admin: User, db: Session) -> dict[str, Any]:
...
def approve_payout(payout_id: int, payload: ActionRequest | None, current_admin: User, db: Session) -> dict[str, Any]:
...
def reject_payout(payout_id: int, payload: ActionRequest | None, current_admin: User, db: Session) -> dict[str, Any]:
...
def approve_batch(batch_id: int, payload: ActionRequest | None, current_admin: User, db: Session) -> dict[str, Any]:
...
def reject_batch(batch_id: int, payload: ActionRequest | None, current_admin: User, db: Session) -> dict[str, Any]:
...
def dispatch_batch(batch_id: int, payload: ActionRequest | None, current_admin: User, db: Session) -> dict[str, Any]:
