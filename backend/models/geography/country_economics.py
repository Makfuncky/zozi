...
class CountryEconomics(Base):
    ...
    __table_args__ = (Index('ix_country_economics_code', 'country_code', unique=True), Index('ix_country_economics_country_created', 'country_code', 'created_at'), {'schema': 'country'})
