...
class ShiftHandoverLog(Base, TenantMixin):
...
class PaymentOrchestratorSync(Base, TenantMixin):
...
class SupplierOnboardingSync(Base, TenantMixin):
...
class LegalContractTemplate(Base, TenantMixin):
...
class DataResidencyRecord(Base, TenantMixin):
...
class CountryMapConfig(Base, TenantMixin):
...
class ShopWarehouseLocation(Base, TenantMixin):
...
class LogisticsPartnerLocation(Base, TenantMixin):
...
class ParcelLocationTracker(Base, TenantMixin):
