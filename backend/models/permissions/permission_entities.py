...
class RolePermissionAssignment(Base):
    ...
    granted_by = Column(Integer, ForeignKey('security.users.id', ondelete='RESTRICT'), nullable=True, index=True)
...
class PermissionAuditLog(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    actor_id = Column(Integer, ForeignKey('security.users.id', ondelete='RESTRICT'), nullable=False, index=True)
    action = Column(String(50), nullable=False)
    target_user_id = Column(Integer, ForeignKey('security.users.id', ondelete='RESTRICT'), nullable=True, index=True)
