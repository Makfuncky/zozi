"""
Logistics controller â€” shipping carriers, zones, and shipment fulfilment.
"""
...
async def create_carrier(data: dict, current_user: dict, db: Session) -> dict:
    ...
    add_and_flush(db, carrier)
    commit_and_refresh(db, carrier)
...
# â”€â”€ shipping zones â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
async def upsert_shipping_zone(data: dict, current_user: dict, db: Session) -> dict:
    ...
    if zone_id:
        ...
        add_and_flush(db, zone)

    commit_and_refresh(db, zone)
...
async def create_shipment(data: dict, current_user: dict, db: Session) -> dict:
    ...
    logger.info("Shipment created: order %d by supplier %d â†’ tracking %s", order_id, supplier_id, tracking_number)
