...
Re-exports ``services.hr.employee_communication_service`` so first-party layers can reach it through the
...
_target = "services.hr.employee_communication_service"
