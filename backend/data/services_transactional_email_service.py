...
Re-exports ``services.comms.transactional_email_service`` so first-party layers can reach it through the
...
_target = "services.comms.transactional_email_service"
