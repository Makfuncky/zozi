...
Re-exports ``services.logistics.logistics_partner_pricing`` so first-party layers can reach it through the
...
_target = "services.logistics.logistics_partner_pricing"
