...
from utils.country_utils import normalize_country_code
...
def enforce_country_access(country_code: str, request: Optional[Request] = None, db: Session = Depends(get_db)) -> str:
