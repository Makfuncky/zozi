...
from _legacy.models import User, Employee, UserDevice
from services.security.iam_service import generate_qr_code
...
class MobileAuthService:
    ...
    def validate_biometric(
        ...
        from services.security.biometric_auth import BiometricAuthService
    ...
    def geo_fenced_check_in(
        ...
        from services.logistics.geo_fence_service import GeoFenceService
