"""Currency conversion and rate logic — moved from kernel/currency.py.

This module depends on providers.geography.rates for live exchange rates,
so it belongs in infrastructure (kernel must not import providers).
"""
