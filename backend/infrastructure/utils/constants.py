...
Note: this module is the canonical home for all business-specific constants
(roles, statuses, pagination caps, finance account codes, upload limits, ...).
Kernel/ is reserved for pure business primitives only and does not host these.
"""
