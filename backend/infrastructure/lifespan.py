...
def _startup_register_services() -> None:
    ...
    ``domains/_service_registry.py`` imports runtime-dispatched service modules
    ...
    """
    try:
        import domains._service_registry  # noqa: F401 — import side-effects only
        logger.info("Service side-effect registry imported")
    except Exception:
        logger.exception("Failed to import domains._service_registry at startup")
