...
SKIP_DIR_PARTS = {"tests", "_extra_files", "scripts", "__pycache__", ".venv", "_parked"}
...
def regenerate() -> dict[str, int]:
    ...
    with open(BASELINE_PATH, "w", encoding="utf-8") as fh:
        ...
        fh.write(    "# Regenerate with scripts/_gen_offset_adoption_baseline.py after an intentional migration.\n")
