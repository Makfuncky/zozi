...
async def create_product(
    ...
    # Step 8 â€” multi-country publishing + auto logistics tier.
...
async def analyze_async(
    ...
    This prevents ML inference from blocking HTTP workers â€” under an upload
...
async def translate_text(
    ...
    """Step 6 â€” ENâ†’AR translation for product titles/descriptions (best-effort)."""
...
async def get_variant_axes(
    ...
    - Apparel: color Ã— size, sleeve_length, fit, etc.
    - Electronics: storage Ã— RAM, processor, screen_size, etc.
    - Beauty: volume Ã— scent, etc.
    - Jewelry: karat Ã— plating, chain_length, ring_size, etc.
...
async def moderate_text(
    ...
    """Step 6 â€” GCC content moderation for text (alcohol/pork/gambling/tobacco)."""
    from services.content_service import moderate_content
...
async def process_tools(
    ...
    Never 500s â€” returns the original image if all tools fail.
    """
    raw = await image.read()
    if not raw:
        raise HTTPException(status_code=400, detail="Empty image file")
...
# â”€â”€ Supplier Bank Account (Payout Beneficiary) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
