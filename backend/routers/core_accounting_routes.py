...
try:
    import controllers.accounting_controller as _ctrl
    _HAS_CTRL = True
...
def status():
    ...
    return {"router": "core_accounting_routes", "controller": "controllers.accounting_controller" if _HAS_CTRL else None,
