...
try:
    import controllers.core.export_controller as _ctrl
    _HAS_CTRL = True
...
def status():
    ...
    return {"router": "core_export_routes", "controller": "controllers.core.export_controller" if _HAS_CTRL else None,
