"""store orders routes router.

Business logic lives in `controllers/orders_controller.py`;
...
try:
    import controllers.orders_controller as _ctrl
    _HAS_CTRL = True
...
def status():
    ...
    return {"router": "store_orders_routes", "controller": "controllers.orders_controller" if _HAS_CTRL else None,
