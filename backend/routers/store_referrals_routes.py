...
try:
    import controllers.commerce.referrals_controller as _ctrl
    _HAS_CTRL = True
...
def status():
    ...
    return {"router": "store_referrals_routes", "controller": "controllers.commerce.referrals_controller" if _HAS_CTRL else None,
