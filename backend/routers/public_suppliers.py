"""
Public Suppliers Router â€” unauthenticated customer-facing supplier endpoints.

GET /suppliers              â€” list active, verified suppliers (discovery)
GET /suppliers/{id}         â€” full public supplier profile
GET /suppliers/{id}/products â€” paginated products by this supplier
"""
