        ...
        "strategies": [
            {
                ...
                "description": "br05 â€” Best for simple product shots, clean edges",
                "icon": "Wand2",
            },
            {
                "key": "precision_geometry",
                "label": "Precision Geometry",
                "description": "br06 â€” Best for geometric shapes, electronics, accessories",
                "icon": "Layers",
            },
            {
                "key": "birefnet_production",
                "label": "Production BiRefNet",
                "description": "br08 â€” Best for general products, good quality-speed tradeoff",
                "icon": "Zap",
            },
            {
                "key": "ultimate_gaps",
                "label": "Ultimate v11",
                "description": "br11 â€” Best for complex shapes with gaps and fine details",
                "icon": "Sparkles",
            },
            {
                "key": "marketing_variants",
                "label": "Ultimate v12",
                "description": "br12 â€” Best for marketing photos, floating artifacts removal",
                "icon": "Tag",
            },
            {
                "key": "lite_variants",
                "label": "Variant Testing",
                "description": "br13 â€” Best for clothing / fabric, lightweight model chain",
                "icon": "Camera",
            },
        ]
    }
...
# â”€â”€ In-memory cache for category recommendations â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
