"""Search routes â€” text, AI-powered, voice, visual, autocomplete, and recommendations."""
...
async def voice_search(
    ...
    """
    Voice search â€” accepts raw audio (transcribed via Whisper) OR pre-transcribed text.
...
async def visual_search(
    ...
    """
    Visual similarity search â€” upload an image and find visually similar products.
