"""
AI Service â€” HuggingFace Inference API integration.
...
def generate_product_description(
    ...
    1. If image_bytes provided â†’ BLIP captioning â†’ enrich with text.
    2. Otherwise â†’ rule-based template description.
...
def _build_description(name: str, category: str, caption: str = "") -> str:
    ...
    templates = {
        "Electronics": (
            "Introducing {name} â€” a cutting-edge {cat} device engineered for "
        ...
        "Beauty": (
            "Discover {name} â€” a luxurious {cat} product formulated to nourish, "
        ...
        "Sports": (
            "Reach your peak performance with {name} â€” a professional-grade "
    ...
    template = templates.get(
        category,
        "Introducing {name} â€” a high-quality {cat} product designed to "
