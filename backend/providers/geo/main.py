"""IP/location tracking provider for the Zozi order/delivery system.

Provides geo-location endpoints via the providers.geography.geo module.
Part of the providers/geo package (ARCHITECTURE_DIAGRAM.md Law 1).
