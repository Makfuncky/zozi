...
def magic_erase_tool(image_b64: str, mask_json: str) -> str:
    ...
    """
    import numpy as np
    from data.providers_bg_remover import magic_erase
    image_bytes = base64.b64decode(image_b64)
...
def parse_email_to_ledger_tool(email_text: str) -> str:
    ...
    """
    from providers.finance.finance_ai import parse_email_to_ledger
...
def suggest_reconciliation_match_tool(
    ...
    """
    from providers.finance.finance_ai import suggest_reconciliation_match
...
def generate_photo_angles_tool(
    ...
    """
    from data.providers_image import generate_angles
