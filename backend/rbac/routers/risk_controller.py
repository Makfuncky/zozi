...
from domains.governance.services.risk_service import (
    ...
    get_employee_risk_scores as _get_employee_risk_scores,
...
@get("/api/v1/admin/{employee_id}/risk-score", skip=True)
def get_risk_score(employee_id: int, db: Session = None):
    """Return flight-risk / burnout score records for an employee (0 = all)."""
    return _get_employee_risk_scores(employee_id, db)
