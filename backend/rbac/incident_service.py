...
from models import IncidentWarRoom, IncidentThread, IncidentActionItem, User
...
def get_war_room_summary(db: Session, war_room_id: int) -> dict:
    """Read a war room with its action items (extracted from the admin/public
    security routers so they stay thin HTTP layers)."""
