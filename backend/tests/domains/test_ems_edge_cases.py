...
class TestDuplicateOnboarding:
    ...
    def test_complete_step_nonexistent_pipeline_raises(self, db_session):
        ...
        _ensure_country_config(db_session)
        from domains.hr.services.employee_lifecycle_service import complete_onboarding_step
...
class TestDoubleCancelOffboarding:
    ...
    def test_cancel_completed_offboarding_raises(self, db_session):
        ...
        # Verify completed
        from domains.hr.services.employee_lifecycle_service import get_offboarding_status
    ...
    def test_cancel_nonexistent_case_raises(self, db_session):
        ...
        from domains.hr.services.employee_lifecycle_service import cancel_offboarding
...
class TestOffboardingTerminatedEmployee:
    ...
    def test_initiate_offboarding_terminated_employee(self, db_session):
        ...
        from domains.hr.services.employee_lifecycle_service import initiate_offboarding as init_off
        with pytest.raises((ValueError, KeyError)):
            init_off(
                db=db_session, employee_id=emp_id,
...
class TestAlreadyCompletedSteps:
    ...
    def test_complete_onboarding_step_twice(self, db_session):
        ...
        from domains.hr.services.employee_lifecycle_service import create_onboarding_pipeline, complete_onboarding_step
        ...
        from domains.hr.services.employee_lifecycle_service import get_onboarding_progress
...
class TestBackgroundCheckStep:
    ...
    def test_background_check_export_to_dict(self, db_session):
        ...
        from domains.hr.services.background_check import BackgroundCheckResult, BACKGROUND_CHECK_CLEAR
    ...
    def test_100_parallel_onboarding_pipelines(self, db_file):
        ...
        try:
            ...
            with verify_engine.connect() as conn:
                ...
                from domains.hr.services.employee_lifecycle_service import DEFAULT_ONBOARDING_STEPS
