"""Customer module router law tests.

Verifies Laws 1, 2, 87, 88, 89, 90, 99, 132-139 for the customer module.
"""
...
class TestCustomerRouterImports:
            ...
            for node in ast.walk(tree):
                if isinstance(node, ast.ImportFrom) and node.module:
                    if node.module.startswith("domains."):
                        domain_imports += 1
        assert domain_imports > 0, "customer routers never import from domains"


class TestCustomerRouterLaw8788:
...
class TestCustomerRouterLaw290:
...
class TestCustomerRouterLaw139:
    """Law 139: route prefixes match /customer/*."""
