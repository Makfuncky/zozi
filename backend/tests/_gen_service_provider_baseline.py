...
Regenerate after an intentional relocation:
    python tests/_gen_service_provider_baseline.py
"""
...
BASELINE_FILE = os.path.join(BACKEND, "tests", "_service_provider_baseline.txt")
...
if __name__ == "__main__":
    ...
    with open(BASELINE_FILE, "w", encoding="utf-8") as fh:
        fh.write(
            ...
            "# intentional relocation: python tests/_gen_service_provider_baseline.py\n"
