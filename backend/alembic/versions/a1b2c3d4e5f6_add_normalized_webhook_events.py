"""Migration to add NormalizedWebhookEvent table for webhook audit trail."""
from alembic import op
import sqlalchemy as sa
from sqlalchemy.dialects import postgresql

revision = 'a1b2c3d4e5f6_add_normalized_webhook_events'
down_revision = 'e7f8a9b0c1d2_add_payment_gateway_connections'
branch_labels = None
depends_on = None
