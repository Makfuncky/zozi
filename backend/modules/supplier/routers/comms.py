"""Supplier comms router — supplier-facing communications endpoints.

Suppliers can:
- read their own notifications
- create/manage support tickets
- use proxy communication channels (when transacting with customers)
- view their own chat threads and history
"""
...
router = APIRouter(prefix="/supplier/comms", tags=["supplier", "comms"])
