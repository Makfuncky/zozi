from domains.governance.events import publish_gov_bulk_update_staff_accounts_requested
from domains.governance.events import publish_gov_create_staff_account_requested
from domains.governance.events import publish_gov_delete_staff_account_requested
from domains.governance.events import publish_gov_update_staff_account_requested
"""
...
def create_staff(
    ...
    return publish_gov_create_staff_account_requested(payload, current_admin, db)
...
def bulk_update_staff(
    ...
    return publish_gov_bulk_update_staff_accounts_requested(body.user_ids, body.updates, current_admin, db)
...
def update_staff(
    ...
    return publish_gov_update_staff_account_requested(user_id, payload, current_admin, db)
...
def delete_staff(
    ...
    return publish_gov_delete_staff_account_requested(user_id, current_admin, db)
