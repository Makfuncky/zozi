from domains.governance.events import publish_gov_bulk_delete_products_admin_requested
from domains.governance.events import publish_gov_bulk_product_moderation_requested
from domains.governance.events import publish_gov_delete_product_admin_requested
from domains.governance.events import publish_gov_restore_product_admin_requested
from domains.governance.events import publish_gov_toggle_product_badge_requested
"""
...
def bulk_delete_products(
    ...
    return publish_gov_bulk_delete_products_admin_requested(body.product_ids, current_admin, db)
...
def delete_product(
    ...
    return publish_gov_delete_product_admin_requested(product_id, current_admin, db)
...
def bulk_moderate_products(
    ...
    return publish_gov_bulk_product_moderation_requested(body.product_ids, body.action, body.note, current_admin, db)
...
def restore_product(
    ...
    return publish_gov_restore_product_admin_requested(product_id, current_admin, db)
...
def set_product_badge(
    ...
    return publish_gov_toggle_product_badge_requested(product_id, field, value, current_admin, db)
