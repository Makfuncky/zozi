...
view models (response shaping, field filtering). This module provides the
admin serialization models used by admin routers (auth and shared).
"""
...
from domains.accounts.schemas import RegisterRequest, TokenResponse, UserOut
