...
ALLOWED_EXTENSIONS = {'.py', '.yaml', '.yml', '.json', '.cfg', '.ini', '.toml', '.ts', '.tsx', '.js'}
...
EXCLUDE_DIRS = {
    ...
    '.vscode', 'dist', 'build', '.pytest_cache', 'tests', 'scripts', 'document', 'documents', '__tests__', 'test_outputs',
...
EXCLUDE_PATTERNS = [
    ...
    '*.egg-info', 'codebase.md', 'generate_codebase.py', 'IMPROVEMENT_PLAN.md', 'QUICK_START.md', 'README.md', 'zozi.db',
    # Binary or encoding-problematic .txt files
    'payments_orders_async.txt', 
    'payments_orders_no_logging.txt', 
    'payments_orders_pytest_rA_durations.txt',
    'payments_orders_pytest_ra.txt', 'targeted-rerun.txt', 
    '.collect_order.txt', 'audit_out.txt', 'listpage_out.txt',
    'Single_Window_Dashboard_System.txt', 
    'Admin_Employees_System.txt', 
    'Database_Management_System.txt', 
    'Employee_Chat_Video_Email_System.txt', 
    'Error_Handling_System.txt', 
    'Finance_Treasury_System.txt', 
    'Fraud_Detection_System.txt', 
    'Multi_Country_System.txt', 
    'Payment_Gateway_System.txt', 
    'Security_System.txt',
    'Features_List.md',
    'problems',
    'README.md', 'AGENTS.md', 'AUDIT_REPORT.md', 'BANNER_PROMOTION_DISCOUNT_CODE.md', 'codebase_v1.md', 'FEATURE_MATRIX.md',
    'codebase_v3.md', 'codebase_v1.md', 'codebase_v2.md',
    'mobile_app.html'   
]
