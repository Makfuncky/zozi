...
class SystemAlert(Base):
    ...
    acknowledged_by = Column(Integer, ForeignKey("security.users.id"), nullable=True)
...
class AdminChangeAuditLog(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    admin_id = Column(Integer, ForeignKey("security.users.id"), nullable=False)
...
class APIKey(Base):
    ...
    created_by = Column(Integer, ForeignKey("security.users.id"), nullable=True)
    created_at = Column(DateTime, default=_utcnow)
    country_code = Column(String(10), nullable=True, index=True)
...
class BadgeBillingRecord(Base):
    ...
    supplier_id = Column(Integer, ForeignKey("security.users.id"), nullable=True)
...
class CommissionBadgeTier(Base):
    ...
    is_active = Column(Boolean, default=True)
    updated_by = Column(Integer, ForeignKey("security.users.id"), nullable=True)
    created_at = Column(DateTime, default=_utcnow)
    updated_at = Column(DateTime, default=_utcnow, onupdate=_utcnow)
    country_code = Column(String(10), nullable=True, index=True)
...
class TicketReply(Base):
    ...
    sender_id = Column(Integer, ForeignKey("security.users.id"), nullable=False)
    message = Column(Text, nullable=False)
    created_at = Column(DateTime, default=_utcnow)
    country_code = Column(String(10), nullable=True, index=True)
...
class LogisticsCODRemittanceReceipt(Base):
    ...
    settlement_id = Column(Integer, ForeignKey("logistics_settlements.id"), nullable=True)
    amount = Column(Numeric(12, 2), nullable=False)
    bank_reference = Column(String, nullable=True)
    receipt_file_url = Column(String, nullable=True)
    notes = Column(Text, nullable=True)
    review_note = Column(Text, nullable=True)
    reviewed_by = Column(Integer, ForeignKey("security.users.id"), nullable=True)
    status = Column(String, default="pending")
    currency = Column(String(3), nullable=True)
    created_at = Column(DateTime, default=_utcnow)
    country_code = Column(String(10), nullable=True, index=True)
...
class LogisticsPartnerBankAccount(Base):
    ...
    verified_by = Column(Integer, ForeignKey("security.users.id"), nullable=True)
    is_active = Column(Boolean, default=True)
    created_at = Column(DateTime, default=_utcnow)
    updated_at = Column(DateTime, default=_utcnow, onupdate=_utcnow)
    country_code = Column(String(10), nullable=True, index=True)
...
class ShipmentConfirmation(Base):
    ...
    order_id = Column(Integer, ForeignKey("orders.id"), nullable=True)
    supplier_id = Column(Integer, ForeignKey("security.users.id"), nullable=True)
    requester_user_id = Column(Integer, ForeignKey("security.users.id"), nullable=True)
    requester_role = Column(String, nullable=True)
    target_user_id = Column(Integer, ForeignKey("security.users.id"), nullable=True)
...
class SupplierBankAccount(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    supplier_id = Column(Integer, ForeignKey("security.users.id"), nullable=False)
    account_number = Column(String, nullable=True)
    bank_name = Column(String, nullable=False)
    beneficiary_name = Column(String, nullable=True)
    branch_name = Column(String, nullable=True)
...
class EmployeeExpense(Base):
    ...
    approved_by = Column(Integer, ForeignKey("security.users.id"), nullable=True)
...
class SupplierDispute(Base):
    ...
    resolved_by = Column(Integer, ForeignKey("security.users.id"), nullable=True)
