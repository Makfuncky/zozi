...
class User(Base):
    __tablename__ = "users"
    __table_args__ = (
        Index("ix_users_role", "role"), {"schema": "security"})
...
class Referral(Base):
    ...
    # Audit / lifecycle columns (ARCHITECTURE_DIAGRAM §DBA03): uuid identity,
    # soft-delete, optimistic version, and audit-by columns.
