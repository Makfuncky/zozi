...
class ShiftHandoverLog(Base):
    ...
    user_id = Column(Integer, ForeignKey("security.users.id"), nullable=False, index=True)
    ...
    handover_to_user_id = Column(Integer, ForeignKey("security.users.id"), nullable=True)
...
class SupplierOnboardingSync(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    country_code = Column(String(10), ForeignKey("country.country_configs.code"), nullable=False, index=True)
    supplier_id = Column(Integer, ForeignKey("security.users.id"), nullable=False, index=True)
