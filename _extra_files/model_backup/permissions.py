...
class RolePermissionAssignment(Base):
    ...
    __table_args__ = (
        UniqueConstraint("role_name", "permission_id", "country_code", name="uq_role_permission_country"), {"schema": "security"})
    id = Column(Integer, primary_key=True, index=True)
...
class UserPermissionOverride(Base):
    ...
    __table_args__ = (
        UniqueConstraint("user_id", "permission_id", "country_code", name="uq_user_perm_override_country"), {"schema": "security"})
    id = Column(Integer, primary_key=True, index=True)
