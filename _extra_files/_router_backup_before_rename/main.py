...
if str(getattr(settings, "storage_backend", "") or os.getenv("STORAGE_BACKEND", "local")).lower() != "s3":
    ...
    # Serve the security disclosure file at the standard /.well-known/security.txt
    well_known_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "var", "static", ".well-known")
