...
from data.services_workflow_engine import get_workflow_engine
import structlog
...
@router.post("/workflows/create", response_model=dict)
def create_workflow(
    name: str,
    workflow_type: str,
    steps: list,
...
@router.post("/workflows/execute/{workflow_type}", response_model=dict)
