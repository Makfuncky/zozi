...
from _legacy.models import User, Employee, CountryStaffAssignment
...
class RBACService:
    ...
    def can_approve_resource(
        ...
        from services.users.approval_matrix_service import can_approve as _can_approve
    ...
    def resolve_resource_approvers(
        ...
        from services.users.approval_matrix_service import resolve_approvers as _resolve
    ...
    def get_resource_approval_chain(
        ...
        from services.users.approval_matrix_service import get_approval_chain as _chain
