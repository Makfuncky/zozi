...
Design:
  Supplier sweep:
    ...
    2. For each eligible settlement â†’ create a Payout record
    3. Group created Payouts by supplier â†’ create PayoutBatchItem per supplier
  ...
  Logistics sweep (identical pattern):
    ...
    2. For each eligible settlement â†’ create a LogisticsPartnerPayout record
    3. Group by partner_id â†’ create PayoutBatchItem per partner (entity_type="logistics")
...
# â”€â”€ Core sweep logic â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    *,
    ...
    dict
        Summary with keys:
          ...
          - payout_ids: list[dict] â€” supplier_id, payout_id, amount
    ...
    try:
        # â”€â”€ 1. Find eligible settlements â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        settlements = (
            ...
            .filter(
                ...
                # eligible_at is NULL â†’ use the created_at + default holding period
                (
        ...
        # â”€â”€ 3. Group by supplier â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # â”€â”€ 3. Create Payout records (one per settlement) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # â”€â”€ 4. Create PayoutBatch â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # â”€â”€ 5. Create PayoutBatchItem records (one per supplier) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        for supplier_id, amt in net_by_supplier.items():
            item = PayoutBatchItem(
                ...
                reference=f"Supplier #{supplier_id} â€” {len(supplier_groups[supplier_id])} settlement(s)",
                status="pending",
                country_code=batch_country,
            )
            db.add(item)

        # â”€â”€ 6. Log to FinanceAutomationLog â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        logger.info(
            "Auto-payout sweep complete: %d settlements â†’ %d payouts "
            "for %d suppliers, batch %s (total %s OMR) â€” %d notifications",
            len(settlements),
            len(created_payouts),
            len(supplier_groups),
            batch_number,
...
# â”€â”€ Logistics payout sweep â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    *,
    ...
    dict
        Summary with keys:
          ...
          - payout_ids: list[dict] â€” partner_id, payout_id, amount
          - batch_id: PayoutBatch.id (None for dry_run)
          - status: "ok", "no_eligible_settlements", or "error"
    """
    now = force_date or _utcnow()
    try:
        # â”€â”€ 1. Find eligible logistics settlements â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        settlements = (
            db.query(LogisticsSettlement)
            .filter(
                LogisticsSettlement.status == "pending",
                LogisticsSettlement.payout_id.is_(None),
                # eligible_at is NULL â†’ use created_at + default holding period
                (
        ...
        # â”€â”€ 3. Group by partner â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # â”€â”€ 4. Create LogisticsPartnerPayout records â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # â”€â”€ 5. Create PayoutBatch â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # â”€â”€ 6. Create PayoutBatchItem records (one per partner) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        for partner_id, amt in amount_by_partner.items():
            item = PayoutBatchItem(
                ...
                amount=round_money(amt),
                currency=batch_currency,
                reference=f"Logistics Partner #{partner_id} â€” {len(partner_groups[partner_id])} settlement(s)",
                status="pending",
                country_code=batch_country,
            )
            db.add(item)

        # â”€â”€ 7. Log to FinanceAutomationLog â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        log_entry = FinanceAutomationLog(
        ...
        logger.info(
            "Auto-logistics-payout sweep complete: %d settlements â†’ %d payouts "
            "for %d partners, batch %s (total %s OMR) â€” %d notifications",
            len(settlements),
            len(created_payouts),
            len(partner_groups),
            batch_number,
...
# â”€â”€ Background job state (exposed for admin dashboard) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def _update_after_sweep(
    ...
    with _background_status_lock:
        ...
        if sweep_name == "supplier":
            ...
            # Always update last_run_status â€” if logistics runs after and fails,
    ...
    # â”€â”€ Fire-and-forget WebSocket broadcast â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    try:
        ...
        try:
            ...
            if status == "no_eligible_settlements":
                ...
                logger.info(
                    "Supplier auto-payout sweep: %d settlements â†’ %d suppliers, batch=%s total=%s",
        ...
        try:
            ...
            if status == "no_eligible_settlements":
                ...
                logger.info(
                    "Logistics auto-payout sweep: %d settlements â†’ %d partners, batch=%s total=%s",
                    result.get("processed", 0),
