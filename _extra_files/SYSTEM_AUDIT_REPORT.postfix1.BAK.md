...
> **Generated:** 2026-08-06T07:23:47.812147+00:00  
> **Repo:** `D:\Projects\10- E-COMMERCE WEBSITE\zozi`  
> **Result:** 🔴 230 violations · 🟡 3896 advisories · 🟢 50 info  
> **Architecture Debt Score:** **118124**  
...
| DBA01 | 7 | 🟡 ADVISORY | bounded-context schema missing or unknown |
...
| DOM2 | 12 | 🟡 ADVISORY | file is inside the wrong domain folder |
...
| HL101 | 26 | 🟡 ADVISORY | oversized Python file |
| HL102 | 75 | 🟡 ADVISORY | oversized Python function |
| HL110 | 1 | 🟡 ADVISORY | missing docstring on public service/controller function |
| HL201 | 20 | 🟡 ADVISORY | print() used instead of structured logging |
| HL203 | 17 | 🟡 ADVISORY | logging.basicConfig() should be configured centrally |
| HL204 | 8 | 🟡 ADVISORY | possible secret/token value in log/print statement |
| HL302 | 178 | 🟡 ADVISORY | swallowed exception (except + pass / no logging) |
| HL303 | 67 | 🟡 ADVISORY | broad except Exception should be narrowed or logged |
| HL403 | 1 | 🟡 ADVISORY | sync file/OS I/O inside async function |
| HL501 | 4 | 🟡 ADVISORY | heavy top-level import in web path (lazy-load recommended) |
| HL502 | 103 | 🟡 ADVISORY | star import (from x import *) pollutes namespace |
| HL601 | 14 | 🟡 ADVISORY | sequential external calls (concurrency opportunity) |
| HL602 | 17 | 🟡 ADVISORY | missing timeout on external call |
| HL801 | 131 | 🟡 ADVISORY | function needs timing/metrics instrumentation |
| HL901 | 1 | 🟡 ADVISORY |  |
...
| QUAL1 | 20 | 🟡 ADVISORY | weak exception handling (bare except / swallowed exception) |
...
| QUAL4 | 155 | 🟡 ADVISORY | print/debug output in application code |
...
| W4 | 42 | 🟡 ADVISORY | controller imports another controller (shared logic -> service/util) |
...
| 🔴 | DBA06 | database | `backend\models\geography\countries.py:144` | cross-schema FK: country_communications.from_user_id -> core.users.id | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\countries.py:145` | cross-schema FK: country_communications.to_user_id -> core.users.id | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\countries.py:185` | cross-schema FK: payout_rules.country_code -> country.country_configs.code | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\countries.py:217` | cross-schema FK: shipping_rules.country_code -> country.country_configs.code | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\countries.py:236` | cross-schema FK: messages.from_user_id -> core.users.id | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\countries.py:237` | cross-schema FK: messages.to_user_id -> core.users.id | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\countries.py:281` | cross-schema FK: payout_rule_products.product_id -> commerce.products.id | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\country_enhancements.py:25` | cross-schema FK: country_feature_flags.country_code -> country.country_configs.code | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\country_enhancements.py:47` | cross-schema FK: country_staff_assignments.user_id -> core.users.id | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\country_enhancements.py:48` | cross-schema FK: country_staff_assignments.country_code -> country.country_configs.code | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\country_enhancements.py:51` | cross-schema FK: country_staff_assignments.assigned_by -> core.users.id | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\country_enhancements.py:67` | cross-schema FK: cross_country_customer_sessions.user_id -> core.users.id | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\country_enhancements.py:72` | cross-schema FK: cross_country_customer_sessions.order_id -> commerce.orders.id | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\country_enhancements.py:110` | cross-schema FK: country_config_versions.country_code -> country.country_configs.code | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\country_enhancements.py:115` | cross-schema FK: country_config_versions.draft_by -> core.users.id | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\country_enhancements.py:116` | cross-schema FK: country_config_versions.approved_by -> core.users.id | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\country_enhancements.py:168` | cross-schema FK: country_commission_rates.country_code -> country.country_configs.code | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\country_enhancements.py:185` | cross-schema FK: country_localization.country_code -> country.country_configs.code | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\country_enhancements.py:204` | cross-schema FK: country_payment_aliases.country_code -> country.country_configs.code | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\country_enhancements.py:221` | cross-schema FK: country_legal_contracts.country_code -> country.country_configs.code | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\country_enhancements.py:240` | cross-schema FK: country_category_tax_rates.country_code -> country.country_configs.code | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\country_enhancements.py:241` | cross-schema FK: country_category_tax_rates.category_id -> commerce.categories.id | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\country_enhancements.py:293` | cross-schema FK: country_holiday_calendars.country_code -> country.country_configs.code | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\country_enhancements.py:311` | cross-schema FK: country_gateway_configs.country_code -> country.country_configs.code | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\country_enhancements.py:335` | cross-schema FK: country_communication_threads.country_code -> country.country_configs.code | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\country_enhancements.py:354` | cross-schema FK: country_commission_rate_history.country_code -> country.country_configs.code | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\country_enhancements.py:355` | cross-schema FK: country_commission_rate_history.category_id -> commerce.categories.id | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\country_enhancements.py:360` | cross-schema FK: country_commission_rate_history.changed_by -> core.users.id | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\country_enhancements.py:376` | cross-schema FK: country_logistics_zones.country_code -> country.country_configs.code | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\geography\country_enhancements.py:396` | cross-schema FK: country_payout_rules.country_code -> country.country_configs.code | use services/events, not FKs |
...
| 🔴 | DBA06 | database | `backend\models\comms\communication.py:22` | cross-schema FK: notifications.user_id -> core.users.id | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\comms\communication.py:42` | cross-schema FK: ticket_messages.sender_id -> core.users.id | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\comms\communication.py:101` | cross-schema FK: proxy_sessions.participant_one_id -> core.users.id | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\comms\communication.py:102` | cross-schema FK: proxy_sessions.participant_two_id -> core.users.id | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\comms\communication.py:117` | cross-schema FK: proxy_messages.sender_id -> core.users.id | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\comms\communication.py:118` | cross-schema FK: proxy_messages.recipient_id -> core.users.id | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\comms\communication.py:133` | cross-schema FK: proxy_call_logs.caller_id -> core.users.id | use services/events, not FKs |
| 🔴 | DBA06 | database | `backend\models\comms\communication.py:134` | cross-schema FK: proxy_call_logs.callee_id -> core.users.id | use services/events, not FKs |
...
| 🟡 | API2 | backend | `backend\providers\legacy\br_05.py:153` | private symbol '_Br05BackgroundRemover' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_05.py:105` | private symbol '_Br05CleanEdgeRefiner' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_05.py:33` | private symbol '_Br05ColoredFormatter' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_05.py:56` | private symbol '_Br05Deps' used in 6 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_06.py:281` | private symbol '_Br06BackgroundRemover' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_06.py:33` | private symbol '_Br06ColoredFormatter' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_06.py:53` | private symbol '_Br06Deps' used in 6 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_06.py:243` | private symbol '_Br06EdgeRefiner' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_06.py:110` | private symbol '_Br06HandRemover' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_06.py:153` | private symbol '_Br06HoleFiller' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_06.py:219` | private symbol '_Br06HumanPreserver' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_06.py:98` | private symbol '_Br06SceneAnalyzer' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_06.py:194` | private symbol '_Br06ThinPartHandler' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_08.py:101` | private symbol '_Br08ColorSpaceUtils' used in 5 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_08.py:463` | private symbol '_Br08Exporter' used in 2 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_08.py:384` | private symbol '_Br08HoleFiller' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_08.py:128` | private symbol '_Br08ImageLoader' used in 2 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_08.py:32` | private symbol '_Br08MemoryManager' used in 4 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_08.py:191` | private symbol '_Br08ModelSelector' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_08.py:215` | private symbol '_Br08MultiModelSegmenter' used in 8 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_08.py:74` | private symbol '_Br08ProcessingConfig' used in 6 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_08.py:146` | private symbol '_Br08QualityAnalyzer' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_08.py:157` | private symbol '_Br08SubjectDetector' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_08.py:408` | private symbol '_Br08WoodBackgroundRemover' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_08.py:493` | private symbol '_Br08ZoziBackgroundRemover' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_11.py:60` | private symbol '_Br11AISegmenter' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_11.py:198` | private symbol '_Br11ArtifactIsolator' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_11.py:132` | private symbol '_Br11EdgeShaver' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_11.py:218` | private symbol '_Br11Exporter' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_11.py:152` | private symbol '_Br11GlobalBackgroundBleeder' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_11.py:54` | private symbol '_Br11MemoryManager' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_11.py:47` | private symbol '_Br11ProcessingConfig' used in 3 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_12.py:54` | private symbol '_Br12AISegmenter' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_12.py:196` | private symbol '_Br12BottomTextEraser' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_12.py:238` | private symbol '_Br12EdgeShaver' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_12.py:277` | private symbol '_Br12Exporter' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_12.py:140` | private symbol '_Br12FloatingArtifactRemover' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_12.py:248` | private symbol '_Br12GlobalBackgroundBleeder' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_12.py:48` | private symbol '_Br12MemoryManager' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_12.py:41` | private symbol '_Br12ProcessingConfig' used in 3 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_13.py:53` | private symbol '_Br13AISegmenter' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_13.py:216` | private symbol '_Br13BottomTextEraser' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_13.py:138` | private symbol '_Br13EdgeShaver' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_13.py:241` | private symbol '_Br13Exporter' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_13.py:176` | private symbol '_Br13FloatingArtifactRemover' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_13.py:148` | private symbol '_Br13GlobalBackgroundBleeder' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_13.py:47` | private symbol '_Br13MemoryManager' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_13.py:40` | private symbol '_Br13ProcessingConfig' used in 3 external module(s) | make it public (remove _) or keep internal and refactor external usages |
| 🟡 | API2 | backend | `backend\providers\legacy\br_05.py:96` | private symbol '_Config' used in 6 external module(s) | make it public (remove _) or keep internal and refactor external usages |
...
| 🟡 | API2 | backend | `backend\providers\legacy\br_08.py:232` | private symbol '_check_model_availability' used in 4 external module(s) | make it public (remove _) or keep internal and refactor external usages |
...
| 🟡 | API2 | backend | `backend\providers\legacy\br_08.py:275` | private symbol '_generate_probability_map' used in 4 external module(s) | make it public (remove _) or keep internal and refactor external usages |
...
| 🟡 | CA2 | services | `backend\services\geography\country_rls_service.py` | file contains signals for 4 domains: configuration(2), geography(2), finance(2), core(2) — split candidate | split this file into domain-specific modules; each file should serve one domain |
...
| 🟡 | CA2 | services | `backend\services\geography\country_tax_service.py` | file contains signals for 3 domains: catalog(4), finance(4), geography(2) — split candidate | split this file into domain-specific modules; each file should serve one domain |
| 🟡 | CA2 | services | `backend\services\geography\country_write_service.py` | file contains signals for 6 domains: geography(37), configuration(17), comms(6), finance(5), supplier(4), logistics(3) — split candidate | split this file into domain-specific modules; each file should serve one domain |
...
| 🟡 | CA2 | services | `backend\services\comms\tickets_write_service.py` | file contains signals for 3 domains: comms(10), finance(9), orders(4) — split candidate | split this file into domain-specific modules; each file should serve one domain |
...
| 🟡 | D3 | backend | `providers.hr.br_08, providers.legacy.br_08:90` | class name 'LegacySubjectCategory' is defined in 2 modules | rename or consolidate; duplicate class names create import/confusion drift |
...
| 🟡 | DBA02 | dev | `backend\services\commerce\promotion_engine_service.py:41` | create_all present but appears dev-gated | ensure impossible in production |
...
| 🟡 | DG2 | backend | `backend\models\__init__.py` | circular module dependency: models -> models._exports -> models.country.country_basics -> models.geography.country_basics -> models.geography -> models | break the cycle by extracting shared logic into a lower layer (utils/service interface) |
...
| 🟡 | DG2 | backend | `backend\models\__init__.py` | circular module dependency: models -> models._exports -> models.communication.marketing -> models.comms.marketing -> models.comms -> models | break the cycle by extracting shared logic into a lower layer (utils/service interface) |
...
| 🟡 | DG2 | backend | `backend\models\__init__.py` | circular module dependency: models -> models._exports -> models.security.permissions -> models.security -> models | break the cycle by extracting shared logic into a lower layer (utils/service interface) |
...
| 🟡 | DOM2 | models | `backend/models/` | 1 file(s) in backend/models/communication/ are in the wrong sub-folder; detected domain: 'core' | mkdir -p backend/models/core; move: backend\models\communication\core.py (detected from core) |
| 🟡 | DOM2 | models | `backend/models/` | 1 file(s) in backend/models/communication/ are in the wrong sub-folder; detected domain: 'supplier' | mkdir -p backend/models/supplier; move: backend\models\communication\suppliers.py (detected from suppliers) |
...
| 🟡 | DOM2 | services | `backend/services/` | 1 file(s) in backend/services/country/ are in the wrong sub-folder; detected domain: 'logistics' | mkdir -p backend/services/logistics; move: backend\services\country\map_service.py (detected from map) |
...
| 🟡 | HL601 | concurrency | `backend\services\geography\country_ai_research.py` | sequential external calls: _fetch_web_evidence (2 calls), _generate_ai_modules (2 calls) | use asyncio.gather or ThreadPoolExecutor; add timeout + retry |
| 🟡 | HL601 | concurrency | `backend\services\geography\country_data_orchestrator.py` | sequential external calls: __aenter__ (2 calls) | use asyncio.gather or ThreadPoolExecutor; add timeout + retry |
| 🟡 | HL601 | concurrency | `backend\services\geography\country_detection.py` | sequential external calls: _lookup_ipapi (2 calls) | use asyncio.gather or ThreadPoolExecutor; add timeout + retry |
...
| 🟡 | HL601 | concurrency | `backend\providers\logistics\map.py` | sequential external calls: _resolve_ip (2 calls), _reverse_geocode (2 calls) | use asyncio.gather or ThreadPoolExecutor; add timeout + retry |
...
| 🟡 | HL602 | concurrency | `backend\utils\backup.py` | external call(s) missing timeout: _s3_client:324 | always set timeout; add retry + circuit breaker |
| 🟡 | HL602 | concurrency | `backend\utils\config.py` | external call(s) missing timeout: _load_field_encryption_key_from_aws_ssm:393 | always set timeout; add retry + circuit breaker |
...
| 🟡 | HL602 | concurrency | `backend\services\geography\country_ai_research.py` | external call(s) missing timeout: _fetch_web_evidence:381, _generate_ai_modules:415 | always set timeout; add retry + circuit breaker |
| 🟡 | HL602 | concurrency | `backend\services\geography\country_data_orchestrator.py` | external call(s) missing timeout: __aenter__:35 | always set timeout; add retry + circuit breaker |
| 🟡 | HL602 | concurrency | `backend\services\geography\country_detection.py` | external call(s) missing timeout: _lookup_ipapi:115 | always set timeout; add retry + circuit breaker |
...
| 🟡 | HL602 | concurrency | `backend\services\finance\payments_gateway_service.py` | external call(s) missing timeout: test_payment_gateway_connection:1599, create_payment_intent:2366, create_payment_intent:2311, create_stripe_checkout_session:2417, confirm_card_payment:2515, confirm_card_payment:2490 | always set timeout; add retry + circuit breaker |
...
| 🟡 | HL602 | concurrency | `backend\providers\logistics\map.py` | external call(s) missing timeout: _resolve_ip:41, _reverse_geocode:87 | always set timeout; add retry + circuit breaker |
...
| 🟡 | HL602 | concurrency | `backend\controllers\orders\returns_controller.py` | external call(s) missing timeout: update_return_request:460 | always set timeout; add retry + circuit breaker |
...
| 🟢 | MET1 | repo | `architecture-debt` | UNIFIED debt score = 118124 | - |
...
| 🟡 | MR101 | memory | `backend\controllers\supplier\supplier_controller.py` | nested list comprehension: get_supplier_orders:1041 | use generator expression for large datasets |
| 🟡 | MR101 | memory | `backend\controllers\orders\orders_controller.py` | nested list comprehension: get_orders:1026 | use generator expression for large datasets |
...
| 🟡 | MV1 | controllers | `backend/controllers/` | 1 'comms' domain file(s) at backend/controllers/ root should be moved to backend/controllers/comms/ | mkdir -p backend/controllers/comms; move: backend\controllers\comm_controller.py (detected from comm, comms) |
...
| 🟡 | PERF2 | backend | `backend\utils\rls_interceptor.py` | 2 possible DB query inside loop (N+1 risk) in this file; batch queries / use joins / preload relationships (lines: 527, 530) | batch the query / use joins / preload relationships instead of querying per item |
...
| 🟡 | QUAL1 | backend | `backend\providers\hr\br_05.py` | 1 weak exception handling location(s) in this file; log or re-raise instead of swallowing exceptions (lines: 136) | log or re-raise; silent swallowing hides bugs |
...
| 🟡 | QUAL3 | backend | `backend\services\comms\payout_notification_service.py:298` | oversized function 'notify_logistics_partners_of_payout' (132 lines) | extract smaller functions / service methods; long functions hide side effects |
...
| 🟡 | QUAL4 | backend | `backend\providers\hr\br_05.py` | 10 print/debug output location(s) in this file; use structured logging instead of print() (lines: 280, 286, 288, 289, 290, 291, 292, 293, 294, 301) | use structured logging instead of print() |
| 🟡 | QUAL4 | backend | `backend\providers\hr\br_06.py` | 10 print/debug output location(s) in this file; use structured logging instead of print() (lines: 419, 425, 427, 428, 429, 430, 431, 432, 433, 440) | use structured logging instead of print() |
| 🟡 | QUAL4 | backend | `backend\providers\hr\br_08.py` | 13 print/debug output location(s) in this file; use structured logging instead of print() (lines: 622, 625, 626, 627, 633, 634, 643, 653, 654, 658 +3 more) | use structured logging instead of print() |
| 🟡 | QUAL4 | backend | `backend\providers\hr\br_11.py` | 6 print/debug output location(s) in this file; use structured logging instead of print() (lines: 282, 285, 289, 297, 300, 305) | use structured logging instead of print() |
| 🟡 | QUAL4 | backend | `backend\providers\hr\br_12.py` | 7 print/debug output location(s) in this file; use structured logging instead of print() (lines: 343, 346, 347, 351, 359, 362, 367) | use structured logging instead of print() |
| 🟡 | QUAL4 | backend | `backend\providers\hr\br_13.py` | 7 print/debug output location(s) in this file; use structured logging instead of print() (lines: 307, 310, 311, 315, 323, 326, 331) | use structured logging instead of print() |
| 🟡 | QUAL4 | backend | `backend\providers\hr\check_BiRefNet.py` | 4 print/debug output location(s) in this file; use structured logging instead of print() (lines: 10, 12, 13, 17) | use structured logging instead of print() |
...
| 🟡 | SYM2 | backend | `providers.legacy.br_08:90, providers.hr.br_08:90` | class 'LegacySubjectCategory' defined in 2 modules | consolidate into one canonical definition |
...
| 🟡 | SYM2 | backend | `providers.legacy.br_05:153, providers.hr.br_05:153` | class '_Br05BackgroundRemover' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_05:105, providers.hr.br_05:105` | class '_Br05CleanEdgeRefiner' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_05:33, providers.hr.br_05:33` | class '_Br05ColoredFormatter' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_05:56, providers.hr.br_05:56` | class '_Br05Deps' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_06:281, providers.hr.br_06:281` | class '_Br06BackgroundRemover' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_06:33, providers.hr.br_06:33` | class '_Br06ColoredFormatter' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_06:53, providers.hr.br_06:53` | class '_Br06Deps' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_06:243, providers.hr.br_06:243` | class '_Br06EdgeRefiner' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_06:110, providers.hr.br_06:110` | class '_Br06HandRemover' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_06:153, providers.hr.br_06:153` | class '_Br06HoleFiller' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_06:219, providers.hr.br_06:219` | class '_Br06HumanPreserver' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_06:98, providers.hr.br_06:98` | class '_Br06SceneAnalyzer' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_06:194, providers.hr.br_06:194` | class '_Br06ThinPartHandler' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_08:101, providers.hr.br_08:101` | class '_Br08ColorSpaceUtils' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_08:463, providers.hr.br_08:463` | class '_Br08Exporter' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_08:384, providers.hr.br_08:384` | class '_Br08HoleFiller' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_08:128, providers.hr.br_08:128` | class '_Br08ImageLoader' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_08:32, providers.hr.br_08:32` | class '_Br08MemoryManager' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_08:191, providers.hr.br_08:191` | class '_Br08ModelSelector' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_08:215, providers.hr.br_08:215` | class '_Br08MultiModelSegmenter' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_08:74, providers.hr.br_08:74` | class '_Br08ProcessingConfig' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_08:146, providers.hr.br_08:146` | class '_Br08QualityAnalyzer' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_08:157, providers.hr.br_08:157` | class '_Br08SubjectDetector' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_08:408, providers.hr.br_08:408` | class '_Br08WoodBackgroundRemover' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_08:493, providers.hr.br_08:493` | class '_Br08ZoziBackgroundRemover' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_11:60, providers.hr.br_11:60` | class '_Br11AISegmenter' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_11:198, providers.hr.br_11:198` | class '_Br11ArtifactIsolator' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_11:132, providers.hr.br_11:132` | class '_Br11EdgeShaver' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_11:218, providers.hr.br_11:218` | class '_Br11Exporter' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_11:152, providers.hr.br_11:152` | class '_Br11GlobalBackgroundBleeder' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_11:54, providers.hr.br_11:54` | class '_Br11MemoryManager' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_11:47, providers.hr.br_11:47` | class '_Br11ProcessingConfig' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_12:54, providers.hr.br_12:54` | class '_Br12AISegmenter' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_12:196, providers.hr.br_12:196` | class '_Br12BottomTextEraser' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_12:238, providers.hr.br_12:238` | class '_Br12EdgeShaver' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_12:277, providers.hr.br_12:277` | class '_Br12Exporter' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_12:140, providers.hr.br_12:140` | class '_Br12FloatingArtifactRemover' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_12:248, providers.hr.br_12:248` | class '_Br12GlobalBackgroundBleeder' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_12:48, providers.hr.br_12:48` | class '_Br12MemoryManager' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_12:41, providers.hr.br_12:41` | class '_Br12ProcessingConfig' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_13:53, providers.hr.br_13:53` | class '_Br13AISegmenter' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_13:216, providers.hr.br_13:216` | class '_Br13BottomTextEraser' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_13:138, providers.hr.br_13:138` | class '_Br13EdgeShaver' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_13:241, providers.hr.br_13:241` | class '_Br13Exporter' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_13:176, providers.hr.br_13:176` | class '_Br13FloatingArtifactRemover' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_13:148, providers.hr.br_13:148` | class '_Br13GlobalBackgroundBleeder' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_13:47, providers.hr.br_13:47` | class '_Br13MemoryManager' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_13:40, providers.hr.br_13:40` | class '_Br13ProcessingConfig' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_05:96, providers.legacy.br_06:90, providers.hr.br_05:96, providers.hr.br_06:90` | class '_Config' defined in 4 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `providers.legacy.br_08:97, providers.hr.br_08:97` | class '_FusionStrategy' defined in 2 modules | consolidate into one canonical definition |
| 🟡 | SYM2 | backend | `services.ai.bg_removal_service:386, providers.hr.bg_remover:191` | class '_SessionManager' defined in 2 modules | consolidate into one canonical definition |
...
| 🟡 | SYM2 | backend | `routers.supplier_supplier_routes:255, controllers.supplier.supplier_controller:2936` | public function 'bulk_upload_products' defined in 2 modules | consolidate or rename to avoid confusion |
...
| 🟡 | W4 | backend | `backend\controllers\comm_controller.py:2` | controller imports another controller ('controllers.comms.comm_controller') | extract shared logic into a service or util; controllers stay thin |
...
- 🟢 **I4** `move-map` — 36 file move suggestions generated
...
- 🟢 **I1** `.` — backend models=63 routers=152 controllers=86 services=350 middleware=22
- 🟢 **I2** `documents/scope/` — rules loaded from: embedded defaults
- 🟢 **I3** `backend/` — module graph: modules=1012, edges=2623, classes=1144
- 🟢 **MET1** `architecture-debt` — UNIFIED debt score = 118124

### BACKEND (792 findings)
...
- 🟢 **DOM8** `backend/` — 247 scanned file(s) are already in the correct domain folder → *keep these placements; do not move them*
...
- 🟡 **W4** `backend\controllers\comm_controller.py:2` — controller imports another controller ('controllers.comms.comm_controller') → *extract shared logic into a service or util; controllers stay thin*
...
- 🟡 **DG2** `backend\models\__init__.py` — circular module dependency: models -> models._exports -> models.country.country_basics -> models.geography.country_basics -> models.geography -> models → *break the cycle by extracting shared logic into a lower layer (utils/service interface)*
...
- 🟡 **DG2** `backend\models\__init__.py` — circular module dependency: models -> models._exports -> models.communication.marketing -> models.comms.marketing -> models.comms -> models → *break the cycle by extracting shared logic into a lower layer (utils/service interface)*
...
- 🟡 **DG2** `backend\models\__init__.py` — circular module dependency: models -> models._exports -> models.security.permissions -> models.security -> models → *break the cycle by extracting shared logic into a lower layer (utils/service interface)*
...
- 🟡 **D3** `providers.hr.br_08, providers.legacy.br_08:90` — class name 'LegacySubjectCategory' is defined in 2 modules → *rename or consolidate; duplicate class names create import/confusion drift*
...
- 🟡 **SYM2** `providers.legacy.br_08:90, providers.hr.br_08:90` — class 'LegacySubjectCategory' defined in 2 modules → *consolidate into one canonical definition*
...
- 🟡 **SYM2** `providers.legacy.br_05:153, providers.hr.br_05:153` — class '_Br05BackgroundRemover' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_05:105, providers.hr.br_05:105` — class '_Br05CleanEdgeRefiner' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_05:33, providers.hr.br_05:33` — class '_Br05ColoredFormatter' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_05:56, providers.hr.br_05:56` — class '_Br05Deps' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_06:281, providers.hr.br_06:281` — class '_Br06BackgroundRemover' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_06:33, providers.hr.br_06:33` — class '_Br06ColoredFormatter' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_06:53, providers.hr.br_06:53` — class '_Br06Deps' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_06:243, providers.hr.br_06:243` — class '_Br06EdgeRefiner' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_06:110, providers.hr.br_06:110` — class '_Br06HandRemover' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_06:153, providers.hr.br_06:153` — class '_Br06HoleFiller' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_06:219, providers.hr.br_06:219` — class '_Br06HumanPreserver' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_06:98, providers.hr.br_06:98` — class '_Br06SceneAnalyzer' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_06:194, providers.hr.br_06:194` — class '_Br06ThinPartHandler' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_08:101, providers.hr.br_08:101` — class '_Br08ColorSpaceUtils' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_08:463, providers.hr.br_08:463` — class '_Br08Exporter' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_08:384, providers.hr.br_08:384` — class '_Br08HoleFiller' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_08:128, providers.hr.br_08:128` — class '_Br08ImageLoader' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_08:32, providers.hr.br_08:32` — class '_Br08MemoryManager' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_08:191, providers.hr.br_08:191` — class '_Br08ModelSelector' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_08:215, providers.hr.br_08:215` — class '_Br08MultiModelSegmenter' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_08:74, providers.hr.br_08:74` — class '_Br08ProcessingConfig' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_08:146, providers.hr.br_08:146` — class '_Br08QualityAnalyzer' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_08:157, providers.hr.br_08:157` — class '_Br08SubjectDetector' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_08:408, providers.hr.br_08:408` — class '_Br08WoodBackgroundRemover' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_08:493, providers.hr.br_08:493` — class '_Br08ZoziBackgroundRemover' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_11:60, providers.hr.br_11:60` — class '_Br11AISegmenter' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_11:198, providers.hr.br_11:198` — class '_Br11ArtifactIsolator' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_11:132, providers.hr.br_11:132` — class '_Br11EdgeShaver' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_11:218, providers.hr.br_11:218` — class '_Br11Exporter' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_11:152, providers.hr.br_11:152` — class '_Br11GlobalBackgroundBleeder' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_11:54, providers.hr.br_11:54` — class '_Br11MemoryManager' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_11:47, providers.hr.br_11:47` — class '_Br11ProcessingConfig' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_12:54, providers.hr.br_12:54` — class '_Br12AISegmenter' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_12:196, providers.hr.br_12:196` — class '_Br12BottomTextEraser' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_12:238, providers.hr.br_12:238` — class '_Br12EdgeShaver' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_12:277, providers.hr.br_12:277` — class '_Br12Exporter' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_12:140, providers.hr.br_12:140` — class '_Br12FloatingArtifactRemover' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_12:248, providers.hr.br_12:248` — class '_Br12GlobalBackgroundBleeder' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_12:48, providers.hr.br_12:48` — class '_Br12MemoryManager' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_12:41, providers.hr.br_12:41` — class '_Br12ProcessingConfig' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_13:53, providers.hr.br_13:53` — class '_Br13AISegmenter' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_13:216, providers.hr.br_13:216` — class '_Br13BottomTextEraser' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_13:138, providers.hr.br_13:138` — class '_Br13EdgeShaver' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_13:241, providers.hr.br_13:241` — class '_Br13Exporter' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_13:176, providers.hr.br_13:176` — class '_Br13FloatingArtifactRemover' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_13:148, providers.hr.br_13:148` — class '_Br13GlobalBackgroundBleeder' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_13:47, providers.hr.br_13:47` — class '_Br13MemoryManager' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_13:40, providers.hr.br_13:40` — class '_Br13ProcessingConfig' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_05:96, providers.legacy.br_06:90, providers.hr.br_05:96, providers.hr.br_06:90` — class '_Config' defined in 4 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `providers.legacy.br_08:97, providers.hr.br_08:97` — class '_FusionStrategy' defined in 2 modules → *consolidate into one canonical definition*
- 🟡 **SYM2** `services.ai.bg_removal_service:386, providers.hr.bg_remover:191` — class '_SessionManager' defined in 2 modules → *consolidate into one canonical definition*
...
- 🟡 **SYM2** `routers.supplier_supplier_routes:255, controllers.supplier.supplier_controller:2936` — public function 'bulk_upload_products' defined in 2 modules → *consolidate or rename to avoid confusion*
...
- 🟡 **API2** `backend\providers\legacy\br_05.py:153` — private symbol '_Br05BackgroundRemover' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_05.py:105` — private symbol '_Br05CleanEdgeRefiner' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_05.py:33` — private symbol '_Br05ColoredFormatter' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_05.py:56` — private symbol '_Br05Deps' used in 6 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_06.py:281` — private symbol '_Br06BackgroundRemover' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_06.py:33` — private symbol '_Br06ColoredFormatter' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_06.py:53` — private symbol '_Br06Deps' used in 6 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_06.py:243` — private symbol '_Br06EdgeRefiner' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_06.py:110` — private symbol '_Br06HandRemover' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_06.py:153` — private symbol '_Br06HoleFiller' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_06.py:219` — private symbol '_Br06HumanPreserver' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_06.py:98` — private symbol '_Br06SceneAnalyzer' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_06.py:194` — private symbol '_Br06ThinPartHandler' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_08.py:101` — private symbol '_Br08ColorSpaceUtils' used in 5 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_08.py:463` — private symbol '_Br08Exporter' used in 2 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_08.py:384` — private symbol '_Br08HoleFiller' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_08.py:128` — private symbol '_Br08ImageLoader' used in 2 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_08.py:32` — private symbol '_Br08MemoryManager' used in 4 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_08.py:191` — private symbol '_Br08ModelSelector' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_08.py:215` — private symbol '_Br08MultiModelSegmenter' used in 8 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_08.py:74` — private symbol '_Br08ProcessingConfig' used in 6 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_08.py:146` — private symbol '_Br08QualityAnalyzer' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_08.py:157` — private symbol '_Br08SubjectDetector' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_08.py:408` — private symbol '_Br08WoodBackgroundRemover' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_08.py:493` — private symbol '_Br08ZoziBackgroundRemover' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_11.py:60` — private symbol '_Br11AISegmenter' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_11.py:198` — private symbol '_Br11ArtifactIsolator' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_11.py:132` — private symbol '_Br11EdgeShaver' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_11.py:218` — private symbol '_Br11Exporter' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_11.py:152` — private symbol '_Br11GlobalBackgroundBleeder' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_11.py:54` — private symbol '_Br11MemoryManager' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_11.py:47` — private symbol '_Br11ProcessingConfig' used in 3 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_12.py:54` — private symbol '_Br12AISegmenter' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_12.py:196` — private symbol '_Br12BottomTextEraser' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_12.py:238` — private symbol '_Br12EdgeShaver' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_12.py:277` — private symbol '_Br12Exporter' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_12.py:140` — private symbol '_Br12FloatingArtifactRemover' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_12.py:248` — private symbol '_Br12GlobalBackgroundBleeder' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_12.py:48` — private symbol '_Br12MemoryManager' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_12.py:41` — private symbol '_Br12ProcessingConfig' used in 3 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_13.py:53` — private symbol '_Br13AISegmenter' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_13.py:216` — private symbol '_Br13BottomTextEraser' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_13.py:138` — private symbol '_Br13EdgeShaver' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_13.py:241` — private symbol '_Br13Exporter' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_13.py:176` — private symbol '_Br13FloatingArtifactRemover' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_13.py:148` — private symbol '_Br13GlobalBackgroundBleeder' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_13.py:47` — private symbol '_Br13MemoryManager' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_13.py:40` — private symbol '_Br13ProcessingConfig' used in 3 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
- 🟡 **API2** `backend\providers\legacy\br_05.py:96` — private symbol '_Config' used in 6 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
...
- 🟡 **API2** `backend\providers\legacy\br_08.py:232` — private symbol '_check_model_availability' used in 4 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
...
- 🟡 **API2** `backend\providers\legacy\br_08.py:275` — private symbol '_generate_probability_map' used in 4 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
...
- 🟡 **QUAL3** `backend\services\comms\payout_notification_service.py:298` — oversized function 'notify_logistics_partners_of_payout' (132 lines) → *extract smaller functions / service methods; long functions hide side effects*
...
- 🟡 **DBA32** `backend\controllers\security\auth_controller.py:1521` — OFFSET pagination detected → *use cursor-based pagination*
...
- 🟡 **DBA32** `backend\controllers\orders\orders_controller.py:1020` — OFFSET pagination detected → *use cursor-based pagination*
...
- 🟡 **DBA32** `backend\controllers\comms\admin_tickets_controller.py:23` — OFFSET pagination detected → *use cursor-based pagination*
...
- 🟡 **DBA32** `backend\controllers\catalog\products_controller.py:389` — OFFSET pagination detected → *use cursor-based pagination*
...
- 🟡 **DBA32** `backend\services\core\command_center_service.py:534` — OFFSET pagination detected → *use cursor-based pagination*
...
- 🟡 **DBA32** `backend\services\comms\chat_read_service.py:34` — OFFSET pagination detected → *use cursor-based pagination*
- 🟡 **DBA32** `backend\services\comms\communication_audit.py:62` — OFFSET pagination detected → *use cursor-based pagination*
- 🟡 **DBA32** `backend\services\comms\email_gateway.py:326` — OFFSET pagination detected → *use cursor-based pagination*
- 🟡 **DBA32** `backend\services\comms\email_management_service.py:75` — OFFSET pagination detected → *use cursor-based pagination*
- 🟡 **DBA32** `backend\services\comms\email_write_service.py:168` — OFFSET pagination detected → *use cursor-based pagination*
- 🟡 **DBA32** `backend\services\comms\entity_chat_service.py:49` — OFFSET pagination detected → *use cursor-based pagination*
- 🟡 **DBA32** `backend\services\comms\entity_messaging.py:52` — OFFSET pagination detected → *use cursor-based pagination*
- 🟡 **DBA32** `backend\services\comms\internal_communication.py:258` — OFFSET pagination detected → *use cursor-based pagination*
- 🟡 **DBA32** `backend\services\comms\proxy_communication.py:82` — OFFSET pagination detected → *use cursor-based pagination*
- 🟡 **DBA32** `backend\services\comms\push_notifications_service.py:82` — OFFSET pagination detected → *use cursor-based pagination*
- 🟡 **DBA32** `backend\services\comms\tickets_write_service.py:48` — OFFSET pagination detected → *use cursor-based pagination*
...
- 🟡 **DBA32** `backend\services\commerce\promotion_engine_service.py:243` — OFFSET pagination detected → *use cursor-based pagination*
...
- 🟡 **PERF2** `backend\utils\rls_interceptor.py` — 2 possible DB query inside loop (N+1 risk) in this file; batch queries / use joins / preload relationships (lines: 527, 530) → *batch the query / use joins / preload relationships instead of querying per item*
...
- 🟡 **QUAL1** `backend\providers\hr\br_05.py` — 1 weak exception handling location(s) in this file; log or re-raise instead of swallowing exceptions (lines: 136) → *log or re-raise; silent swallowing hides bugs*
...
- 🟡 **QUAL4** `backend\providers\hr\br_05.py` — 10 print/debug output location(s) in this file; use structured logging instead of print() (lines: 280, 286, 288, 289, 290, 291, 292, 293, 294, 301) → *use structured logging instead of print()*
- 🟡 **QUAL4** `backend\providers\hr\br_06.py` — 10 print/debug output location(s) in this file; use structured logging instead of print() (lines: 419, 425, 427, 428, 429, 430, 431, 432, 433, 440) → *use structured logging instead of print()*
- 🟡 **QUAL4** `backend\providers\hr\br_08.py` — 13 print/debug output location(s) in this file; use structured logging instead of print() (lines: 622, 625, 626, 627, 633, 634, 643, 653, 654, 658 +3 more) → *use structured logging instead of print()*
- 🟡 **QUAL4** `backend\providers\hr\br_11.py` — 6 print/debug output location(s) in this file; use structured logging instead of print() (lines: 282, 285, 289, 297, 300, 305) → *use structured logging instead of print()*
- 🟡 **QUAL4** `backend\providers\hr\br_12.py` — 7 print/debug output location(s) in this file; use structured logging instead of print() (lines: 343, 346, 347, 351, 359, 362, 367) → *use structured logging instead of print()*
- 🟡 **QUAL4** `backend\providers\hr\br_13.py` — 7 print/debug output location(s) in this file; use structured logging instead of print() (lines: 307, 310, 311, 315, 323, 326, 331) → *use structured logging instead of print()*
- 🟡 **QUAL4** `backend\providers\hr\check_BiRefNet.py` — 4 print/debug output location(s) in this file; use structured logging instead of print() (lines: 10, 12, 13, 17) → *use structured logging instead of print()*
...
- 🟡 **DBA08** `backend\models\geography\countries.py:15` — FK column 'country_configs.basics_id' has no explicit index signal → *every FK should have an explicit index*
- 🟡 **DBA07** `backend\models\geography\countries.py:15` — FK 'country_configs.basics_id' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🟡 **DBA07** `backend\models\geography\countries.py:143` — FK 'country_communications.country_code' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\countries.py:144` — cross-schema FK: country_communications.from_user_id -> core.users.id → *use services/events, not FKs*
- 🟡 **DBA08** `backend\models\geography\countries.py:144` — FK column 'country_communications.from_user_id' has no explicit index signal → *every FK should have an explicit index*
- 🟡 **DBA07** `backend\models\geography\countries.py:144` — FK 'country_communications.from_user_id' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\countries.py:145` — cross-schema FK: country_communications.to_user_id -> core.users.id → *use services/events, not FKs*
- 🟡 **DBA07** `backend\models\geography\countries.py:145` — FK 'country_communications.to_user_id' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🟡 **DBA07** `backend\models\geography\countries.py:169` — FK 'country_gateway_credentials.country_code' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\countries.py:185` — cross-schema FK: payout_rules.country_code -> country.country_configs.code → *use services/events, not FKs*
- 🟡 **DBA07** `backend\models\geography\countries.py:185` — FK 'payout_rules.country_code' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🟡 **DBA07** `backend\models\geography\countries.py:202` — FK 'tax_rules.country_code' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\countries.py:217` — cross-schema FK: shipping_rules.country_code -> country.country_configs.code → *use services/events, not FKs*
- 🟡 **DBA07** `backend\models\geography\countries.py:217` — FK 'shipping_rules.country_code' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🟡 **DBA07** `backend\models\geography\countries.py:235` — FK 'messages.country_code' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\countries.py:236` — cross-schema FK: messages.from_user_id -> core.users.id → *use services/events, not FKs*
- 🟡 **DBA07** `backend\models\geography\countries.py:236` — FK 'messages.from_user_id' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\countries.py:237` — cross-schema FK: messages.to_user_id -> core.users.id → *use services/events, not FKs*
- 🟡 **DBA07** `backend\models\geography\countries.py:237` — FK 'messages.to_user_id' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🟡 **DBA07** `backend\models\geography\countries.py:261` — FK 'payout_rule_categories.country_code' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🟡 **DBA07** `backend\models\geography\countries.py:280` — FK 'payout_rule_products.country_code' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\countries.py:281` — cross-schema FK: payout_rule_products.product_id -> commerce.products.id → *use services/events, not FKs*
- 🟡 **DBA07** `backend\models\geography\countries.py:281` — FK 'payout_rule_products.product_id' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🟡 **DBA07** `backend\models\geography\country_economics.py:32` — FK 'country_economics.country_code' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\country_enhancements.py:25` — cross-schema FK: country_feature_flags.country_code -> country.country_configs.code → *use services/events, not FKs*
- 🟡 **DBA07** `backend\models\geography\country_enhancements.py:25` — FK 'country_feature_flags.country_code' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\country_enhancements.py:47` — cross-schema FK: country_staff_assignments.user_id -> core.users.id → *use services/events, not FKs*
- 🟡 **DBA07** `backend\models\geography\country_enhancements.py:47` — FK 'country_staff_assignments.user_id' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\country_enhancements.py:48` — cross-schema FK: country_staff_assignments.country_code -> country.country_configs.code → *use services/events, not FKs*
- 🟡 **DBA07** `backend\models\geography\country_enhancements.py:48` — FK 'country_staff_assignments.country_code' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\country_enhancements.py:51` — cross-schema FK: country_staff_assignments.assigned_by -> core.users.id → *use services/events, not FKs*
- 🟡 **DBA08** `backend\models\geography\country_enhancements.py:51` — FK column 'country_staff_assignments.assigned_by' has no explicit index signal → *every FK should have an explicit index*
- 🟡 **DBA07** `backend\models\geography\country_enhancements.py:51` — FK 'country_staff_assignments.assigned_by' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\country_enhancements.py:67` — cross-schema FK: cross_country_customer_sessions.user_id -> core.users.id → *use services/events, not FKs*
- 🟡 **DBA07** `backend\models\geography\country_enhancements.py:67` — FK 'cross_country_customer_sessions.user_id' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\country_enhancements.py:72` — cross-schema FK: cross_country_customer_sessions.order_id -> commerce.orders.id → *use services/events, not FKs*
- 🟡 **DBA08** `backend\models\geography\country_enhancements.py:72` — FK column 'cross_country_customer_sessions.order_id' has no explicit index signal → *every FK should have an explicit index*
- 🟡 **DBA07** `backend\models\geography\country_enhancements.py:72` — FK 'cross_country_customer_sessions.order_id' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\country_enhancements.py:110` — cross-schema FK: country_config_versions.country_code -> country.country_configs.code → *use services/events, not FKs*
- 🟡 **DBA07** `backend\models\geography\country_enhancements.py:110` — FK 'country_config_versions.country_code' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\country_enhancements.py:115` — cross-schema FK: country_config_versions.draft_by -> core.users.id → *use services/events, not FKs*
- 🟡 **DBA08** `backend\models\geography\country_enhancements.py:115` — FK column 'country_config_versions.draft_by' has no explicit index signal → *every FK should have an explicit index*
- 🟡 **DBA07** `backend\models\geography\country_enhancements.py:115` — FK 'country_config_versions.draft_by' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\country_enhancements.py:116` — cross-schema FK: country_config_versions.approved_by -> core.users.id → *use services/events, not FKs*
- 🟡 **DBA08** `backend\models\geography\country_enhancements.py:116` — FK column 'country_config_versions.approved_by' has no explicit index signal → *every FK should have an explicit index*
- 🟡 **DBA07** `backend\models\geography\country_enhancements.py:116` — FK 'country_config_versions.approved_by' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🟡 **DBA07** `backend\models\geography\country_enhancements.py:132` — FK 'supplier_kyc_requirements.country_code' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🟡 **DBA07** `backend\models\geography\country_enhancements.py:150` — FK 'logistics_partner_kyc_requirements.country_code' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\country_enhancements.py:168` — cross-schema FK: country_commission_rates.country_code -> country.country_configs.code → *use services/events, not FKs*
- 🟡 **DBA07** `backend\models\geography\country_enhancements.py:168` — FK 'country_commission_rates.country_code' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\country_enhancements.py:185` — cross-schema FK: country_localization.country_code -> country.country_configs.code → *use services/events, not FKs*
- 🟡 **DBA07** `backend\models\geography\country_enhancements.py:185` — FK 'country_localization.country_code' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\country_enhancements.py:204` — cross-schema FK: country_payment_aliases.country_code -> country.country_configs.code → *use services/events, not FKs*
- 🟡 **DBA07** `backend\models\geography\country_enhancements.py:204` — FK 'country_payment_aliases.country_code' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\country_enhancements.py:221` — cross-schema FK: country_legal_contracts.country_code -> country.country_configs.code → *use services/events, not FKs*
- 🟡 **DBA07** `backend\models\geography\country_enhancements.py:221` — FK 'country_legal_contracts.country_code' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\country_enhancements.py:240` — cross-schema FK: country_category_tax_rates.country_code -> country.country_configs.code → *use services/events, not FKs*
- 🟡 **DBA07** `backend\models\geography\country_enhancements.py:240` — FK 'country_category_tax_rates.country_code' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\country_enhancements.py:241` — cross-schema FK: country_category_tax_rates.category_id -> commerce.categories.id → *use services/events, not FKs*
- 🟡 **DBA07** `backend\models\geography\country_enhancements.py:241` — FK 'country_category_tax_rates.category_id' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🟡 **DBA07** `backend\models\geography\country_enhancements.py:266` — FK 'country_cities.country_code' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\country_enhancements.py:293` — cross-schema FK: country_holiday_calendars.country_code -> country.country_configs.code → *use services/events, not FKs*
- 🟡 **DBA07** `backend\models\geography\country_enhancements.py:293` — FK 'country_holiday_calendars.country_code' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\country_enhancements.py:311` — cross-schema FK: country_gateway_configs.country_code -> country.country_configs.code → *use services/events, not FKs*
- 🟡 **DBA07** `backend\models\geography\country_enhancements.py:311` — FK 'country_gateway_configs.country_code' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\country_enhancements.py:335` — cross-schema FK: country_communication_threads.country_code -> country.country_configs.code → *use services/events, not FKs*
- 🟡 **DBA07** `backend\models\geography\country_enhancements.py:335` — FK 'country_communication_threads.country_code' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\country_enhancements.py:354` — cross-schema FK: country_commission_rate_history.country_code -> country.country_configs.code → *use services/events, not FKs*
- 🟡 **DBA07** `backend\models\geography\country_enhancements.py:354` — FK 'country_commission_rate_history.country_code' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\country_enhancements.py:355` — cross-schema FK: country_commission_rate_history.category_id -> commerce.categories.id → *use services/events, not FKs*
- 🟡 **DBA08** `backend\models\geography\country_enhancements.py:355` — FK column 'country_commission_rate_history.category_id' has no explicit index signal → *every FK should have an explicit index*
- 🟡 **DBA07** `backend\models\geography\country_enhancements.py:355` — FK 'country_commission_rate_history.category_id' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\country_enhancements.py:360` — cross-schema FK: country_commission_rate_history.changed_by -> core.users.id → *use services/events, not FKs*
- 🟡 **DBA08** `backend\models\geography\country_enhancements.py:360` — FK column 'country_commission_rate_history.changed_by' has no explicit index signal → *every FK should have an explicit index*
- 🟡 **DBA07** `backend\models\geography\country_enhancements.py:360` — FK 'country_commission_rate_history.changed_by' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\country_enhancements.py:376` — cross-schema FK: country_logistics_zones.country_code -> country.country_configs.code → *use services/events, not FKs*
- 🟡 **DBA07** `backend\models\geography\country_enhancements.py:376` — FK 'country_logistics_zones.country_code' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\geography\country_enhancements.py:396` — cross-schema FK: country_payout_rules.country_code -> country.country_configs.code → *use services/events, not FKs*
- 🟡 **DBA07** `backend\models\geography\country_enhancements.py:396` — FK 'country_payout_rules.country_code' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🟡 **DBA07** `backend\models\geography\country_legal.py:32` — FK 'country_legal.country_code' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
...
- 🔴 **DBA06** `backend\models\comms\communication.py:22` — cross-schema FK: notifications.user_id -> core.users.id → *use services/events, not FKs*
- 🟡 **DBA07** `backend\models\comms\communication.py:22` — FK 'notifications.user_id' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🟡 **DBA08** `backend\models\comms\communication.py:41` — FK column 'ticket_messages.ticket_id' has no explicit index signal → *every FK should have an explicit index*
- 🟡 **DBA07** `backend\models\comms\communication.py:41` — FK 'ticket_messages.ticket_id' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\comms\communication.py:42` — cross-schema FK: ticket_messages.sender_id -> core.users.id → *use services/events, not FKs*
- 🟡 **DBA08** `backend\models\comms\communication.py:42` — FK column 'ticket_messages.sender_id' has no explicit index signal → *every FK should have an explicit index*
- 🟡 **DBA07** `backend\models\comms\communication.py:42` — FK 'ticket_messages.sender_id' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🟡 **DBA08** `backend\models\comms\communication.py:100` — FK column 'proxy_sessions.channel_id' has no explicit index signal → *every FK should have an explicit index*
- 🟡 **DBA07** `backend\models\comms\communication.py:100` — FK 'proxy_sessions.channel_id' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\comms\communication.py:101` — cross-schema FK: proxy_sessions.participant_one_id -> core.users.id → *use services/events, not FKs*
- 🟡 **DBA08** `backend\models\comms\communication.py:101` — FK column 'proxy_sessions.participant_one_id' has no explicit index signal → *every FK should have an explicit index*
- 🟡 **DBA07** `backend\models\comms\communication.py:101` — FK 'proxy_sessions.participant_one_id' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\comms\communication.py:102` — cross-schema FK: proxy_sessions.participant_two_id -> core.users.id → *use services/events, not FKs*
- 🟡 **DBA08** `backend\models\comms\communication.py:102` — FK column 'proxy_sessions.participant_two_id' has no explicit index signal → *every FK should have an explicit index*
- 🟡 **DBA07** `backend\models\comms\communication.py:102` — FK 'proxy_sessions.participant_two_id' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🟡 **DBA08** `backend\models\comms\communication.py:116` — FK column 'proxy_messages.session_id' has no explicit index signal → *every FK should have an explicit index*
- 🟡 **DBA07** `backend\models\comms\communication.py:116` — FK 'proxy_messages.session_id' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\comms\communication.py:117` — cross-schema FK: proxy_messages.sender_id -> core.users.id → *use services/events, not FKs*
- 🟡 **DBA08** `backend\models\comms\communication.py:117` — FK column 'proxy_messages.sender_id' has no explicit index signal → *every FK should have an explicit index*
- 🟡 **DBA07** `backend\models\comms\communication.py:117` — FK 'proxy_messages.sender_id' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\comms\communication.py:118` — cross-schema FK: proxy_messages.recipient_id -> core.users.id → *use services/events, not FKs*
- 🟡 **DBA08** `backend\models\comms\communication.py:118` — FK column 'proxy_messages.recipient_id' has no explicit index signal → *every FK should have an explicit index*
- 🟡 **DBA07** `backend\models\comms\communication.py:118` — FK 'proxy_messages.recipient_id' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🟡 **DBA08** `backend\models\comms\communication.py:132` — FK column 'proxy_call_logs.channel_id' has no explicit index signal → *every FK should have an explicit index*
- 🟡 **DBA07** `backend\models\comms\communication.py:132` — FK 'proxy_call_logs.channel_id' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\comms\communication.py:133` — cross-schema FK: proxy_call_logs.caller_id -> core.users.id → *use services/events, not FKs*
- 🟡 **DBA08** `backend\models\comms\communication.py:133` — FK column 'proxy_call_logs.caller_id' has no explicit index signal → *every FK should have an explicit index*
- 🟡 **DBA07** `backend\models\comms\communication.py:133` — FK 'proxy_call_logs.caller_id' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
- 🔴 **DBA06** `backend\models\comms\communication.py:134` — cross-schema FK: proxy_call_logs.callee_id -> core.users.id → *use services/events, not FKs*
- 🟡 **DBA08** `backend\models\comms\communication.py:134` — FK column 'proxy_call_logs.callee_id' has no explicit index signal → *every FK should have an explicit index*
- 🟡 **DBA07** `backend\models\comms\communication.py:134` — FK 'proxy_call_logs.callee_id' missing ON DELETE rule → *default RESTRICT; CASCADE only for composition*
...
- 🟡 **DBA09** `backend\models\comms\communication.py:32` — JSONB column 'notifications.variables' has no GIN index signal → *add GIN index for JSONB filters/facets*
- 🟡 **DBA09** `backend\models\comms\communication.py:88` — JSONB column 'proxy_channels.participants' has no GIN index signal → *add GIN index for JSONB filters/facets*
- 🟡 **DBA09** `backend\models\comms\communication.py:106` — JSONB column 'proxy_sessions.session_metadata' has no GIN index signal → *add GIN index for JSONB filters/facets*
- 🟡 **DBA09** `backend\models\comms\communication.py:194` — JSONB column 'communication_audit_trail.metadata_json' has no GIN index signal → *add GIN index for JSONB filters/facets*
- 🟡 **DBA09** `backend\models\comms\communication.py:215` — JSONB column 'internal_channels.allowed_roles' has no GIN index signal → *add GIN index for JSONB filters/facets*
- 🟡 **DBA09** `backend\models\comms\core.py:74` — JSONB column 'audit_logs.details' has no GIN index signal → *add GIN index for JSONB filters/facets*
- 🟡 **DBA09** `backend\models\comms\core.py:180` — JSONB column 'command_center_views.config' has no GIN index signal → *add GIN index for JSONB filters/facets*
- 🟡 **DBA09** `backend\models\comms\core.py:210` — JSONB column 'news_articles.ai_tags' has no GIN index signal → *add GIN index for JSONB filters/facets*
- 🟡 **DBA09** `backend\models\comms\marketing.py:22` — JSONB column 'flash_sales.product_ids' has no GIN index signal → *add GIN index for JSONB filters/facets*
- 🟡 **DBA09** `backend\models\comms\marketing.py:128` — JSONB column 'email_delivery_events.details' has no GIN index signal → *add GIN index for JSONB filters/facets*
- 🟡 **DBA09** `backend\models\comms\suppliers.py:42` — JSONB column 'supplier_profiles.certifications' has no GIN index signal → *add GIN index for JSONB filters/facets*
- 🟡 **DBA09** `backend\models\comms\suppliers.py:43` — JSONB column 'supplier_profiles.social_links_json' has no GIN index signal → *add GIN index for JSONB filters/facets*
- 🟡 **DBA09** `backend\models\comms\suppliers.py:45` — JSONB column 'supplier_profiles.operating_regions' has no GIN index signal → *add GIN index for JSONB filters/facets*
- 🟡 **DBA09** `backend\models\comms\suppliers.py:46` — JSONB column 'supplier_profiles.verified_documents' has no GIN index signal → *add GIN index for JSONB filters/facets*
...
- 🟡 **DBA31** `backend\models\comms\communication.py:149` — table 'employee_communication_threads' has country_code + created_at but no composite index → *add composite index (country_code, created_at)*
...
- 🟡 **DBA18** `backend\models\comms\core.py:62` — audit_logs model missing expected columns: log_type, actor, entity, country_code, old/new_value_json → *audit_logs should have log_type, actor, entity, old/new_value_json, country_code*
...
- 🟡 **HL204** `backend\utils\auth.py` — possible secret in log (lines: 101, 104, 188) → *never log secrets; log only IDs/status*
...
- 🟡 **HL204** `backend\services\finance\payments_gateway_service.py` — possible secret in log (lines: 913) → *never log secrets; log only IDs/status*
- 🟡 **HL204** `backend\middleware\country_context.py` — possible secret in log (lines: 85) → *never log secrets; log only IDs/status*
- 🟡 **HL204** `backend\controllers\security\auth_controller.py` — possible secret in log (lines: 833, 1760) → *never log secrets; log only IDs/status*
...
### CONCURRENCY (31 findings)

- 🟡 **HL602** `backend\utils\backup.py` — external call(s) missing timeout: _s3_client:324 → *always set timeout; add retry + circuit breaker*
- 🟡 **HL602** `backend\utils\config.py` — external call(s) missing timeout: _load_field_encryption_key_from_aws_ssm:393 → *always set timeout; add retry + circuit breaker*
...
- 🟡 **HL601** `backend\services\geography\country_ai_research.py` — sequential external calls: _fetch_web_evidence (2 calls), _generate_ai_modules (2 calls) → *use asyncio.gather or ThreadPoolExecutor; add timeout + retry*
- 🟡 **HL602** `backend\services\geography\country_ai_research.py` — external call(s) missing timeout: _fetch_web_evidence:381, _generate_ai_modules:415 → *always set timeout; add retry + circuit breaker*
- 🟡 **HL601** `backend\services\geography\country_data_orchestrator.py` — sequential external calls: __aenter__ (2 calls) → *use asyncio.gather or ThreadPoolExecutor; add timeout + retry*
- 🟡 **HL602** `backend\services\geography\country_data_orchestrator.py` — external call(s) missing timeout: __aenter__:35 → *always set timeout; add retry + circuit breaker*
- 🟡 **HL601** `backend\services\geography\country_detection.py` — sequential external calls: _lookup_ipapi (2 calls) → *use asyncio.gather or ThreadPoolExecutor; add timeout + retry*
- 🟡 **HL602** `backend\services\geography\country_detection.py` — external call(s) missing timeout: _lookup_ipapi:115 → *always set timeout; add retry + circuit breaker*
...
- 🟡 **HL601** `backend\providers\logistics\map.py` — sequential external calls: _resolve_ip (2 calls), _reverse_geocode (2 calls) → *use asyncio.gather or ThreadPoolExecutor; add timeout + retry*
- 🟡 **HL602** `backend\providers\logistics\map.py` — external call(s) missing timeout: _resolve_ip:41, _reverse_geocode:87 → *always set timeout; add retry + circuit breaker*
...
- 🟡 **HL602** `backend\controllers\orders\returns_controller.py` — external call(s) missing timeout: update_return_request:460 → *always set timeout; add retry + circuit breaker*
...
- 🟡 **MV1** `backend/controllers/` — 1 'comms' domain file(s) at backend/controllers/ root should be moved to backend/controllers/comms/ → *mkdir -p backend/controllers/comms; move: backend\controllers\comm_controller.py (detected from comm, comms)*
...
- 🟡 **DBA02** `backend\services\commerce\promotion_engine_service.py:41` — create_all present but appears dev-gated → *ensure impossible in production*
...
- 🟡 **HL110** `backend/` — 2859 public functions missing docstrings across 339 files → *By layer: services/ (1414), routers/ (986), controllers/ (325), providers/ (134). Top: country_read_service.py, credit_control_service.py, __init__.py, cash_management_service.py, cash_write_service.py +334 more*

### ERROR-HANDLING (245 findings)
...
- 🟡 **HL302** `backend\main.py` — swallowed exception (lines: 379, 382) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟡 **HL303** `backend\utils\analytics_service.py` — broad except Exception (lines: 83, 57, 71) → *narrow exception types; always log with context*
- 🟡 **HL303** `backend\utils\audit.py` — broad except Exception (lines: 64) → *narrow exception types; always log with context*
- 🟡 **HL303** `backend\utils\audit_log.py` — broad except Exception (lines: 177, 181) → *narrow exception types; always log with context*
- 🟡 **HL302** `backend\utils\auth.py` — swallowed exception (lines: 296, 327, 357) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL303** `backend\utils\background_jobs.py` — broad except Exception (lines: 91, 116, 136, 181, 201, 211 +1 more) → *narrow exception types; always log with context*
- 🟡 **HL302** `backend\utils\backup.py` — swallowed exception (lines: 126, 305, 310) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL303** `backend\utils\cache.py` — broad except Exception (lines: 25, 41, 52, 70, 81, 108 +2 more) → *narrow exception types; always log with context*
- 🟡 **HL302** `backend\utils\circuit_breaker.py` — swallowed exception (lines: 145, 185, 443, 455, 177) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL302** `backend\utils\config.py` — swallowed exception (lines: 22, 275, 337, 295, 300) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL303** `backend\utils\currency.py` — broad except Exception (lines: 193, 294) → *narrow exception types; always log with context*
- 🟡 **HL303** `backend\utils\db_backup.py` — broad except Exception (lines: 34) → *narrow exception types; always log with context*
- 🟡 **HL302** `backend\utils\dependencies.py` — swallowed exception (lines: 96, 35) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟡 **HL302** `backend\utils\ip_utils.py` — swallowed exception (lines: 87) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL303** `backend\utils\key_rotation.py` — broad except Exception (lines: 131, 120) → *narrow exception types; always log with context*
- 🟡 **HL303** `backend\utils\kms_integration.py` — broad except Exception (lines: 29) → *narrow exception types; always log with context*
...
- 🟡 **HL303** `backend\utils\migration_helpers.py` — broad except Exception (lines: 35, 43, 53, 59, 65) → *narrow exception types; always log with context*
- 🟡 **HL303** `backend\utils\ml_worker.py` — broad except Exception (lines: 50, 114, 85) → *narrow exception types; always log with context*
...
- 🟡 **HL303** `backend\utils\pagination.py` — broad except Exception (lines: 170) → *narrow exception types; always log with context*
...
- 🟡 **HL303** `backend\utils\qr_auth.py` — broad except Exception (lines: 73) → *narrow exception types; always log with context*
- 🟡 **HL303** `backend\utils\realtime.py` — broad except Exception (lines: 45, 81, 120, 173, 269, 125 +1 more) → *narrow exception types; always log with context*
- 🟡 **HL302** `backend\utils\redis_client.py` — swallowed exception (lines: 74) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL302** `backend\utils\rls_interceptor.py` — swallowed exception (lines: 348) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL303** `backend\utils\schema_audit.py` — broad except Exception (lines: 59, 506, 908, 340, 352, 369 +6 more) → *narrow exception types; always log with context*
...
- 🟡 **HL303** `backend\utils\vault.py` — broad except Exception (lines: 156) → *narrow exception types; always log with context*
- 🟡 **HL303** `backend\utils\websocket_manager.py` — broad except Exception (lines: 45) → *narrow exception types; always log with context*
...
- 🟡 **HL302** `backend\services\treasury\cash_management_service.py` — swallowed exception (lines: 649, 657, 712, 731, 741, 887) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟡 **HL302** `backend\services\supplier\supplier_countries_service.py` — swallowed exception (lines: 66, 1917) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟡 **HL303** `backend\services\security\effective_permissions.py` — broad except Exception (lines: 147, 164, 176, 193, 210) → *narrow exception types; always log with context*
- 🟡 **HL303** `backend\services\security\fraud_detection_service.py` — broad except Exception (lines: 955, 974, 991, 760, 1028, 1045) → *narrow exception types; always log with context*
...
- 🟡 **HL303** `backend\services\media\free_image_tools.py` — broad except Exception (lines: 140, 161, 179, 226, 290, 319 +15 more) → *narrow exception types; always log with context*
- 🟡 **HL302** `backend\services\media\image_ai_service.py` — swallowed exception (lines: 45) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟡 **HL303** `backend\services\geography\country_ai_research.py` — broad except Exception (lines: 436, 527, 481, 402, 533) → *narrow exception types; always log with context*
- 🟡 **HL303** `backend\services\geography\country_auto_populate.py` — broad except Exception (lines: 38, 54, 225, 269, 296, 321 +4 more) → *narrow exception types; always log with context*
- 🟡 **HL302** `backend\services\geography\country_detection.py` — swallowed exception (lines: 82) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL302** `backend\services\geography\country_maps_service.py` — swallowed exception (lines: 47, 59) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL302** `backend\services\geography\country_restriction_service.py` — swallowed exception (lines: 54) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL302** `backend\services\geography\country_write_service.py` — swallowed exception (lines: 25) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL302** `backend\services\geography\cross_border_service.py` — swallowed exception (lines: 25) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL302** `backend\services\geography\legal_contract_service.py` — swallowed exception (lines: 176) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟡 **HL302** `backend\services\finance\payments_gateway_service.py` — swallowed exception (lines: 620, 1652, 2596, 2861, 3027, 3183 +8 more) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟡 **HL303** `backend\services\core\command_center_service.py` — broad except Exception (lines: 81, 91, 108, 117, 230, 833 +3 more) → *narrow exception types; always log with context*
...
- 🟡 **HL303** `backend\services\comms\chat_enrichment.py` — broad except Exception (lines: 54, 445) → *narrow exception types; always log with context*
- 🟡 **HL302** `backend\services\comms\command_center_query_service.py` — swallowed exception (lines: 37, 45, 59) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL302** `backend\services\comms\communication_read_service.py` — swallowed exception (lines: 49, 59, 79) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL303** `backend\services\comms\content_service.py` — broad except Exception (lines: 74) → *narrow exception types; always log with context*
- 🟡 **HL303** `backend\services\comms\email_enrichment.py` — broad except Exception (lines: 152) → *narrow exception types; always log with context*
- 🟡 **HL302** `backend\services\comms\email_event_service.py` — swallowed exception (lines: 53, 76) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL302** `backend\services\comms\email_gateway.py` — swallowed exception (lines: 244, 300) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL303** `backend\services\comms\notification_engine.py` — broad except Exception (lines: 192) → *narrow exception types; always log with context*
- 🟡 **HL303** `backend\services\comms\notification_worker.py` — broad except Exception (lines: 81, 131) → *narrow exception types; always log with context*
- 🟡 **HL302** `backend\services\comms\payout_notification_service.py` — swallowed exception (lines: 44, 232, 361) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL302** `backend\services\comms\proxy_communication.py` — swallowed exception (lines: 17) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL302** `backend\services\comms\translation_service.py` — swallowed exception (lines: 61) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL303** `backend\services\comms\video_conferencing.py` — broad except Exception (lines: 234, 262) → *narrow exception types; always log with context*
- 🟡 **HL302** `backend\services\comms\websocket_manager.py` — swallowed exception (lines: 44, 54) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟡 **HL302** `backend\services\ai\bg_removal_service.py` — swallowed exception (lines: 70, 68, 287, 726) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟡 **HL302** `backend\routers\api_comms_command.py` — swallowed exception (lines: 517, 559) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL302** `backend\routers\api_comms_console.py` — swallowed exception (lines: 469, 515) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟡 **HL302** `backend\providers\legacy\br_05.py` — swallowed exception (lines: 78, 136) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL302** `backend\providers\legacy\br_06.py` — swallowed exception (lines: 73, 268) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟡 **HL302** `backend\providers\hr\br_05.py` — swallowed exception (lines: 78, 136) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL302** `backend\providers\hr\br_06.py` — swallowed exception (lines: 73, 268) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL302** `backend\providers\hr\br_08.py` — swallowed exception (lines: 42, 50, 657) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL302** `backend\providers\hr\br_11.py` — swallowed exception (lines: 38, 299) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL302** `backend\providers\hr\br_12.py` — swallowed exception (lines: 361) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL302** `backend\providers\hr\br_13.py` — swallowed exception (lines: 31, 325) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL302** `backend\providers\hr\check_BiRefNet.py` — swallowed exception (lines: 11) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟡 **HL303** `backend\middleware\impossible_travel_middleware.py` — broad except Exception (lines: 77, 110, 124, 137, 146, 154 +2 more) → *narrow exception types; always log with context*
...
- 🟡 **HL302** `backend\controllers\ai_controller.py` — swallowed exception (lines: 74) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟡 **HL302** `backend\controllers\supplier\supplier_controller.py` — swallowed exception (lines: 493, 506, 865, 2956, 184, 715 +15 more) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL302** `backend\controllers\security\auth_controller.py` — swallowed exception (lines: 208, 891, 964, 1396, 1964) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟡 **HL302** `backend\controllers\orders\orders_controller.py` — swallowed exception (lines: 247, 145) → *log with logger.exception(...); re-raise or return controlled error*
- 🟡 **HL302** `backend\controllers\orders\returns_controller.py` — swallowed exception (lines: 74, 594, 512) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟡 **HL302** `backend\controllers\logistics\logistics_partner_controller.py` — swallowed exception (lines: 191, 195, 199, 276, 326, 341 +24 more) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟡 **HL302** `backend\controllers\geography\country_controller.py` — swallowed exception (lines: 122, 167, 1598) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟡 **HL302** `backend\controllers\catalog\products_controller.py` — swallowed exception (lines: 91, 264, 250) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟡 **HL201** `backend\utils\schema_audit.py` — 23 print() (lines: 961, 962, 963, 966, 967, 1012 +17 more) → *use structured logging with request_id/domain/context*
...
- 🟡 **HL201** `backend\providers\hr\br_05.py` — 10 print() (lines: 288, 289, 290, 291, 292, 293 +4 more) → *use structured logging with request_id/domain/context*
- 🟡 **HL201** `backend\providers\hr\br_06.py` — 10 print() (lines: 427, 428, 429, 430, 431, 432 +4 more) → *use structured logging with request_id/domain/context*
- 🟡 **HL203** `backend\providers\hr\br_08.py` — logging.basicConfig() in module code → *configure once in main; modules use getLogger()*
- 🟡 **HL201** `backend\providers\hr\br_08.py` — 13 print() (lines: 625, 626, 627, 661, 662, 663 +7 more) → *use structured logging with request_id/domain/context*
- 🟡 **HL203** `backend\providers\hr\br_11.py` — logging.basicConfig() in module code → *configure once in main; modules use getLogger()*
- 🟡 **HL201** `backend\providers\hr\br_11.py` — 6 print() (lines: 285, 305, 282, 289, 297, 300) → *use structured logging with request_id/domain/context*
- 🟡 **HL203** `backend\providers\hr\br_12.py` — logging.basicConfig() in module code → *configure once in main; modules use getLogger()*
- 🟡 **HL201** `backend\providers\hr\br_12.py` — 7 print() (lines: 346, 347, 367, 343, 351, 359 +1 more) → *use structured logging with request_id/domain/context*
- 🟡 **HL203** `backend\providers\hr\br_13.py` — logging.basicConfig() in module code → *configure once in main; modules use getLogger()*
- 🟡 **HL201** `backend\providers\hr\br_13.py` — 7 print() (lines: 310, 311, 331, 307, 315, 323 +1 more) → *use structured logging with request_id/domain/context*
- 🟡 **HL201** `backend\providers\hr\check_BiRefNet.py` — 4 print() (lines: 10, 12, 13, 17) → *use structured logging with request_id/domain/context*
...
- 🟡 **MR104** `backend\services\geography\country_ai_research.py` — global mutable state: QUAL_MODULES, DDG_QUERIES → *use dependency injection / singleton*
- 🟡 **MR104** `backend\services\geography\localization_service.py` — global mutable state: GREGORIAN_MONTHS_EN, GREGORIAN_MONTHS_AR, HIJRI_MONTHS_AR → *use dependency injection / singleton*
...
- 🟡 **MR104** `backend\services\catalog\product_verification_service.py` — global mutable state: ALLOWED_TYPES, ALLOWED_RESULTS → *use dependency injection / singleton*
...
- 🟡 **MR101** `backend\controllers\supplier\supplier_controller.py` — nested list comprehension: get_supplier_orders:1041 → *use generator expression for large datasets*
...
- 🟡 **MR101** `backend\controllers\orders\orders_controller.py` — nested list comprehension: get_orders:1026 → *use generator expression for large datasets*
...
- 🟡 **DOM2** `backend/models/` — 1 file(s) in backend/models/communication/ are in the wrong sub-folder; detected domain: 'core' → *mkdir -p backend/models/core; move: backend\models\communication\core.py (detected from core)*
- 🟡 **DOM2** `backend/models/` — 1 file(s) in backend/models/communication/ are in the wrong sub-folder; detected domain: 'supplier' → *mkdir -p backend/models/supplier; move: backend\models\communication\suppliers.py (detected from suppliers)*
...
- 🟡 **DBA03** `backend\models\geography\countries.py:11` — model 'CountryConfig' table 'country_configs' missing: uuid, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\geography\countries.py:135` — model 'CountryCommunication' table 'country_communications' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\geography\countries.py:162` — model 'CountryGatewayCredentials' table 'country_gateway_credentials' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\geography\countries.py:178` — model 'PayoutRule' table 'payout_rules' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\geography\countries.py:195` — model 'TaxRule' table 'tax_rules' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\geography\countries.py:210` — model 'ShippingRule' table 'shipping_rules' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\geography\countries.py:226` — model 'Message' table 'messages' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\geography\countries.py:253` — model 'PayoutRuleCategory' table 'payout_rule_categories' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\geography\countries.py:272` — model 'PayoutRuleProduct' table 'payout_rule_products' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\geography\country_basics.py:12` — model 'CountryBasics' table 'country_basics' missing: uuid, version → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\geography\country_enhancements.py:17` — model 'CountryFeatureFlag' table 'country_feature_flags' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\geography\country_enhancements.py:38` — model 'CountryStaffAssignment' table 'country_staff_assignments' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\geography\country_enhancements.py:61` — model 'CrossCountryCustomerSession' table 'cross_country_customer_sessions' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\geography\country_enhancements.py:81` — model 'OmanDeliveryZone' table 'oman_delivery_zones' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\geography\country_enhancements.py:101` — model 'CountryConfigVersion' table 'country_config_versions' missing: uuid, soft-delete, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\geography\country_enhancements.py:125` — model 'SupplierKYCRequirement' table 'supplier_kyc_requirements' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\geography\country_enhancements.py:143` — model 'LogisticsPartnerKYCRequirement' table 'logistics_partner_kyc_requirements' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\geography\country_enhancements.py:163` — model 'CountryCommissionRate' table 'country_commission_rates' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\geography\country_enhancements.py:179` — model 'CountryLocalization' table 'country_localization' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\geography\country_enhancements.py:196` — model 'CountryPaymentAlias' table 'country_payment_aliases' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\geography\country_enhancements.py:213` — model 'CountryLegalContract' table 'country_legal_contracts' missing: uuid, soft-delete, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\geography\country_enhancements.py:232` — model 'CountryCategoryTaxRate' table 'country_category_tax_rates' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\geography\country_enhancements.py:257` — model 'CountryCity' table 'country_cities' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\geography\country_enhancements.py:285` — model 'CountryHolidayCalendar' table 'country_holiday_calendars' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\geography\country_enhancements.py:303` — model 'CountryGatewayConfig' table 'country_gateway_configs' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\geography\country_enhancements.py:327` — model 'CountryCommunicationThread' table 'country_communication_threads' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\geography\country_enhancements.py:346` — model 'CountryCommissionRateHistory' table 'country_commission_rate_history' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\geography\country_enhancements.py:368` — model 'CountryLogisticsZone' table 'country_logistics_zones' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\geography\country_enhancements.py:388` — model 'CountryPayoutRule' table 'country_payout_rules' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
...
- 🟡 **DBA03** `backend\models\comms\communication.py:14` — model 'Notification' table 'notifications' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\communication.py:37` — model 'TicketMessage' table 'ticket_messages' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\communication.py:50` — model 'Announcement' table 'announcements' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\communication.py:62` — model 'FAQ' table 'faqs' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\communication.py:72` — model 'HelpCategory' table 'help_categories' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\communication.py:81` — model 'ProxyChannel' table 'proxy_channels' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\communication.py:96` — model 'ProxySession' table 'proxy_sessions' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\communication.py:112` — model 'ProxyMessage' table 'proxy_messages' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\communication.py:128` — model 'ProxyCallLog' table 'proxy_call_logs' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\communication.py:149` — model 'EmployeeCommunicationThread' table 'employee_communication_threads' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\communication.py:166` — model 'ExternalContactMasking' table 'external_contact_masking' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\communication.py:181` — model 'CommunicationAuditTrail' table 'communication_audit_trail' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\communication.py:199` — model 'InternalChannel' table 'internal_channels' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\communication.py:221` — model 'InternalChannelMember' table 'internal_channel_members' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\communication.py:235` — model 'InternalMessage' table 'internal_messages' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\communication.py:253` — model 'ChatReadReceipt' table 'chat_read_receipts' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\communication.py:265` — model 'ChatAttachment' table 'chat_attachments' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\communication.py:282` — model 'InternalEmail' table 'internal_emails' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\communication.py:308` — model 'EmailFolder' table 'email_folders' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\communication.py:320` — model 'MaskedMessage' table 'masked_messages' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:20` — model 'Address' table 'addresses' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:38` — model 'Cart' table 'carts' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:47` — model 'CartItem' table 'cart_items' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:62` — model 'AuditLog' table 'audit_logs' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:78` — model 'SupportTicket' table 'support_tickets' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:92` — model 'SupportTicketReply' table 'support_ticket_replies' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:103` — model 'TicketAttachment' table 'ticket_attachments' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:115` — model 'CityDistanceMatrix' table 'city_distance_matrix' missing: uuid, created_at/updated_at, soft-delete, version → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:129` — model 'ExecutiveNews' table 'executive_news' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:144` — model 'UserBrowsingHistory' table 'user_browsing_history' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:152` — model 'SystemHealthEvent' table 'system_health_events' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:163` — model 'UserSession' table 'user_sessions' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:174` — model 'CommandCenterView' table 'command_center_views' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:185` — model 'NewsSource' table 'news_sources' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:195` — model 'NewsArticle' table 'news_articles' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:214` — model 'InternalNotice' table 'internal_notices' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:225` — model 'PredictiveSimulation' table 'predictive_simulations' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:234` — model 'AlertEscalationRule' table 'alert_escalation_rules' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:243` — model 'EntityChatThread' table 'entity_chat_threads' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:254` — model 'EntityChatMessage' table 'entity_chat_messages' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:269` — model 'VideoRoom' table 'video_rooms' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:294` — model 'VideoRoomParticipant' table 'video_room_participants' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:307` — model 'VideoRoomRecording' table 'video_room_recordings' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:321` — model 'DirectChatRoom' table 'direct_chat_rooms' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:332` — model 'DirectChatMessage' table 'direct_chat_messages' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:345` — model 'GroupChatRoom' table 'group_chat_rooms' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:357` — model 'GroupChatMember' table 'group_chat_members' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:368` — model 'GroupChatMessage' table 'group_chat_messages' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:381` — model 'ShiftHandoverSession' table 'shift_handover_sessions' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:400` — model 'ShiftHandoverTask' table 'shift_handover_tasks' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:412` — model 'EscalationSLARule' table 'escalation_sla_rules' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\core.py:421` — model 'EscalationSLALog' table 'escalation_sla_logs' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\marketing.py:10` — model 'FlashSale' table 'flash_sales' missing: uuid, created_at/updated_at, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\marketing.py:28` — model 'FlashSaleItem' table 'flash_sale_items' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\marketing.py:45` — model 'EmailCampaign' table 'email_campaigns' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\marketing.py:66` — model 'EmailTemplate' table 'email_templates' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\marketing.py:79` — model 'NewsletterSubscriber' table 'newsletter_subscribers' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\marketing.py:88` — model 'EmailCampaignLog' table 'email_campaign_logs' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\marketing.py:100` — model 'CampaignRecipient' table 'campaign_recipients' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\marketing.py:120` — model 'EmailDeliveryEvent' table 'email_delivery_events' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\marketing.py:131` — model 'EmailSuppression' table 'email_suppressions' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\marketing.py:145` — model 'EmailRuntimeConfig' table 'email_runtime_config' missing: uuid, created_at/updated_at, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\suppliers.py:10` — model 'SupplierProfile' table 'supplier_profiles' missing: uuid, created_at/updated_at, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\suppliers.py:57` — model 'SupplierDocument' table 'supplier_documents' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\comms\suppliers.py:81` — model 'SupplierNotificationPreference' table 'supplier_notification_preferences' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
...
- 🟡 **DBA03** `backend\models\analytics\analytics.py:29` — model 'DailySalesSnapshot' table 'mv_daily_sales' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\analytics\analytics.py:50` — model 'MonthlySalesSnapshot' table 'mv_monthly_sales' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\analytics\analytics.py:71` — model 'KPICustomer' table 'kpi_customer' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\analytics\analytics.py:92` — model 'KPISupplier' table 'kpi_supplier' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\analytics\analytics.py:112` — model 'KPICountry' table 'kpi_country' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\analytics\analytics.py:133` — model 'KPIRevenue' table 'kpi_revenue' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\analytics\analytics.py:154` — model 'KPIOrders' table 'kpi_orders' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\analytics\analytics.py:175` — model 'KPIRetention' table 'kpi_retention' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\analytics\analytics.py:194` — model 'KPIConversion' table 'kpi_conversion' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\analytics\analytics.py:214` — model 'CashPositionSnapshotMV' table 'mv_cash_position' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
- 🟡 **DBA03** `backend\models\analytics\analytics.py:236` — model 'FacetCountsSnapshot' table 'mv_facet_counts' missing: uuid, soft-delete, version, created_by/updated_by → *use AuditMixin + SoftDeleteMixin + TenantMixin*
...
- 🟡 **DBA11** `backend\models\geography\countries.py:11` — table 'country_configs' column issues: tax_inclusive boolean should start with is_/has_/can_; cod_enabled boolean should start with is_/has_/can_; cod_verification_required boolean should start with is_/has_/can_; legal_entity_required boolean should start with is_/has_/can_ → *follow naming conventions*
- 🟡 **DBA11** `backend\models\geography\countries.py:162` — table 'country_gateway_credentials' column issues: credentials JSON should end with _json → *follow naming conventions*
- 🟡 **DBA11** `backend\models\geography\country_enhancements.py:61` — table 'cross_country_customer_sessions' column issues: conversion boolean should start with is_/has_/can_ → *follow naming conventions*
- 🟡 **DBA11** `backend\models\geography\country_enhancements.py:101` — table 'country_config_versions' column issues: effective_from datetime should end with _at/_on → *follow naming conventions*
- 🟡 **DBA11** `backend\models\geography\country_enhancements.py:143` — table 'logistics_partner_kyc_requirements' column issues: insurance_required boolean should start with is_/has_/can_; background_check_required boolean should start with is_/has_/can_ → *follow naming conventions*
- 🟡 **DBA11** `backend\models\geography\country_enhancements.py:163` — table 'country_commission_rates' column issues: effective_from datetime should end with _at/_on; effective_to datetime should end with _at/_on → *follow naming conventions*
- 🟡 **DBA11** `backend\models\geography\country_enhancements.py:179` — table 'country_localization': should be plural → *snake_case plural table names*
- 🟡 **DBA11** `backend\models\geography\country_enhancements.py:179` — table 'country_localization' column issues: hijri_calendar_enabled boolean should start with is_/has_/can_; rtl_layout_enabled boolean should start with is_/has_/can_ → *follow naming conventions*
- 🟡 **DBA11** `backend\models\geography\country_enhancements.py:346` — table 'country_commission_rate_history': should be plural → *snake_case plural table names*
- 🟡 **DBA11** `backend\models\geography\country_enhancements.py:346` — table 'country_commission_rate_history' column issues: effective_from datetime should end with _at/_on; effective_to datetime should end with _at/_on → *follow naming conventions*
- 🟡 **DBA11** `backend\models\geography\country_legal.py:24` — table 'country_legal': should be plural → *snake_case plural table names*
- 🟡 **DBA11** `backend\models\geography\country_legal.py:24` — table 'country_legal' column issues: gdpr_compliant boolean should start with is_/has_/can_; local_data_residency boolean should start with is_/has_/can_ → *follow naming conventions*
- 🟡 **DBA11** `backend\models\geography\country_tax.py:24` — table 'country_tax': should be plural → *snake_case plural table names*
- 🟡 **DBA11** `backend\models\geography\country_tax.py:24` — table 'country_tax' column issues: tax_inclusive boolean should start with is_/has_/can_ → *follow naming conventions*
...
- 🟡 **DBA11** `backend\models\comms\communication.py:14` — table 'notifications' column issues: variables JSON should end with _json → *follow naming conventions*
- 🟡 **DBA11** `backend\models\comms\communication.py:81` — table 'proxy_channels' column issues: participants JSON should end with _json → *follow naming conventions*
- 🟡 **DBA11** `backend\models\comms\communication.py:96` — table 'proxy_sessions' column issues: session_metadata JSON should end with _json → *follow naming conventions*
- 🟡 **DBA11** `backend\models\comms\communication.py:166` — table 'external_contact_masking': should be plural → *snake_case plural table names*
- 🟡 **DBA11** `backend\models\comms\communication.py:181` — table 'communication_audit_trail': should be plural → *snake_case plural table names*
- 🟡 **DBA11** `backend\models\comms\communication.py:199` — table 'internal_channels' column issues: allowed_roles JSON should end with _json → *follow naming conventions*
- 🟡 **DBA11** `backend\models\comms\core.py:62` — table 'audit_logs' column issues: details JSON should end with _json → *follow naming conventions*
- 🟡 **DBA11** `backend\models\comms\core.py:115` — table 'city_distance_matrix': should be plural → *snake_case plural table names*
- 🟡 **DBA11** `backend\models\comms\core.py:144` — table 'user_browsing_history': should be plural → *snake_case plural table names*
- 🟡 **DBA11** `backend\models\comms\core.py:174` — table 'command_center_views' column issues: config JSON should end with _json → *follow naming conventions*
- 🟡 **DBA11** `backend\models\comms\core.py:185` — table 'news_sources' column issues: api_key_required boolean should start with is_/has_/can_ → *follow naming conventions*
- 🟡 **DBA11** `backend\models\comms\core.py:195` — table 'news_articles' column issues: ai_tags JSON should end with _json → *follow naming conventions*
- 🟡 **DBA11** `backend\models\comms\core.py:214` — table 'internal_notices' column issues: valid_to datetime should end with _at/_on → *follow naming conventions*
- 🟡 **DBA11** `backend\models\comms\core.py:269` — table 'video_rooms' column issues: recording_enabled boolean should start with is_/has_/can_; watermark_enabled boolean should start with is_/has_/can_; transcription_enabled boolean should start with is_/has_/can_ → *follow naming conventions*
- 🟡 **DBA11** `backend\models\comms\marketing.py:10` — table 'flash_sales' column issues: product_ids JSON should end with _json → *follow naming conventions*
- 🟡 **DBA11** `backend\models\comms\marketing.py:120` — table 'email_delivery_events' column issues: details JSON should end with _json → *follow naming conventions*
- 🟡 **DBA11** `backend\models\comms\marketing.py:145` — table 'email_runtime_config': should be plural → *snake_case plural table names*
- 🟡 **DBA11** `backend\models\comms\suppliers.py:10` — table 'supplier_profiles' column issues: certifications JSON should end with _json; operating_regions JSON should end with _json; verified_documents JSON should end with _json → *follow naming conventions*
- 🟡 **DBA11** `backend\models\comms\suppliers.py:81` — table 'supplier_notification_preferences' column issues: notify_new_order boolean should start with is_/has_/can_; notify_low_stock boolean should start with is_/has_/can_; notify_payout_processed boolean should start with is_/has_/can_; notify_doc_expiry boolean should start with is_/has_/can_; notify_return_updates boolean should start with is_/has_/can_; notify_dispute_updates boolean should start with is_/has_/can_; in_app_enabled boolean should start with is_/has_/can_; email_enabled boolean should start with is_/has_/can_ → *follow naming conventions*
...
- 🟡 **DBA11** `backend\models\analytics\analytics.py:71` — table 'kpi_customer': should be plural → *snake_case plural table names*
- 🟡 **DBA11** `backend\models\analytics\analytics.py:92` — table 'kpi_supplier': should be plural → *snake_case plural table names*
- 🟡 **DBA11** `backend\models\analytics\analytics.py:112` — table 'kpi_country': should be plural → *snake_case plural table names*
- 🟡 **DBA11** `backend\models\analytics\analytics.py:133` — table 'kpi_revenue': should be plural → *snake_case plural table names*
- 🟡 **DBA11** `backend\models\analytics\analytics.py:175` — table 'kpi_retention': should be plural → *snake_case plural table names*
- 🟡 **DBA11** `backend\models\analytics\analytics.py:194` — table 'kpi_conversion': should be plural → *snake_case plural table names*
- 🟡 **DBA11** `backend\models\analytics\analytics.py:214` — table 'mv_cash_position': should be plural → *snake_case plural table names*
...
- 🟡 **HL801** `backend\services\supplier\supplier_countries_service.py` — function(s) need timing/metrics: _country_public_payload (calls=39), create_admin_country (calls=207), update_country_identity (calls=55), create_tax_draft (calls=28), create_logistics_draft (calls=32), create_commission_draft (calls=28) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟡 **HL801** `backend\services\security\fraud_detection_service.py` — function(s) need timing/metrics: check_ip_reputation (calls=32), calculate_score (calls=69) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟡 **HL801** `backend\services\orders\trading_service.py` — function(s) need timing/metrics: create_purchase_order (calls=38), receive_purchase_order (calls=41), three_way_match (calls=25), create_sales_order (calls=50), dispatch_sales_order (calls=25), auto_invoice_ecommerce_orders (calls=27) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟡 **HL801** `backend\services\geography\confidence_scoring.py` — function(s) need timing/metrics: calculate_confidence_score (calls=59) → *add timing decorator / Prometheus histogram / duration_ms logs*
- 🟡 **HL801** `backend\services\geography\country_ai_research.py` — function(s) need timing/metrics: _fetch_web_evidence (calls=13), _generate_ai_modules (calls=15) → *add timing decorator / Prometheus histogram / duration_ms logs*
- 🟡 **HL801** `backend\services\geography\country_auto_populate.py` — function(s) need timing/metrics: normalize_rest_country (calls=31), auto_populate_country (calls=102) → *add timing decorator / Prometheus histogram / duration_ms logs*
- 🟡 **HL801** `backend\services\geography\country_data_orchestrator.py` — function(s) need timing/metrics: auto_populate_country_config (calls=33), __aenter__ (calls=2) → *add timing decorator / Prometheus histogram / duration_ms logs*
- 🟡 **HL801** `backend\services\geography\country_detection.py` — function(s) need timing/metrics: _lookup_ipapi (calls=8) → *add timing decorator / Prometheus histogram / duration_ms logs*
- 🟡 **HL801** `backend\services\geography\country_maps_service.py` — function(s) need timing/metrics: get_country_map (calls=26) → *add timing decorator / Prometheus histogram / duration_ms logs*
- 🟡 **HL801** `backend\services\geography\country_research.py` — function(s) need timing/metrics: build_country_research (calls=87) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟡 **HL801** `backend\services\finance\payments_gateway_service.py` — function(s) need timing/metrics: get_customer_checkout_gateways (calls=26), _serialize_gateway_connection (calls=107), upsert_payment_gateway_connection (calls=38), test_payment_gateway_connection (calls=53), build_payment_finance_quote (calls=44), _build_tap_customer (calls=26) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟡 **HL801** `backend\services\comms\email_event_service.py` — function(s) need timing/metrics: verify_resend_webhook_request (calls=26), process_resend_webhook (calls=50) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟡 **HL801** `backend\services\comms\payout_notification_service.py` — function(s) need timing/metrics: notify_suppliers_of_payout (calls=34), notify_logistics_partners_of_payout (calls=47) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟡 **HL801** `backend\services\commerce\promotion_engine_service.py` — function(s) need timing/metrics: _serialize_config (calls=45), calculate_order_tier_discount (calls=32) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟡 **HL801** `backend\services\catalog\product_verification_service.py` — function(s) need timing/metrics: create_verification (calls=27) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟡 **HL801** `backend\services\ai\bg_removal_service.py` — function(s) need timing/metrics: get_category_recommendations (calls=25), _generate_alpha (calls=26), _postprocess (calls=34), get (calls=25), remove (calls=25) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟡 **HL801** `backend\routers\api_comms_command.py` — function(s) need timing/metrics: get_dashboard (calls=26), get_dashboard_stats (calls=43), websocket_endpoint (calls=34), get_comprehensive_dashboard (calls=113) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟡 **HL801** `backend\providers\logistics\map.py` — function(s) need timing/metrics: _resolve_ip (calls=19), _reverse_geocode (calls=21) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟡 **HL801** `backend\controllers\ai_controller.py` — function(s) need timing/metrics: _collect_upload_sources (calls=25), _generate_ai_suggestions (calls=43) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟡 **HL801** `backend\controllers\orders\orders_controller.py` — function(s) need timing/metrics: load_products_for_order (calls=32), group_supplier_totals (calls=44), _calculate_order_amounts (calls=58), create_order (calls=67), preview_order (calls=37), _build_supply_chain_timeline (calls=27) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟡 **HL801** `backend\controllers\catalog\products_controller.py` — function(s) need timing/metrics: _apply_live_offer_metadata (calls=43), _list_products_cached (calls=109), get_recommended_products (calls=39) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟡 **OB101** `backend/controllers/` — 66 modules missing structured logger → *Add logger = logging.getLogger(__name__). Top: comm_controller.py, compliance_controller.py, coupons_controller.py, disputes_controller.py, flash_sale_controller.py +61 more*
- 🟡 **OB101** `backend/providers/` — 22 modules missing structured logger → *Add logger = logging.getLogger(__name__). Top: async_workers.py, bg_remover.py, image.py, ocr.py, vision.py +17 more*
- 🟡 **OB101** `backend/routers/` — 108 modules missing structured logger → *Add logger = logging.getLogger(__name__). Top: admin_analytics_routes.py, admin_catalog_routes.py, admin_catalog_routes_2.py, admin_commerce_routes.py, admin_comms_routes_2.py +103 more*
- 🟡 **OB101** `backend/services/` — 196 modules missing structured logger → *Add logger = logging.getLogger(__name__). Top: country_read_service.py, credit_control_service.py, database.py, video_conferencing.py, write_helpers.py +191 more*
- 🟡 **OB102** `backend/controllers/` — 84 modules missing request_id / correlation_id → *Add X-Request-ID middleware in main.py (fixes all 84 at once). Top: admin_controller.py, ai_controller.py, banner_controller.py, cart_controller.py, comm_controller.py +79 more*
...
- 🟡 **HL102** `backend\utils\order_tracking.py` — oversized function(s): _build_order_finance_breakdown (88L), build_tracking_timeline (138L), build_order_tracking_payload (107L) → *extract smaller functions*
- 🟡 **HL102** `backend\utils\realtime.py` — oversized function(s): _collect_realtime_events (188L) → *extract smaller functions*
- 🟡 **HL101** `backend\utils\schema_audit.py` — oversized file (1017 lines) → *split by responsibility/domain*
...
- 🟡 **HL101** `backend\services\treasury\cash_management_service.py` — oversized file (1249 lines) → *split by responsibility/domain*
...
- 🟡 **HL502** `backend\services\suppliers\suppliers_write_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL101** `backend\services\supplier\supplier_countries_service.py` — oversized file (1949 lines) → *split by responsibility/domain*
- 🟡 **HL102** `backend\services\supplier\supplier_countries_service.py` — oversized function(s): _country_public_payload (83L), create_admin_country (159L), update_country_identity (91L), _apply_version_payload (153L) → *extract smaller functions*
...
- 🟡 **HL101** `backend\services\security\fraud_detection_service.py` — oversized file (1112 lines) → *split by responsibility/domain*
...
- 🟡 **HL101** `backend\services\media\free_image_tools.py` — oversized file (979 lines) → *split by responsibility/domain*
...
- 🟡 **HL102** `backend\services\geography\confidence_scoring.py` — oversized function(s): calculate_confidence_score (100L) → *extract smaller functions*
- 🟡 **HL102** `backend\services\geography\country_auto_populate.py` — oversized function(s): auto_populate_country (268L) → *extract smaller functions*
- 🟡 **HL102** `backend\services\geography\country_research.py` — oversized function(s): build_country_research (186L) → *extract smaller functions*
...
- 🟡 **HL101** `backend\services\finance\payments_gateway_service.py` — oversized file (4549 lines) → *split by responsibility/domain*
- 🟡 **HL102** `backend\services\finance\payments_gateway_service.py` — oversized function(s): get_payment_methods_status (87L), _built_in_gateway_defaults (214L), _serialize_gateway_connection (108L), test_payment_gateway_connection (100L), _finalize_inventory_for_paid_order (88L), create_payment_intent (103L) → *extract smaller functions*
...
- 🟡 **HL502** `backend\services\country\confidence_scoring.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\country\country_ai_research.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\country\country_auto_populate.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\country\country_communication_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\country\country_data_orchestrator.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\country\country_detection.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\country\country_dropdown_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\country\country_heuristic_engine.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\country\country_maps_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\country\country_research.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\country\country_rls_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\country\country_router_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\country\country_staff_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\country\country_tax_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\country\country_write_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\country\cross_border_detection.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\country\cross_border_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\country\downstream_hooks.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\country\legal_contract_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\country\localization_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\country\map_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\country\__init__.py` — star import at lines: 2 → *use explicit imports*
...
- 🟡 **HL101** `backend\services\core\command_center_service.py` — oversized file (904 lines) → *split by responsibility/domain*
...
- 🟡 **HL502** `backend\services\communication\chat_enrichment.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\chat_read_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\command_center_query_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\communication_audit.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\communication_read_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\communication_write_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\content_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\email_enrichment.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\email_event_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\email_gateway.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\email_management_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\email_reputation.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\email_write_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\entity_chat_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\entity_messaging.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\escalation_sla.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\external_contact.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\internal_communication.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\notification_engine.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\notification_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\notification_worker.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\payout_notification_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\proxy_communication.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\push_notifications_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\tickets_write_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\transactional_email_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\translation_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\video_conferencing.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\video_service.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\websocket_chat.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\websocket_manager.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\services\communication\__init__.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL102** `backend\services\comms\email_gateway.py` — oversized function(s): send_internal_email (97L) → *extract smaller functions*
- 🟡 **HL102** `backend\services\comms\payout_notification_service.py` — oversized function(s): notify_suppliers_of_payout (114L), notify_logistics_partners_of_payout (132L) → *extract smaller functions*
...
- 🟡 **HL101** `backend\services\ai\bg_removal_service.py` — oversized file (1164 lines) → *split by responsibility/domain*
...
- 🟡 **HL102** `backend\providers\hr\br_06.py` — oversized function(s): process_file (82L) → *extract smaller functions*
- 🟡 **HL102** `backend\providers\hr\br_08.py` — oversized function(s): process (91L) → *extract smaller functions*
- 🟡 **HL502** `backend\providers\country\country.py` — star import at lines: 2 → *use explicit imports*
...
- 🟡 **HL502** `backend\models\country\countries.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\models\country\country_basics.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\models\country\country_economics.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\models\country\country_enhancements.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\models\country\country_legal.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\models\country\country_tax.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\models\country\__init__.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\models\communication\communication.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\models\communication\core.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\models\communication\marketing.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\models\communication\suppliers.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\models\communication\__init__.py` — star import at lines: 2 → *use explicit imports*
...
- 🟡 **HL101** `backend\controllers\supplier\supplier_controller.py` — oversized file (4063 lines) → *split by responsibility/domain*
- 🟡 **HL102** `backend\controllers\supplier\supplier_controller.py` — oversized function(s): persist_supplier_product (114L), _parse_product_variants_payload (83L), get_supplier_orders (145L), get_supplier_label_payload (143L), upload_supplier_parcel_proof (141L), create_supplier_product_upload (134L) → *extract smaller functions*
- 🟡 **HL502** `backend\controllers\supplier\__init__.py` — star import at lines: 7 → *use explicit imports*
- 🟡 **HL101** `backend\controllers\security\auth_controller.py` — oversized file (2023 lines) → *split by responsibility/domain*
...
- 🟡 **HL101** `backend\controllers\orders\orders_controller.py` — oversized file (1647 lines) → *split by responsibility/domain*
- 🟡 **HL102** `backend\controllers\orders\orders_controller.py` — oversized function(s): _calculate_order_amounts (150L), create_order (151L), _build_supply_chain_timeline (90L), get_order_invoice (112L), respond_to_shipment_confirmation (135L) → *extract smaller functions*
...
- 🟡 **HL101** `backend\controllers\logistics\logistics_partner_controller.py` — oversized file (3799 lines) → *split by responsibility/domain*
...
- 🟡 **HL101** `backend\controllers\geography\country_controller.py` — oversized file (1702 lines) → *split by responsibility/domain*
...
- 🟡 **HL502** `backend\controllers\country\country_controller.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\controllers\country\__init__.py` — star import at lines: 2 → *use explicit imports*
...
- 🟡 **HL502** `backend\controllers\communication\admin_tickets_controller.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\controllers\communication\comm_controller.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL502** `backend\controllers\communication\__init__.py` — star import at lines: 2 → *use explicit imports*
- 🟡 **HL101** `backend\controllers\catalog\products_controller.py` — oversized file (1080 lines) → *split by responsibility/domain*
- 🟡 **HL102** `backend\controllers\catalog\products_controller.py` — oversized function(s): _list_products_cached (195L), get_products (103L) → *extract smaller functions*
...
- 🟡 **DOM2** `backend/services/` — 1 file(s) in backend/services/country/ are in the wrong sub-folder; detected domain: 'logistics' → *mkdir -p backend/services/logistics; move: backend\services\country\map_service.py (detected from map)*
...
- 🟡 **CA2** `backend\services\geography\country_rls_service.py` — file contains signals for 4 domains: configuration(2), geography(2), finance(2), core(2) — split candidate → *split this file into domain-specific modules; each file should serve one domain*
...
- 🟡 **CA2** `backend\services\geography\country_tax_service.py` — file contains signals for 3 domains: catalog(4), finance(4), geography(2) — split candidate → *split this file into domain-specific modules; each file should serve one domain*
- 🟡 **CA2** `backend\services\geography\country_write_service.py` — file contains signals for 6 domains: geography(37), configuration(17), comms(6), finance(5), supplier(4), logistics(3) — split candidate → *split this file into domain-specific modules; each file should serve one domain*
...
- 🟡 **CA2** `backend\services\comms\tickets_write_service.py` — file contains signals for 3 domains: comms(10), finance(9), orders(4) — split candidate → *split this file into domain-specific modules; each file should serve one domain*
...
| 4 | `backend\services\country\map_service.py` | `backend/services/logistics/map_service.py` | domain | 67% |
...
| 8 | `backend\services\location\geo_service.py` | `backend/services/geography/geo_service.py` | domain | 91% |
| 9 | `backend\services\logistics\geo_fence_service.py` | `backend/services/geography/geo_fence_service.py` | domain | 90% |
| 10 | `backend\models\communication\core.py` | `backend/models/core/core.py` | domain | 67% |
| 11 | `backend\models\communication\suppliers.py` | `backend/models/supplier/suppliers.py` | domain | 67% |
| 12 | `backend\controllers\banner_controller.py` | `backend/controllers/core/banner_controller.py` | domain | 93% |
| 13 | `backend\controllers\cart_controller.py` | `backend/controllers/orders/cart_controller.py` | domain | 93% |
| 14 | `backend\controllers\comm_controller.py` | `backend/controllers/comms/comm_controller.py` | domain | 93% |
| 15 | `backend\controllers\coupons_controller.py` | `backend/controllers/commerce/coupons_controller.py` | domain | 93% |
| 16 | `backend\controllers\disputes_controller.py` | `backend/controllers/orders/disputes_controller.py` | domain | 93% |
| 17 | `backend\controllers\product_verification_controller.py` | `backend/controllers/catalog/product_verification_controller.py` | domain | 96% |
| 18 | `backend\controllers\products_controller.py` | `backend/controllers/catalog/products_controller.py` | domain | 96% |
| 19 | `backend\controllers\promotion_controller.py` | `backend/controllers/commerce/promotion_controller.py` | domain | 93% |
| 20 | `backend\controllers\returns_controller.py` | `backend/controllers/orders/returns_controller.py` | domain | 93% |
| 21 | `backend\controllers\search_controller.py` | `backend/controllers/catalog/search_controller.py` | domain | 93% |
| 22 | `backend\providers\catalog\text.py` | `backend/providers/ai/text.py` | domain | 91% |
| 23 | `backend\providers\image.py` | `backend/providers/media/image.py` | domain | 93% |
| 24 | `backend\providers\logistics\geo.py` | `backend/providers/geography/geo.py` | domain | 75% |
| 25 | `backend\providers\ocr.py` | `backend/providers/ai/ocr.py` | domain | 91% |
| 26 | `backend\providers\vision.py` | `backend/providers/ai/vision.py` | domain | 91% |
| 27 | `backend\providers\voice_to_text.py` | `backend/providers/ai/voice_to_text.py` | domain | 95% |
| 28 | `backend\events.py` | `backend/utils/events.py` | backend-root | 60% |
| 29 | `backend/controllers/communication/` | `backend/controllers/comms/` | rename-folder | 100% |
| 30 | `backend/controllers/country/` | `backend/controllers/geography/` | rename-folder | 100% |
| 31 | `backend/models/communication/` | `backend/models/comms/` | rename-folder | 100% |
| 32 | `backend/models/country/` | `backend/models/geography/` | rename-folder | 100% |
| 33 | `backend/providers/country/` | `backend/providers/geography/` | rename-folder | 100% |
| 34 | `backend/services/communication/` | `backend/services/comms/` | rename-folder | 100% |
| 35 | `backend/services/country/` | `backend/services/geography/` | rename-folder | 100% |
| 36 | `backend/services/suppliers/` | `backend/services/supplier/` | rename-folder | 100% |
...
- **Dependency edges:** 2623
- **Classes found:** 1144
- **Layer counts:** `_triage=1`, `alembic=33`, `controllers=86`, `data=84`, `db=10`, `dependencies=3`, `events=1`, `lifespan=1`, `main=1`, `middleware=22`, `models=63`, `providers=56`, `routers=152`, `run_server=1`, `services=350`, `tests=78`, `utils=70`
...
| 🟠 P1 (fix this sprint) | 452 | Scaling / performance risk |
| 🟡 P2 (fix this month) | 2442 | Maintainability / structure |
| 🟢 P3 (fix when convenient) | 1274 | Hygiene / style |
...
| 4 | `backend\models\geography\country_enhancements.py` | 233 | DBA03, DBA06, DBA07, DBA08, DBA11 |
| 5 | `backend\models\hr\employee_models.py` | 209 | DBA03, DBA06, DBA07, DBA08, DBA09, DBA11 |
| 6 | `backend\models\comms\communication.py` | 149 | DBA03, DBA06, DBA07, DBA08, DBA09, DBA11, DBA31 |
| 7 | `backend\controllers\security\auth_controller.py` | 107 | DBA32, HL101, HL102, HL204, HL302, HL601, HL801, MET2, Q1, QUAL3, W4 |
| 8 | `backend\models\catalog\products.py` | 94 | DBA01, DBA03, DBA09, DBA11, DBA31 |
| 9 | `backend\models\finance\payments.py` | 90 | DBA01, DBA03, DBA06, DBA07, DBA08, DBA09, DBA11, DBA31 |
| 10 | `backend\models\geography\countries.py` | 89 | DBA03, DBA06, DBA07, DBA08, DBA11 |
| 11 | `backend\models\logistics\country_control.py` | 88 | DBA03, DBA06 |
| 12 | `backend\models\comms\core.py` | 87 | DBA03, DBA09, DBA11, DBA18 |
| 13 | `backend\controllers\supplier\supplier_controller.py` | 86 | A1, API2, DBA32, HL101, HL102, HL302, HL801, MR101, Q1, QUAL3 |
| 14 | `backend\models\supplier\onboarding.py` | 84 | DBA03, DBA06, DBA07, DBA08, DBA09, DBA11 |
| 15 | `backend\controllers\logistics\logistics_controller.py` | 80 | HL101, HL102, HL302, HL801, Q1, QUAL3 |
| 16 | `backend\models\__init__.py` | 79 | A1, DG2, HL502 |
| 17 | `backend\models\core\user.py` | 76 | DBA03, DBA06, DBA07, DBA08, DBA09, DBA11 |
| 18 | `backend\controllers\orders\orders_controller.py` | 74 | DBA32, HL101, HL102, HL302, HL801, MET2, MR101, Q1, QUAL3 |
