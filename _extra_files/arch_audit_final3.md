...
> **Generated:** 2026-08-05T09:52:07.878284+00:00  
> **Repo:** `D:\Projects\10- E-COMMERCE WEBSITE\zozi`  
> **Result:** 🔴 1 violations · 🟡 982 advisories · 🟢 142 info  
> **Architecture Debt Score:** **19480**  
...
| API1 | 102 | 🟢 INFO | public API symbol changed without deprecation |
| API2 | 98 | 🟡 ADVISORY | internal symbol exposed outside its module boundary |
...
| 🟢 | API1 | services | `backend\services\payments\base.py:28` | public class 'BasePaymentGateway' has no docstring (API documentation gap) | add docstring documenting parameters, return type, and side effects |
...
| 🟢 | API1 | services | `backend\services\payments\base.py:16` | public class 'ConnectionTestResult' has no docstring (API documentation gap) | add docstring documenting parameters, return type, and side effects |
...
| 🟢 | API1 | services | `backend\services\payments\webhook_models.py:9` | public class 'PaymentEventType' has no docstring (API documentation gap) | add docstring documenting parameters, return type, and side effects |
...
| 🟢 | API1 | services | `backend\services\payments\registry.py:18` | public class 'PaymentGatewayRegistry' has no docstring (API documentation gap) | add docstring documenting parameters, return type, and side effects |
...
| 🟢 | API1 | services | `backend\services\payments\base.py:8` | public class 'PaymentResult' has no docstring (API documentation gap) | add docstring documenting parameters, return type, and side effects |
...
| 🟢 | API1 | services | `backend\services\payments\base.py:21` | public class 'RefundResult' has no docstring (API documentation gap) | add docstring documenting parameters, return type, and side effects |
...
| 🟡 | API2 | backend | `backend\services\finance\erp_finance_service.py:30` | private symbol '_audit' used in 1 external module(s) | make it public (remove _) or keep internal and refactor external usages |
...
| 🟡 | API2 | backend | `backend\services\payments\payment_engine.py:146` | private symbol '_get_country' used in 3 external module(s) | make it public (remove _) or keep internal and refactor external usages |
...
| 🟡 | DG2 | backend | `backend\models\__init__.py` | circular module dependency: models -> models._exports -> models.country.countries -> models.country -> models | break the cycle by extracting shared logic into a lower layer (utils/service interface) |
...
| 🟡 | DG2 | backend | `backend\models\__init__.py` | circular module dependency: models -> models._exports -> models.communication.communication -> models.communication -> models | break the cycle by extracting shared logic into a lower layer (utils/service interface) |
...
| 🟢 | MET1 | repo | `architecture-debt` | architecture debt score = 19480 | track this number down over time; lower is healthier |
...
- 🟢 **MET1** `architecture-debt` — architecture debt score = 19480 → *track this number down over time; lower is healthier*
...
- 🟡 **DG2** `backend\models\__init__.py` — circular module dependency: models -> models._exports -> models.country.countries -> models.country -> models → *break the cycle by extracting shared logic into a lower layer (utils/service interface)*
...
- 🟡 **DG2** `backend\models\__init__.py` — circular module dependency: models -> models._exports -> models.communication.communication -> models.communication -> models → *break the cycle by extracting shared logic into a lower layer (utils/service interface)*
...
- 🟡 **API2** `backend\services\finance\erp_finance_service.py:30` — private symbol '_audit' used in 1 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
...
- 🟡 **API2** `backend\services\payments\payment_engine.py:146` — private symbol '_get_country' used in 3 external module(s) → *make it public (remove _) or keep internal and refactor external usages*
...
- 🟢 **API1** `backend\services\payments\base.py:28` — public class 'BasePaymentGateway' has no docstring (API documentation gap) → *add docstring documenting parameters, return type, and side effects*
...
- 🟢 **API1** `backend\services\payments\base.py:16` — public class 'ConnectionTestResult' has no docstring (API documentation gap) → *add docstring documenting parameters, return type, and side effects*
...
- 🟢 **API1** `backend\services\payments\webhook_models.py:9` — public class 'PaymentEventType' has no docstring (API documentation gap) → *add docstring documenting parameters, return type, and side effects*
...
- 🟢 **API1** `backend\services\payments\registry.py:18` — public class 'PaymentGatewayRegistry' has no docstring (API documentation gap) → *add docstring documenting parameters, return type, and side effects*
...
- 🟢 **API1** `backend\services\payments\base.py:8` — public class 'PaymentResult' has no docstring (API documentation gap) → *add docstring documenting parameters, return type, and side effects*
...
- 🟢 **API1** `backend\services\payments\base.py:21` — public class 'RefundResult' has no docstring (API documentation gap) → *add docstring documenting parameters, return type, and side effects*
