...
def update_flash_sale(sale_id: int, body: FlashSaleCreate, current_admin: dict, db: Session) -> FlashSaleOut:
    ...
    sale = update_flash_sale_svc(db, sale, updates)
    audit_log(
        db,
...
# Local aliases previously resolved via services.products_write_service. They map
# back to this module's own handler functions to avoid a circular import.
create_flash_sale_svc = create_flash_sale
update_flash_sale_svc = update_flash_sale
delete_flash_sale_svc = delete_flash_sale
