...
from services.hr_write_service import upsert_employee_risk_score as _upsert_employee_risk_score
...
def update_flight_risk_score(employee_id: int, metric: str, score: float, db: Session) -> dict:
    ...
    _upsert_employee_risk_score(db, employee_id, metric, score)
