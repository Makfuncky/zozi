...
def create_return_request(current_user: dict, payload: ReturnRequestCreate, db: Session) -> ReturnRequest:
    ...
    return_request = _create_return_request(
        db,
...
def update_return_request(return_id: int, payload: ReturnRequestUpdate, current_user: dict, db: Session) -> ReturnRequest:
    ...
    updates = {
        ...
        "updated_at": _utcnow(),
        "resolved_at": _utcnow() if payload.status in ("approved", "rejected", "completed") else None,
    }
    ...
    _update_return_request(db, req, updates)
...
def update_supplier_return_request(
    ...
    updates = {
        "supplier_review_state": json.dumps(supplier_state),
...
# Imported at the BOTTOM (not the top) of this module: `services.returns_write_service`
...
from services.returns_write_service import (  # noqa: E402
    create_return_request as _create_return_request,
    create_return_notification as _create_return_notification,
    update_return_request as _update_return_request,
)
