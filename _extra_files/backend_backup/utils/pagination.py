...
# Safe upper bound for unbounded internal queries (e.g. loading all rows for a
# user/entity). Mirrors the historical value removed during the pagination refactor.
SAFE_QUERY_LIMIT = 200
