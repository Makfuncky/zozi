...
Every status change pushes a real-time update via WebSocket to the supplier's
    connected clients (using the existing UserConnectionManager from websocket_manager).
"""
...
from services.comms.websocket_manager import user_manager as _ws_manager

logger = logging.getLogger(__name__)


def _get_ws_manager():
    """Return the WebSocket connection manager for real-time push notifications."""
    return _ws_manager
