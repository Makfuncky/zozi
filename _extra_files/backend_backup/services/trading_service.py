...
try:
    ...
    GoodsReceiptLine = None  # type: ignore[assignment,misc]
    GoodsReceiptNote = None  # type: ignore[assignment,misc]
    PurchaseOrder = None  # type: ignore[assignment,misc]
    PurchaseOrderLine = None  # type: ignore[assignment,misc]
    SalesOrder = None  # type: ignore[assignment,misc]
    SalesOrderLine = None  # type: ignore[assignment,misc]
    StockMovement = None  # type: ignore[assignment,misc]
...
def auto_invoice_ecommerce_orders(db: Session, country_code: str = None) -> dict:
    ...
    """
    from models import ARInvoice, Order
