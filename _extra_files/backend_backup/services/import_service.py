...
try:
    from models import PurchaseOrder, Warehouse
except ImportError:
    PurchaseOrder = None  # type: ignore[assignment,misc]
    Warehouse = None  # type: ignore[assignment,misc]
try:
    from models import CustomsEntry, ImportShipment, ImportShipmentLine
except ImportError:
    CustomsEntry = None  # type: ignore[assignment,misc]
    ImportShipment = None  # type: ignore[assignment,misc]
    ImportShipmentLine = None  # type: ignore[assignment,misc]
try:
    from models import ImportCostTemplate, LandedCostAllocation
except ImportError:
    ImportCostTemplate = None  # type: ignore[assignment,misc]
    LandedCostAllocation = None  # type: ignore[assignment,misc]
