...
try:
    ...
    ChatAttachment = None  # type: ignore[assignment,misc]
...
class ChatSystem:
    ...
    async def send_message_with_files(
        ...
        if chat_type == "entity":
            ...
            from models.core import DirectChatMessage, DirectChatRoom
            room = self.db.query(DirectChatRoom).filter(
                DirectChatRoom.chat_id == chat_id,
                DirectChatRoom.is_active == True,
            ).first()
            ...
            from models.core import GroupChatMessage, GroupChatRoom
            room = self.db.query(GroupChatRoom).filter(
                GroupChatRoom.chat_id == chat_id,
                GroupChatRoom.is_active == True,
            ).first()
