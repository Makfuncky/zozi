...
from models import PointsTransaction, PromotionEngineConfig, UserPoints
from services.promotion_engine_service import (
    get_or_create_config as _get_promotion_config_raw,
)
...
def _get_promotion_config(db: Session) -> PromotionEngineConfig:
    ...
    return _get_promotion_config_raw(db)
