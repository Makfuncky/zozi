...
def notify_suppliers_of_payout(
    ...
    except Exception as exc:  # surfaced per-supplier below to preserve error reporting
    ...
    try:
        ...
        if partner_user_ids:
            ...
            for row in user_rows:
                users_by_id.setdefault(row.id, row)
    except Exception as exc:  # surfaced per-partner below to preserve error reporting
