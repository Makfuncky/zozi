...
# Effective-permission stubs live in the lower-layer primitives module to
# avoid a circular import with routers.public_effective_permissions_access.
...
# check_permission is defined in this module (see def check_permission below);
# use it directly instead of re-importing through routers.public_effective_permissions_access.
resolve_check_perm = check_permission
