...
from routers.public_effective_permissions_access import check_permission
from services.hr.payroll_service import get_employee_payslips
...
def get_employee_payslips(
    ...
    return get_employee_payslips(employee_id, db)
