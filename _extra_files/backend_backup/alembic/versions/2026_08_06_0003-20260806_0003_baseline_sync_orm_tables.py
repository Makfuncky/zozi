...
def upgrade() -> None:
    ...
    if not _has_table('api_keys', 'core'):
        op.create_table('api_keys',
            ...
            sa.Column('country_code', sa.String(length=3), nullable=False),
            sa.Column('is_active', sa.Boolean(), nullable=False),
            sa.Column('version', sa.Integer(), nullable=False), schema='core',
    )
    ...
    if not _has_table('coupon_usages', 'commerce'):
    ...
    if not _has_table('email_verification_tokens', 'core'):
    ...
    if not _has_table('password_reset_tokens', 'core'):
    ...
    if not _has_table('payment_orchestrator_syncs', 'hr'):
        op.create_table('payment_orchestrator_syncs',
                    sa.Column('id', sa.Integer(), primary_key=True, nullable=False),
    ...
    if not _has_table('permission_audit_log', 'core'):
    ...
    if not _has_table('permission_categories', 'core'):
    ...
    if not _has_table('permissions', 'core'):
    ...
    if not _has_table('revoked_tokens', 'core'):
    ...
    if not _has_table('role_permission_assignments', 'core'):
    ...
    if not _has_table('role_permission_settings', 'core'):
    ...
    if not _has_table('supplier_onboarding_syncs', 'hr'):
        op.create_table('supplier_onboarding_syncs',
                    sa.Column('id', sa.Integer(), primary_key=True, nullable=False),
            sa.Column('supplier_id', sa.Integer(), nullable=False),
            sa.Column('kyc_status', sa.String(length=30), nullable=True),
            sa.Column('kyc_documents', sa.Text(), nullable=True),
            sa.Column('is_onboarding_fee_paid', sa.Boolean(), nullable=True),
    ...
    if not _has_table('user_browsing_history', 'core'):
        op.create_table('user_browsing_history',
                    sa.Column('id', sa.Integer(), primary_key=True, nullable=False),
            sa.Column('user_id', sa.Integer(), nullable=False),
            sa.Column('product_id', sa.Integer(), nullable=False),
            sa.Column('viewed_at', sa.DateTime(), nullable=True), schema='core',
    )

    if not _has_table('user_devices', 'core'):
    ...
    if not _has_table('user_login_history', 'core'):
    ...
    if not _has_table('user_permission_overrides', 'core'):
    ...
    if not _has_table('user_sessions', 'core'):
...
def downgrade() -> None:
    ...
    op.execute('DROP TABLE IF EXISTS "core"."user_sessions"')
    op.execute('DROP TABLE IF EXISTS "core"."user_permission_overrides"')
    op.execute('DROP TABLE IF EXISTS "core"."user_login_history"')
    op.execute('DROP TABLE IF EXISTS "core"."user_devices"')
    op.execute('DROP TABLE IF EXISTS "core"."user_browsing_history"')
    ...
    op.execute('DROP TABLE IF EXISTS "core"."role_permission_settings"')
    op.execute('DROP TABLE IF EXISTS "core"."role_permission_assignments"')
    op.execute('DROP TABLE IF EXISTS "core"."revoked_tokens"')
    ...
    op.execute('DROP TABLE IF EXISTS "core"."permissions"')
    op.execute('DROP TABLE IF EXISTS "core"."permission_categories"')
    op.execute('DROP TABLE IF EXISTS "core"."permission_audit_log"')
    ...
    op.execute('DROP TABLE IF EXISTS "core"."email_verification_tokens"')
