...
from routers.public_ai_research_access import router as ai_research_router
...
class TestQueueAIResearch:
    def test_queue_ai_research_returns_job_id(self):
        with patch("utils.auth._get_redis", return_value=None), \
             ...
             patch("routers.public_ai_research_access._run_ai_job") as mock_run:
    ...
    def test_queue_ai_research_returns_503_when_disabled(self):
        with patch("routers.public_ai_research_access.settings") as mock_settings, \
