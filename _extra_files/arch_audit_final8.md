...
> **Generated:** 2026-08-05T10:24:12.079143+00:00  
> **Repo:** `D:\Projects\10- E-COMMERCE WEBSITE\zozi`  
> **Result:** 🔴 1 violations · 🟡 973 advisories · 🟢 137 info  
> **Architecture Debt Score:** **19315**  
...
|---|---|---|---|---|---|
| 🔴 | DG3 | backend | `backend\services\treasury\treasury_query_service.py:17` | cross-domain import treasury -> write_helpers violates explicit ownership rules | declare allowed imports in layer_rules.yaml or route via write_helpers service facade |
...
| 🟡 | BC1 | backend | `backend\services\treasury\treasury_query_service.py:17` | cross-domain import treasury → write_helpers bypasses event/facade boundary | route through events/ or a write_helpers service facade; declare in layer_rules.yaml if intentional |
...
| 🟡 | CA2 | services | `backend\services\treasury\treasury_query_service.py` | file contains signals for 2 domains: treasury(5), finance(2) — split candidate | split this file into domain-specific modules; each file should serve one domain |
...
| 🟢 | MET1 | repo | `architecture-debt` | architecture debt score = 19315 | track this number down over time; lower is healthier |
...
| 🟡 | SYM2 | backend | `services.treasury.treasury_query_service:76, services.treasury.treasury_service:119, services.finance.general_ledger_service:60, routers.api_finance_domain:68, routers.api_finance_routes:98` | public function 'create_journal_entry' defined in 7 modules | consolidate or rename to avoid confusion |
...
- 🟢 **MET1** `architecture-debt` — architecture debt score = 19315 → *track this number down over time; lower is healthier*

### BACKEND (616 findings)
...
- 🟢 **DOM8** `backend/` — 215 scanned file(s) are already in the correct domain folder → *keep these placements; do not move them*
...
- 🔴 **DG3** `backend\services\treasury\treasury_query_service.py:17` — cross-domain import treasury -> write_helpers violates explicit ownership rules → *declare allowed imports in layer_rules.yaml or route via write_helpers service facade*
...
- 🟡 **SYM2** `services.treasury.treasury_query_service:76, services.treasury.treasury_service:119, services.finance.general_ledger_service:60, routers.api_finance_domain:68, routers.api_finance_routes:98` — public function 'create_journal_entry' defined in 7 modules → *consolidate or rename to avoid confusion*
...
- 🟡 **BC1** `backend\services\treasury\treasury_query_service.py:17` — cross-domain import treasury → write_helpers bypasses event/facade boundary → *route through events/ or a write_helpers service facade; declare in layer_rules.yaml if intentional*
...
- 🟡 **CA2** `backend\services\treasury\treasury_query_service.py` — file contains signals for 2 domains: treasury(5), finance(2) — split candidate → *split this file into domain-specific modules; each file should serve one domain*
