...
from data.services_internal_communication import get_internal_communication_service
import structlog
...
@router.post("/channels/{channel_id}/members", response_model=dict)
def add_member(
    channel_id: str,
...
@router.post("/channels/{channel_id}/messages", response_model=dict)
def send_message(
    channel_id: str,
