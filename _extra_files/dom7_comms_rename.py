#!/usr/bin/env python3
"""DOM7 Migration: communication/ -> comms/ across controllers, models, services."""
import os
import shutil
...
moved_files = []
print("=" * 60)
print("DOM7 MIGRATION: communication/ -> comms/")
print("=" * 60)

# Step 1: Create comms/ directories and copy files
...
import_patterns = [
    ("from controllers.communication.", "from controllers.comms."),
    ("import controllers.communication", "import controllers.comms"),
    ("from models.communication.", "from models.comms."),
    ("from models.communication ", "from models.comms "),
    ("import models.communication", "import models.comms"),
    ("from services.communication.", "from services.comms."),
    ("from services.communication ", "from services.comms "),
    ("import services.communication", "import services.comms"),
    ("from data.models.communication", "from data.models.comms"),
]
