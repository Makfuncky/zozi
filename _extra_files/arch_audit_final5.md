...
> **Generated:** 2026-08-05T10:01:51.036851+00:00  
> **Repo:** `D:\Projects\10- E-COMMERCE WEBSITE\zozi`  
> **Result:** 🔴 1 violations · 🟡 980 advisories · 🟢 140 info  
> **Architecture Debt Score:** **19404**  
...
| 🟢 | MET1 | repo | `architecture-debt` | architecture debt score = 19404 | track this number down over time; lower is healthier |
...
- 🟢 **I1** `.` — backend models=51 routers=152 controllers=83 services=282 middleware=22
...
- 🟢 **MET1** `architecture-debt` — architecture debt score = 19404 → *track this number down over time; lower is healthier*

### BACKEND (618 findings)
