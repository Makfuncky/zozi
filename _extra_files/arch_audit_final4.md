...
> **Generated:** 2026-08-05T09:58:21.574147+00:00  
> **Repo:** `D:\Projects\10- E-COMMERCE WEBSITE\zozi`  
> **Result:** 🔴 1 violations · 🟡 981 advisories · 🟢 140 info  
> **Architecture Debt Score:** **19469**  
...
| A2 | 17 | 🟡 ADVISORY | possibly dead/orphan module (no inbound imports; not an entrypoint) |
...
| DOM6 | 10 | 🟢 INFO | new domain candidate auto-detected |
...
| REG1 | 3 | 🟢 INFO | domain missing from architecture registry |
...
|---|---|---|---|---|---|
| 🔴 | DG3 | backend | `backend\services\_registry.py:69` | cross-domain import _registry -> treasury violates explicit ownership rules | declare allowed imports in layer_rules.yaml or route via treasury service facade |
...
| 🟡 | BC1 | backend | `backend\services\_registry.py:69` | cross-domain import _registry → treasury bypasses event/facade boundary | route through events/ or a treasury service facade; declare in layer_rules.yaml if intentional |
...
| 🟢 | DOM6 | backend | `backend/services|models/service` | new domain candidate auto-detected: 'service' | create backend/<layer>/service/ and group related files; or merge into nearest existing domain if this is not a real bounded context. Examples: backend\services\commission_write_service.py, backend\services\country_read_service.py, backend\services\credit_control_service.py, backend\services\customer\customer_health_service.py, backend\services\customer\customer_router_service.py, backend\services\general_ledger_service.py, backend\services\refund_posting_service.py, backend\services\supplier\supplier_badge_service.py |
| 🟢 | DOM6 | backend | `backend/services|models/write` | new domain candidate auto-detected: 'write' | create backend/<layer>/write/ and group related files; or merge into nearest existing domain if this is not a real bounded context. Examples: backend\services\commission_write_service.py, backend\services\supplier\suppliers_write_service.py, backend\services\write_helpers.py |
...
| 🟢 | MET1 | repo | `architecture-debt` | architecture debt score = 19469 | track this number down over time; lower is healthier |
...
- 🟢 **I4** `move-map` — 47 file move suggestions generated → *see 'File Move Suggestions' section in this report*
...
- 🟢 **I3** `backend/` — module graph: modules=919, edges=2504, classes=1163
- 🟢 **MET1** `architecture-debt` — architecture debt score = 19469 → *track this number down over time; lower is healthier*
...
- 🟢 **DOM8** `backend/` — 209 scanned file(s) are already in the correct domain folder → *keep these placements; do not move them*
...
- 🔴 **DG3** `backend\services\_registry.py:69` — cross-domain import _registry -> treasury violates explicit ownership rules → *declare allowed imports in layer_rules.yaml or route via treasury service facade*
...
- 🟡 **BC1** `backend\services\_registry.py:69` — cross-domain import _registry → treasury bypasses event/facade boundary → *route through events/ or a treasury service facade; declare in layer_rules.yaml if intentional*
...
| 5 | `backend\services\commission_write_service.py` | `backend/services/finance/commission_write_service.py` | domain | 86% |
...
| 9 | `backend\services\general_ledger_service.py` | `backend/services/finance/general_ledger_service.py` | domain | 97% |
| 10 | `backend\services\orders\cart_shipping_service.py` | `backend/services/logistics/cart_shipping_service.py` | domain | 74% |
| 11 | `backend\services\orders\order_payment_functions.py` | `backend/services/finance/order_payment_functions.py` | domain | 67% |
| 12 | `backend\services\refund_posting_service.py` | `backend/services/finance/refund_posting_service.py` | domain | 92% |
| 13 | `backend\services\supplier\supplier_finance_service.py` | `backend/services/finance/supplier_finance_service.py` | domain | 86% |
| 14 | `backend\services\supplier\supplier_profile_service.py` | `backend/services/customer/supplier_profile_service.py` | domain | 86% |
| 15 | `backend\services\video_conferencing.py` | `backend/services/comms/video_conferencing.py` | domain | 74% |
| 16 | `backend\models\_exports.py` | `backend/models/geography/_exports.py` | domain | 59% |
...
| 19 | `backend\controllers\cart_controller.py` | `backend/controllers/orders/cart_controller.py` | domain | 93% |
| 20 | `backend\controllers\chatbot_controller.py` | `backend/controllers/ai/chatbot_controller.py` | domain | 91% |
| 21 | `backend\controllers\comm_controller.py` | `backend/controllers/comms/comm_controller.py` | domain | 93% |
| 22 | `backend\controllers\coupons_controller.py` | `backend/controllers/commerce/coupons_controller.py` | domain | 93% |
| 23 | `backend\controllers\disputes_controller.py` | `backend/controllers/orders/disputes_controller.py` | domain | 93% |
| 24 | `backend\controllers\flash_sale_controller.py` | `backend/controllers/catalog/flash_sale_controller.py` | domain | 62% |
| 25 | `backend\controllers\logistics_partner_controller.py` | `backend/controllers/logistics/logistics_partner_controller.py` | domain | 91% |
| 26 | `backend\controllers\product_verification_controller.py` | `backend/controllers/catalog/product_verification_controller.py` | domain | 96% |
| 27 | `backend\controllers\products_controller.py` | `backend/controllers/catalog/products_controller.py` | domain | 96% |
| 28 | `backend\controllers\promotion_controller.py` | `backend/controllers/commerce/promotion_controller.py` | domain | 93% |
| 29 | `backend\controllers\returns_controller.py` | `backend/controllers/orders/returns_controller.py` | domain | 93% |
| 30 | `backend\controllers\search_controller.py` | `backend/controllers/catalog/search_controller.py` | domain | 93% |
| 31 | `backend\controllers\sub_ledger_controller.py` | `backend/controllers/finance/sub_ledger_controller.py` | domain | 93% |
| 32 | `backend\providers\bg_remover.py` | `backend/providers/media/bg_remover.py` | domain | 89% |
| 33 | `backend\providers\catalog\text.py` | `backend/providers/ai/text.py` | domain | 91% |
| 34 | `backend\providers\image.py` | `backend/providers/media/image.py` | domain | 93% |
| 35 | `backend\providers\ocr.py` | `backend/providers/ai/ocr.py` | domain | 91% |
| 36 | `backend\providers\vision.py` | `backend/providers/ai/vision.py` | domain | 91% |
| 37 | `backend\providers\voice_to_text.py` | `backend/providers/ai/voice_to_text.py` | domain | 95% |
| 38 | `backend\_fix_syntax.py` | `backend/utils/_fix_syntax.py` | backend-root | 60% |
| 39 | `backend\check_app.py` | `backend/utils/check_app.py` | backend-root | 60% |
| 40 | `backend\events.py` | `backend/utils/events.py` | backend-root | 60% |
| 41 | `backend/controllers/communication/` | `backend/controllers/comms/` | rename-folder | 100% |
| 42 | `backend/models/communication/` | `backend/models/comms/` | rename-folder | 100% |
| 43 | `backend/models/country/` | `backend/models/geography/` | rename-folder | 100% |
| 44 | `backend/providers/country/` | `backend/providers/geography/` | rename-folder | 100% |
| 45 | `backend/services/communication/` | `backend/services/comms/` | rename-folder | 100% |
| 46 | `backend/services/country/` | `backend/services/geography/` | rename-folder | 100% |
| 47 | `backend/services/payments/` | `backend/services/finance/` | rename-folder | 100% |
