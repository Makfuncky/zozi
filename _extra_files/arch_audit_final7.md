...
| A2 | 18 | 🟡 ADVISORY | possibly dead/orphan module (no inbound imports; not an entrypoint) |
...
| CFG4 | 2 | 🟡 ADVISORY | policy-level domain cycle |
...
|---|---|---|---|---|---|
| 🔴 | DG2 | backend | `domain-graph` | circular domain dependency: finance -> treasury -> finance | redefine bounded-context boundaries; introduce explicit service contracts / events |
...
| 🟡 | CA2 | services | `backend\services\finance\treasury_query_service.py` | file contains signals for 2 domains: treasury(5), finance(2) — split candidate | split this file into domain-specific modules; each file should serve one domain |
...
| 🟡 | CFG4 | repo | `layer_rules.yaml` | explicit domain policy contains a cycle: finance -> treasury -> finance | bounded-context rules should be acyclic; introduce explicit contracts/events |
| 🟡 | CFG4 | repo | `layer_rules.yaml` | explicit domain policy contains a cycle: finance -> treasury -> orders -> finance | bounded-context rules should be acyclic; introduce explicit contracts/events |
...
| 🟡 | DOM2 | services | `backend/services/` | 1 file(s) are in the wrong backend/services/ sub-folder; detected domain: 'treasury' | mkdir -p backend/services/treasury; move: backend\services\finance\treasury_query_service.py (detected from treasury) |
...
| 🟢 | MET1 | repo | `architecture-debt` | architecture debt score = 19430 | track this number down over time; lower is healthier |
...
| 🟡 | SYM2 | backend | `services.treasury.treasury_service:119, services.finance.general_ledger_service:60, services.finance.treasury_query_service:76, routers.api_finance_domain:68, routers.api_finance_routes:98` | public function 'create_journal_entry' defined in 7 modules | consolidate or rename to avoid confusion |
...
| 🟡 | SYM2 | backend | `services.supplier.supplier_countries_service:726, routers.api_geography_registry:322, controllers.country.country_controller:1162` | public function 'create_logistics_providers_draft' defined in 3 modules | consolidate or rename to avoid confusion |
...
- 🟢 **I4** `move-map` — 41 file move suggestions generated → *see 'File Move Suggestions' section in this report*
...
- 🟡 **CFG4** `layer_rules.yaml` — explicit domain policy contains a cycle: finance -> treasury -> finance → *bounded-context rules should be acyclic; introduce explicit contracts/events*
- 🟡 **CFG4** `layer_rules.yaml` — explicit domain policy contains a cycle: finance -> treasury -> orders -> finance → *bounded-context rules should be acyclic; introduce explicit contracts/events*
...
- 🟢 **I3** `backend/` — module graph: modules=917, edges=2503, classes=1163
- 🟢 **MET1** `architecture-debt` — architecture debt score = 19430 → *track this number down over time; lower is healthier*

### BACKEND (615 findings)
...
- 🔴 **DG2** `domain-graph` — circular domain dependency: finance -> treasury -> finance → *redefine bounded-context boundaries; introduce explicit service contracts / events*
...
- 🟡 **SYM2** `services.treasury.treasury_service:119, services.finance.general_ledger_service:60, services.finance.treasury_query_service:76, routers.api_finance_domain:68, routers.api_finance_routes:98` — public function 'create_journal_entry' defined in 7 modules → *consolidate or rename to avoid confusion*
...
- 🟡 **SYM2** `services.supplier.supplier_countries_service:726, routers.api_geography_registry:322, controllers.country.country_controller:1162` — public function 'create_logistics_providers_draft' defined in 3 modules → *consolidate or rename to avoid confusion*
...
- 🟡 **DOM2** `backend/services/` — 1 file(s) are in the wrong backend/services/ sub-folder; detected domain: 'treasury' → *mkdir -p backend/services/treasury; move: backend\services\finance\treasury_query_service.py (detected from treasury)*
...
- 🟡 **CA2** `backend\services\finance\treasury_query_service.py` — file contains signals for 2 domains: treasury(5), finance(2) — split candidate → *split this file into domain-specific modules; each file should serve one domain*
...
| 8 | `backend\services\finance\treasury_query_service.py` | `backend/services/treasury/treasury_query_service.py` | domain | 67% |
| 9 | `backend\services\orders\cart_shipping_service.py` | `backend/services/logistics/cart_shipping_service.py` | domain | 74% |
| 10 | `backend\services\supplier\supplier_profile_service.py` | `backend/services/customer/supplier_profile_service.py` | domain | 86% |
| 11 | `backend\services\video_conferencing.py` | `backend/services/comms/video_conferencing.py` | domain | 74% |
| 12 | `backend\models\_exports.py` | `backend/models/geography/_exports.py` | domain | 59% |
| 13 | `backend\controllers\admin_controller.py` | `backend/controllers/security/admin_controller.py` | domain | 53% |
| 14 | `backend\controllers\banner_controller.py` | `backend/controllers/core/banner_controller.py` | domain | 93% |
| 15 | `backend\controllers\cart_controller.py` | `backend/controllers/orders/cart_controller.py` | domain | 93% |
| 16 | `backend\controllers\chatbot_controller.py` | `backend/controllers/ai/chatbot_controller.py` | domain | 91% |
| 17 | `backend\controllers\comm_controller.py` | `backend/controllers/comms/comm_controller.py` | domain | 93% |
| 18 | `backend\controllers\coupons_controller.py` | `backend/controllers/commerce/coupons_controller.py` | domain | 93% |
| 19 | `backend\controllers\disputes_controller.py` | `backend/controllers/orders/disputes_controller.py` | domain | 93% |
| 20 | `backend\controllers\flash_sale_controller.py` | `backend/controllers/catalog/flash_sale_controller.py` | domain | 62% |
| 21 | `backend\controllers\logistics_partner_controller.py` | `backend/controllers/logistics/logistics_partner_controller.py` | domain | 91% |
| 22 | `backend\controllers\product_verification_controller.py` | `backend/controllers/catalog/product_verification_controller.py` | domain | 96% |
| 23 | `backend\controllers\products_controller.py` | `backend/controllers/catalog/products_controller.py` | domain | 96% |
| 24 | `backend\controllers\promotion_controller.py` | `backend/controllers/commerce/promotion_controller.py` | domain | 93% |
| 25 | `backend\controllers\returns_controller.py` | `backend/controllers/orders/returns_controller.py` | domain | 93% |
| 26 | `backend\controllers\search_controller.py` | `backend/controllers/catalog/search_controller.py` | domain | 93% |
| 27 | `backend\providers\bg_remover.py` | `backend/providers/media/bg_remover.py` | domain | 89% |
| 28 | `backend\providers\catalog\text.py` | `backend/providers/ai/text.py` | domain | 91% |
| 29 | `backend\providers\image.py` | `backend/providers/media/image.py` | domain | 93% |
| 30 | `backend\providers\ocr.py` | `backend/providers/ai/ocr.py` | domain | 91% |
| 31 | `backend\providers\vision.py` | `backend/providers/ai/vision.py` | domain | 91% |
| 32 | `backend\providers\voice_to_text.py` | `backend/providers/ai/voice_to_text.py` | domain | 95% |
| 33 | `backend\_fix_syntax.py` | `backend/utils/_fix_syntax.py` | backend-root | 60% |
| 34 | `backend\check_app.py` | `backend/utils/check_app.py` | backend-root | 60% |
| 35 | `backend\events.py` | `backend/utils/events.py` | backend-root | 60% |
| 36 | `backend/controllers/communication/` | `backend/controllers/comms/` | rename-folder | 100% |
| 37 | `backend/models/communication/` | `backend/models/comms/` | rename-folder | 100% |
| 38 | `backend/models/country/` | `backend/models/geography/` | rename-folder | 100% |
| 39 | `backend/providers/country/` | `backend/providers/geography/` | rename-folder | 100% |
| 40 | `backend/services/communication/` | `backend/services/comms/` | rename-folder | 100% |
| 41 | `backend/services/country/` | `backend/services/geography/` | rename-folder | 100% |
...
- **Architecture Debt Score:** 19430
- **Modules scanned:** 917
- **Dependency edges:** 2503
- **Classes found:** 1163
- **Layer counts:** `_fix_syntax=1`, `_triage=1`, `alembic=33`, `check_app=1`, `controllers=82`, `data=84`, `db=10`, `dependencies=3`, `events=1`, `lifespan=1`, `main=1`, `middleware=22`, `models=51`, `providers=44`, `routers=152`, `run_server=1`, `scripts=3`, `services=282`, `tests=74`, `utils=70`
