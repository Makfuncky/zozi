...
class VideoAnalytics(Base):
    ...
    __table_args__ = ({"schema": "media"},)
    id = Column(Integer, primary_key=True, index=True)
    video_id = Column(Integer, ForeignKey("product_videos.id", ondelete="RESTRICT"), nullable=False, index=True)
...
class ProductFilterOption(Base):
    ...
    __table_args__ = ({"schema": "commerce"},)
    id = Column(Integer, primary_key=True, index=True)
    filter_metadata_id = Column(Integer, ForeignKey("product_filter_metadata.id", ondelete="RESTRICT"), nullable=False, index=True)
