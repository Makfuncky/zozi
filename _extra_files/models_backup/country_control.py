...
class ShiftHandoverLog(Base):
    ...
    handover_to_user_id = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
...
class CountryMapConfig(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    country_code = Column(String(10), ForeignKey("country_configs.code", ondelete="RESTRICT"), nullable=False, unique=True, index=True)
...
class ParcelLocationTracker(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    parcel_id = Column(Integer, ForeignKey("shipments.id", ondelete="RESTRICT"), nullable=False, index=True)
    country_code = Column(String(10), ForeignKey("country_configs.code", ondelete="RESTRICT"), nullable=False, index=True)
    latitude = Column(Float, nullable=True)
    longitude = Column(Float, nullable=True)
