...
class AIUploadJob(Base):
    ...
    created_product_id = Column(Integer, ForeignKey("products.id", ondelete="RESTRICT"), nullable=True, index=True)
...
class AIStagingProduct(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    job_id = Column(Integer, ForeignKey("ai_upload_jobs.id", ondelete="RESTRICT"), nullable=False, index=True)
...
class AIStagingVariant(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    job_id = Column(Integer, ForeignKey("ai_upload_jobs.id", ondelete="RESTRICT"), nullable=False, index=True)
    staging_product_id = Column(Integer, ForeignKey("ai_staging_products.id", ondelete="RESTRICT"), nullable=False, index=True)
