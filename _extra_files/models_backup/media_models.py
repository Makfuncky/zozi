...
class MediaAsset(Base):
    ...
    uploaded_by = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
...
class MediaUploadSession(Base):
    ...
    __table_args__ = (
        Index("ix_media_upload_sessions_entity", "entity_type", "entity_id"),
        Index("ix_media_upload_sessions_created_by", "created_by"),
        {"schema": "media"},
    )
