...
class CommissionAgreement(Base):
    ...
    set_by_admin_id = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
...
class CommissionLedgerEntry(Base):
    ...
    adjusted_by = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
