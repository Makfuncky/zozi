...
class TicketAttachment(Base):
    ...
    __table_args__ = ({"schema": "communication"},)
    id = Column(Integer, primary_key=True, index=True)
    ticket_reply_id = Column(Integer, ForeignKey("support_ticket_replies.id", ondelete="RESTRICT"), nullable=True, index=True)
    ticket_id = Column(Integer, ForeignKey("support_tickets.id", ondelete="RESTRICT"), nullable=True, index=True)
...
class NewsArticle(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    source_id = Column(Integer, ForeignKey("news_sources.id", ondelete="RESTRICT"), nullable=True, index=True)
...
class EntityChatMessage(Base):
    ...
    __table_args__ = ({"schema": "communication"},)
    id = Column(Integer, primary_key=True, index=True)
    thread_id = Column(Integer, ForeignKey("entity_chat_threads.id", ondelete="RESTRICT"), nullable=False, index=True)
    sender_id = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=False, index=True)
    message = Column(Text, nullable=False)
...
class VideoRoomParticipant(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    room_id = Column(Integer, ForeignKey("video_rooms.id", ondelete="RESTRICT"), nullable=False)
...
class VideoRoomRecording(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    room_id = Column(Integer, ForeignKey("video_rooms.id", ondelete="RESTRICT"), nullable=False, index=True)
...
class DirectChatRoom(Base):
    ...
    participant_one = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=False)
    participant_two = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=False)
    country_code = Column(String(10), ForeignKey("country_configs.code", ondelete="RESTRICT"), nullable=True, index=True)
...
class DirectChatMessage(Base):
    ...
    __table_args__ = ({"schema": "communication"},)
    id = Column(Integer, primary_key=True, index=True)
    room_id = Column(Integer, ForeignKey("direct_chat_rooms.id", ondelete="RESTRICT"), nullable=False, index=True)
    sender_id = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=False, index=True)
    message = Column(Text, nullable=False)
    message_type = Column(String(20), default="text")
    read_at = Column(DateTime, nullable=True)
...
class GroupChatMember(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    room_id = Column(Integer, ForeignKey("group_chat_rooms.id", ondelete="RESTRICT"), nullable=False)
    user_id = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=False)
...
class GroupChatMessage(Base):
    ...
    __table_args__ = ({"schema": "communication"},)
    id = Column(Integer, primary_key=True, index=True)
    room_id = Column(Integer, ForeignKey("group_chat_rooms.id", ondelete="RESTRICT"), nullable=False, index=True)
    sender_id = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=False, index=True)
    message = Column(Text, nullable=False)
    message_type = Column(String(20), default="text")
    read_at = Column(DateTime, nullable=True)
...
class ShiftHandoverSession(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    country_code = Column(String(10), ForeignKey("country_configs.code", ondelete="RESTRICT"), nullable=True, index=True)
    outgoing_employee_id = Column(Integer, ForeignKey("employees.id", ondelete="RESTRICT"), nullable=False)
    incoming_employee_id = Column(Integer, ForeignKey("employees.id", ondelete="RESTRICT"), nullable=True)
...
class ShiftHandoverTask(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    session_id = Column(Integer, ForeignKey("shift_handover_sessions.id", ondelete="RESTRICT"), nullable=False, index=True)
...
class EscalationSLALog(Base):
    ...
    original_recipient_id = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
    escalated_to_user_id = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
