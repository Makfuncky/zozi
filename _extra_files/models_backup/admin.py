...
class SystemAlert(Base):
    ...
    acknowledged_by = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
...
class BadgeBillingRecord(Base):
    ...
    bank_transaction_id = Column(Integer, ForeignKey("bank_transactions.id", ondelete="RESTRICT"), nullable=True, index=True)
    created_at = Column(DateTime, default=_utcnow)
    updated_at = Column(DateTime, default=_utcnow, onupdate=_utcnow)
    country_code = Column(String(10), nullable=True, index=True)
...
class CommissionBadgeTier(Base):
    ...
    is_active = Column(Boolean, default=True)
    updated_by = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
    created_at = Column(DateTime, default=_utcnow)
    updated_at = Column(DateTime, default=_utcnow, onupdate=_utcnow)
    country_code = Column(String(10), nullable=True, index=True)
...
class TicketReply(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    ticket_id = Column(Integer, ForeignKey("support_tickets.id", ondelete="RESTRICT"), nullable=False, index=True)
...
class CouponUsage(Base):
    ...
    __table_args__ = ({"schema": "commerce"},)
    id = Column(Integer, primary_key=True, index=True)
    coupon_id = Column(Integer, ForeignKey("coupons.id", ondelete="RESTRICT"), nullable=False, index=True)
    user_id = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=False, index=True)
    order_id = Column(Integer, ForeignKey("orders.id", ondelete="RESTRICT"), nullable=True, index=True)
    country_code = Column(String(10), ForeignKey("country_configs.code", ondelete="RESTRICT"), nullable=True, index=True)
    created_at = Column(DateTime, default=_utcnow)
...
class LogisticsCODRemittanceReceipt(Base):
    ...
    __table_args__ = ({"schema": "logistics"},)
    id = Column(Integer, primary_key=True, index=True)
    partner_id = Column(Integer, ForeignKey("logistics_partners.id", ondelete="RESTRICT"), nullable=True, index=True)
    shipment_id = Column(Integer, ForeignKey("shipments.id", ondelete="RESTRICT"), nullable=True, index=True)
    settlement_id = Column(Integer, ForeignKey("logistics_settlements.id", ondelete="RESTRICT"), nullable=True, index=True)
    amount = Column(Numeric(12, 2), nullable=False)
...
class LogisticsPartnerBankAccount(Base):
    ...
    verified_by = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
    is_active = Column(Boolean, default=True)
    created_at = Column(DateTime, default=_utcnow)
    updated_at = Column(DateTime, default=_utcnow, onupdate=_utcnow)
    country_code = Column(String(10), nullable=True, index=True)
...
class ShipmentConfirmation(Base):
    ...
    __table_args__ = ({"schema": "logistics"},)
    id = Column(Integer, primary_key=True, index=True)
    shipment_id = Column(Integer, ForeignKey("shipments.id", ondelete="RESTRICT"), nullable=False, index=True)
    order_id = Column(Integer, ForeignKey("orders.id", ondelete="RESTRICT"), nullable=True, index=True)
    supplier_id = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
    requester_user_id = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
...
class ChatbotQueryEvent(Base):
    ...
    clicked_product_id = Column(Integer, ForeignKey("products.id", ondelete="RESTRICT"), nullable=True)
...
class SupplierDispute(Base):
    ...
    resolved_by = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
