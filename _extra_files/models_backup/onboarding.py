...
class OnboardingStep(Base):
    ...
    __table_args__ = ({"schema": "hr"},)
    id = Column(Integer, primary_key=True, index=True)
    pipeline_id = Column(Integer, ForeignKey("onboarding_pipelines.id", ondelete="RESTRICT"), nullable=False, index=True)
...
class DocumentVerification(Base):
    ...
    verifier_id = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
...
class OCRResult(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    document_verification_id = Column(Integer, ForeignKey("document_verifications.id", ondelete="RESTRICT"), nullable=False, unique=True, index=True)
...
class KYCVerification(Base):
    ...
    reviewer_id = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
