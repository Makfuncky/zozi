...
spec = importlib.util.spec_from_file_location("iso_models_mixins", r"D:\Projects\10- E-COMMERCE WEBSITE\zozi\backend\models\mixins.py")
m = importlib.util.module_from_spec(spec)
spec.loader.exec_module(m)

B = declarative_base()
class Foo(B, m.StandardMixin):
