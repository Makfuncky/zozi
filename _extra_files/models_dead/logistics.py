...
class LogisticsPartner(Base):
    ...
    __table_args__ = (
                         Index("ix_logistics_partners_coverage_regions", "coverage_regions", postgresql_using="gin"),
                         Index("ix_logistics_partners_service_types", "service_types", postgresql_using="gin"),
                         Index("ix_logistics_partners_social_links", "social_links", postgresql_using="gin"),
                         Index("ix_logistics_partners_country_created", "country_code", "created_at"),
                         {"schema": "logistics"},
                     )
    ...
    country_code = Column(String(3), ForeignKey("country_configs.code", ondelete="RESTRICT"), nullable=True, index=True)
...
class LogisticsPartnerProfile(Base):
    ...
    __table_args__ = (
                         Index("ix_logistics_partner_profiles_country_created", "country_code", "created_at"),
                         {"schema": "logistics"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    partner_id = Column(Integer, ForeignKey("logistics_partners.id", ondelete="RESTRICT"), nullable=False, unique=True, index=True)
    tax_id = Column(String, nullable=True)
...
class LogisticsPartnerServiceArea(Base):
    ...
    __table_args__ = (
                         Index("ix_logistics_partner_service_areas_country_created", "country_code", "created_at"),
                         {"schema": "logistics"},
                     )
    id = Column(Integer, primary_key=True, index=True)
...
class LogisticsPricingProfile(Base):
    ...
    __table_args__ = (
                         Index("ix_logistics_pricing_profiles_country_created", "country_code", "created_at"),
                         {"schema": "logistics"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    partner_id = Column(Integer, ForeignKey("logistics_partners.id", ondelete="RESTRICT"), nullable=False, index=True)
    service_area_id = Column(Integer, ForeignKey("logistics_partner_service_areas.id", ondelete="RESTRICT"), nullable=False, index=True)
...
class LogisticsVehicleRule(Base):
    ...
    __table_args__ = (
                         Index("ix_logistics_vehicle_rules_country_created", "country_code", "created_at"),
                         {"schema": "logistics"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    partner_id = Column(Integer, ForeignKey("logistics_partners.id", ondelete="RESTRICT"), nullable=False, index=True)
...
class LogisticsCategoryPricingRule(Base):
    ...
    __table_args__ = (
                         Index("ix_logistics_category_pricing_rules_country_created", "country_code", "created_at"),
                         {"schema": "logistics"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    partner_id = Column(Integer, ForeignKey("logistics_partners.id", ondelete="RESTRICT"), nullable=False, index=True)
    service_area_id = Column(Integer, ForeignKey("logistics_partner_service_areas.id", ondelete="RESTRICT"), nullable=True, index=True)
...
class Shipment(Base):
    ...
    __table_args__ = (
                         ...
                         Index("ix_shipments_country_created", "country_code", "created_at"),
                         {"schema": "logistics"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    ...
    assigned_partner_id = Column(Integer, ForeignKey("logistics_partners.id", ondelete="RESTRICT"), nullable=True, index=True)
    carrier_id = Column(Integer, ForeignKey("shipping_carriers.id", ondelete="RESTRICT"), nullable=True, index=True)
...
class ShipmentEvent(Base):
    ...
    __table_args__ = (
                         ...
                         Index("ix_shipment_events_country_created", "country_code", "created_at"),
                         {"schema": "logistics"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    shipment_id = Column(Integer, ForeignKey("shipments.id", ondelete="RESTRICT"), nullable=False)
    order_id = Column(Integer, ForeignKey("orders.id", ondelete="RESTRICT"), nullable=False)
    supplier_id = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=False, index=True)
