...
class FiscalPeriod(Base):
    ...
    __table_args__ = (
                         ...
                         Index("ix_fiscal_periods_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    ...
    closed_by = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
...
class TransactionLedger(Base):
    ...
    __table_args__ = (
                         ...
                         Index("ix_transaction_ledgers_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    user_id = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
    supplier_id = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
    logistics_partner_id = Column(Integer, ForeignKey("logistics_partners.id", ondelete="RESTRICT"), nullable=True, index=True)
    order_id = Column(Integer, ForeignKey("orders.id", ondelete="RESTRICT"), nullable=True, index=True)
    order_item_id = Column(Integer, ForeignKey("order_items.id", ondelete="RESTRICT"), nullable=True, index=True)
    shipment_id = Column(Integer, ForeignKey("shipments.id", ondelete="RESTRICT"), nullable=True, index=True)
...
class SupplierSettlement(Base):
    ...
    __table_args__ = (
                         ...
                         Index("ix_supplier_settlements_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    supplier_id = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=False, index=True)
    order_id = Column(Integer, ForeignKey("orders.id", ondelete="RESTRICT"), nullable=True, index=True)
    ledger_id = Column(Integer, ForeignKey("transaction_ledgers.id", ondelete="RESTRICT"), nullable=True, index=True)
    payout_id = Column(Integer, ForeignKey("payouts.id", ondelete="RESTRICT"), nullable=True, index=True)
    shipment_id = Column(Integer, ForeignKey("shipments.id", ondelete="RESTRICT"), nullable=True, index=True)
    ...
    deleted_by = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
...
class JournalEntry(Base):
    ...
    __table_args__ = (
                         ...
                         Index("ix_journal_entries_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    ...
    period_id = Column(Integer, ForeignKey("fiscal_periods.id", ondelete="RESTRICT"), nullable=True, index=True)
    reversal_of_id = Column(Integer, ForeignKey("journal_entries.id", ondelete="RESTRICT"), nullable=True, index=True)
    is_deleted = Column(Boolean, default=False, index=True)
    deleted_at = Column(DateTime, nullable=True)
    deleted_by = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
    created_at = Column(DateTime, default=_utcnow)
...
class JournalEntryLine(Base):
    ...
    __table_args__ = (
                         ...
                         Index("ix_journal_entry_lines_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    entry_id = Column(Integer, ForeignKey("journal_entries.id", ondelete="RESTRICT"), nullable=False)
    account_id = Column(Integer, ForeignKey("accounts.id", ondelete="RESTRICT"), nullable=False)
    cost_center_id = Column(Integer, ForeignKey("cost_centers.id", ondelete="RESTRICT"), nullable=True, index=True)
...
class Account(Base):
    ...
    __table_args__ = (
                         ...
                         Index("ix_accounts_group", "group_id"),
                         CheckConstraint("normal_side IN ('debit', 'credit')", name="chk_account_normal_side_valid"),
                         Index("ix_accounts_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    group_id = Column(Integer, ForeignKey("account_groups.id", ondelete="RESTRICT"), nullable=True)
...
class AccountGroup(Base):
    ...
    __table_args__ = (
                         ...
                         Index("ix_account_groups_order", "display_order"),
                         Index("ix_account_groups_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
...
class ARLedgerEntry(Base):
    ...
    __table_args__ = (
                         ...
                         Index("ix_ar_ledger_entries_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    customer_id = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=False, index=True)
    order_id = Column(Integer, ForeignKey("orders.id", ondelete="RESTRICT"), nullable=True, index=True)
    invoice_id = Column(Integer, ForeignKey("invoices.id", ondelete="RESTRICT"), nullable=True, index=True)
    reference_type = Column(String(50), nullable=True)
    reference_id = Column(Integer, nullable=True)
...
class APLedger(Base):
    ...
    __table_args__ = (
                         ...
                         Index("ix_ap_ledger_entries_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    supplier_id = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=False, index=True)
    order_id = Column(Integer, ForeignKey("orders.id", ondelete="RESTRICT"), nullable=True, index=True)
    invoice_id = Column(Integer, ForeignKey("invoices.id", ondelete="RESTRICT"), nullable=True, index=True)
    settlement_id = Column(Integer, ForeignKey("supplier_settlements.id", ondelete="RESTRICT"), nullable=True, index=True)
    reference_type = Column(String(50), nullable=True)
    reference_id = Column(Integer, nullable=True)
...
class FinancialReport(Base):
    ...
    __table_args__ = (Index("ix_financial_reports_data", "data", postgresql_using="gin"), {"schema": "analytics"})
    id = Column(Integer, primary_key=True, index=True)
...
class Invoice(Base):
    ...
    __table_args__ = (
                         Index("ix_invoices_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
...
class InvoiceItem(Base):
    ...
    __table_args__ = (
                         Index("ix_invoice_items_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
...
class RefundLedger(Base):
    ...
    __table_args__ = (
                         Index("ix_refund_ledger_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    order_id = Column(Integer, ForeignKey("orders.id", ondelete="RESTRICT"), nullable=False, index=True)
    return_request_id = Column(Integer, ForeignKey("return_requests.id", ondelete="RESTRICT"), nullable=True, index=True)
    ...
    performed_by = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
...
class BankTransaction(Base):
    ...
    __table_args__ = (
                         Index("ix_bank_transactions_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    ...
    currency = Column(String(3), default="OMR")
    description = Column(Text, nullable=True)
    linked_order_id = Column(Integer, ForeignKey("orders.id", ondelete="RESTRICT"), nullable=True, index=True)
    linked_supplier_id = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
    ...
    reconciled_by = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
...
class VATRemittance(Base):
    ...
    __table_args__ = (
                         Index("ix_vat_remittances_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    period_start = Column(DateTime, nullable=False)
    ...
    currency = Column(String(3), default="OMR")
    bank_transaction_id = Column(Integer, nullable=True)
    remitted_by = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
...
class CashAccount(Base):
    ...
    __table_args__ = (
                         Index("ix_cash_accounts_country_created", "country_code", "created_at"),
                         {"schema": "treasury"},
                     )
    id = Column(Integer, primary_key=True, index=True)
...
class CashTransaction(Base):
    ...
    __table_args__ = (
                         Index("ix_cash_transactions_country_created", "country_code", "created_at"),
                         {"schema": "treasury"},
                     )
    id = Column(Integer, primary_key=True, index=True)
...
class TreasuryAccount(Base):
    ...
    __table_args__ = (
                         Index("ix_treasury_accounts_country_created", "country_code", "created_at"),
                         {"schema": "treasury"},
                     )
    id = Column(Integer, primary_key=True, index=True)
...
class TreasuryTransaction(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    from_account_id = Column(Integer, ForeignKey("treasury_accounts.id", ondelete="RESTRICT"), nullable=True, index=True)
    to_account_id = Column(Integer, ForeignKey("treasury_accounts.id", ondelete="RESTRICT"), nullable=True, index=True)
    account_id = Column(Integer, ForeignKey("treasury_accounts.id", ondelete="RESTRICT"), nullable=True, index=True)
    transaction_type = Column(String, nullable=False)
    amount = Column(Numeric(12, 2), nullable=False)
    currency = Column(String(3), default="USD")
    reference = Column(String, nullable=True)
...
class CashFlowForecast(Base):
    ...
    __table_args__ = (
                         Index("ix_cash_flow_forecasts_country_created", "country_code", "created_at"),
                         {"schema": "treasury"},
                     )
    id = Column(Integer, primary_key=True, index=True)
...
class CashPositionSnapshot(Base):
    ...
    __table_args__ = (
                         Index("ix_cash_position_snapshots_country_created", "country_code", "created_at"),
                         {"schema": "treasury"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    snapshot_time = Column(DateTime, nullable=False)
    account_id = Column(Integer, ForeignKey("treasury_accounts.id", ondelete="RESTRICT"), nullable=False, index=True)
    balance = Column(Numeric(12, 2), default=0)
    currency = Column(String(3), default="USD")
    country_code = Column(String(3), nullable=True, index=True)
    created_at = Column(DateTime, default=_utcnow)
...
class GatewaySettlementSchedule(Base):
    ...
    __table_args__ = (
                         Index("ix_gateway_settlement_schedules_country_created", "country_code", "created_at"),
                         {"schema": "treasury"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    gateway_id = Column(Integer, ForeignKey("payment_gateway_connections.id", ondelete="RESTRICT"), nullable=False, index=True)
...
class PendingJournalEntry(Base):
    ...
    __table_args__ = (
                         Index("ix_pending_je_status", "status"),
                         Index("ix_pending_je_maker", "created_by"),
                         Index("ix_pending_je_country", "country_code"),
                         Index("ix_pending_journal_entries_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    ...
    approved_by = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
    rejected_by = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
    rejection_reason = Column(Text, nullable=True)
    approved_at = Column(DateTime, nullable=True)
    journal_entry_id = Column(Integer, ForeignKey("journal_entries.id", ondelete="RESTRICT"), nullable=True, index=True)
    created_at = Column(DateTime, default=_utcnow)
...
class PayoutBatch(Base):
    ...
    __table_args__ = (Index("ix_payout_batches_country_created", "country_code", "created_at"),)
...
class PayoutBatchItem(Base):
    ...
    __table_args__ = ({"schema": "treasury"},)
    id = Column(Integer, primary_key=True, index=True)
    batch_id = Column(Integer, ForeignKey("payout_batches.id", ondelete="RESTRICT"), nullable=False, index=True)
...
class BankMappingRule(Base):
    ...
    __table_args__ = (
                         ...
                         Index("ix_bank_mapping_rules_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    country_code = Column(String(3), nullable=True, index=True)
...
class BankStatementImport(Base):
    ...
    __table_args__ = (
                         Index("ix_bsi_country", "country_code"),
                         Index("ix_bank_statement_imports_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    ...
    imported_by = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
    country_code = Column(String(3), nullable=True, index=True)
    created_at = Column(DateTime, default=_utcnow)
...
class BankStatementLine(Base):
    ...
    __table_args__ = (
                         ...
                         Index("ix_bank_statement_lines_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    import_id = Column(Integer, ForeignKey("bank_statement_imports.id", ondelete="RESTRICT"), nullable=False, index=True)
    ...
    mapping_rule_id = Column(Integer, ForeignKey("bank_mapping_rules.id", ondelete="RESTRICT"), nullable=True, index=True)
    status = Column(String(20), default="unmapped")  # unmapped, mapped, posted, reconciled
    posted_journal_entry_id = Column(Integer, ForeignKey("journal_entries.id", ondelete="RESTRICT"), nullable=True, index=True)
    reconciled_transaction_id = Column(Integer, ForeignKey("bank_transactions.id", ondelete="RESTRICT"), nullable=True, index=True)
    country_code = Column(String(3), nullable=True, index=True)
    created_at = Column(DateTime, default=_utcnow)
...
class FixedAsset(Base):
    ...
    __table_args__ = (
                         Index("ix_fa_country", "country_code"),
                         Index("ix_fixed_assets_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    name = Column(String(200), nullable=False)
...
class Accrual(Base):
    ...
    __table_args__ = (
                         Index("ix_accrual_country", "country_code"),
                         Index("ix_accrual_status", "status"),
                         Index("ix_accruals_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    ...
    journal_entry_id = Column(Integer, ForeignKey("journal_entries.id", ondelete="RESTRICT"), nullable=True, index=True)
    reversal_entry_id = Column(Integer, ForeignKey("journal_entries.id", ondelete="RESTRICT"), nullable=True, index=True)
    country_code = Column(String(3), nullable=True, index=True)
    created_by = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
    created_at = Column(DateTime, default=_utcnow)
...
class ScannedExpense(Base):
    ...
    __table_args__ = (
                         Index("ix_se_country", "country_code"),
                         Index("ix_se_status", "status"),
                         Index("ix_scanned_expenses_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    employee_id = Column(Integer, ForeignKey("employees.id", ondelete="RESTRICT"), nullable=True, index=True)
    ...
    posted_journal_entry_id = Column(Integer, ForeignKey("journal_entries.id", ondelete="RESTRICT"), nullable=True, index=True)
    reviewed_by = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
    country_code = Column(String(3), nullable=True, index=True)
    created_at = Column(DateTime, default=_utcnow)
    updated_at = Column(DateTime, default=_utcnow, onupdate=_utcnow)
...
class Vendor(Base):
    ...
    __table_args__ = (
                         Index("ix_vendors_country", "country_code"),
                         Index("ix_vendors_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    name = Column(String(200), nullable=False)
...
class Customer(Base):
    ...
    __table_args__ = (
                         ...
                         Index("ix_customers_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    name = Column(String(200), nullable=False)
...
class CostCenter(Base):
    ...
    __table_args__ = (
                         Index("ix_cost_centers_country", "country_code"),
                         Index("ix_cost_centers_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
...
class APBill(Base):
    ...
    __table_args__ = (
                         ...
                         Index("ix_ap_bills_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    ...
    linked_journal_entry_id = Column(Integer, ForeignKey("journal_entries.id", ondelete="RESTRICT"), nullable=True, index=True)
    paid_journal_entry_id = Column(Integer, ForeignKey("journal_entries.id", ondelete="RESTRICT"), nullable=True, index=True)
    country_code = Column(String(3), nullable=True, index=True)
    created_by = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
    created_at = Column(DateTime, default=_utcnow)
    updated_at = Column(DateTime, default=_utcnow, onupdate=_utcnow)
...
class ARInvoice(Base):
    ...
    __table_args__ = (
                         ...
                         Index("ix_ar_invoices_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
...
class BankAccount(Base):
    ...
    __table_args__ = (
                         Index("ix_bank_accounts_country", "country_code"),
                         Index("ix_bank_accounts_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
...
class Budget(Base):
    ...
    __table_args__ = (
                         ...
                         Index("ix_budgets_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    account_code = Column(String(20), nullable=False)
    fiscal_period_id = Column(Integer, ForeignKey("fiscal_periods.id", ondelete="RESTRICT"), nullable=False)
    amount = Column(Numeric(16, 4), nullable=False)
    currency = Column(String(3), default="OMR")
    country_code = Column(String(3), nullable=True, index=True)
    notes = Column(Text, nullable=True)
...
class BankReconciliation(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    statement_line_id = Column(Integer, ForeignKey("bank_statement_lines.id", ondelete="RESTRICT"), nullable=False, index=True)
    journal_entry_id = Column(Integer, ForeignKey("journal_entries.id", ondelete="RESTRICT"), nullable=True, index=True)
    ...
    matched_by = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
...
class RecurringTemplate(Base):
    ...
    __table_args__ = (
                         Index("ix_recurring_country", "country_code"),
                         Index("ix_recurring_templates_lines", "lines", postgresql_using="gin"),
                         Index("ix_recurring_templates_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    name = Column(String(200), nullable=False)
...
class FinanceAuditLog(Base):
    ...
    __table_args__ = (
                         ...
                         Index("ix_finance_audit_logs_detail", "detail", postgresql_using="gin"),
                         Index("ix_finance_audit_logs_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
...
class FinanceAutomationLog(Base):
    ...
    __table_args__ = (
                         Index("ix_fal_kind", "kind"),
                         Index("ix_fal_country", "country_code"),
                         Index("ix_finance_automation_logs_detail", "detail", postgresql_using="gin"),
                         Index("ix_finance_automation_logs_country_created", "country_code", "created_at"),
                         {"schema": "finance"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    ...
    detail = Column(JSON, nullable=True)
    run_by = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True, index=True)
    country_code = Column(String(3), nullable=True, index=True)
    created_at = Column(DateTime, default=_utcnow)
