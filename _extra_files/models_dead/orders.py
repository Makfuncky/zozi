...
class Order(Base):
    ...
    __table_args__ = (
                         ...
                         Index("ix_orders_country_created", "country_code", "created_at"),
                         {"schema": "commerce"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    order_number = Column(String, unique=True, index=True)
    customer_id = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=True)
...
class OrderItem(Base):
    ...
    __table_args__ = (
                         ...
                         Index("ix_order_items_country_created", "country_code", "created_at"),
                         {"schema": "commerce"},
                     )
    id = Column(Integer, primary_key=True, index=True)
...
class OrderLogisticsAllocation(Base):
    ...
    __table_args__ = (
                         Index("ix_order_logistics_allocations_country_created", "country_code", "created_at"),
                         {"schema": "commerce"},
                     )
    id = Column(Integer, primary_key=True, index=True)
...
class ReturnRequest(Base):
    ...
    __table_args__ = (
                         Index("ix_return_requests_country_created", "country_code", "created_at"),
                         {"schema": "commerce"},
                     )
    id = Column(Integer, primary_key=True, index=True)
    order_id = Column(Integer, ForeignKey("orders.id", ondelete="RESTRICT"), nullable=False, index=True)
