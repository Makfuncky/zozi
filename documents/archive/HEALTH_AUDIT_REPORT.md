...
| 🟠 P1 (fix this sprint) | 120 | Scaling / performance risk |
| 🟡 P2 (fix this month) | 542 | Maintainability / structure |
| 🟢 P3 (fix when convenient) | 638 | Hygiene / style |
...
| 5 | `backend\routers\supplier\supplier_orders.py` | 16 | API101, HL102, HL302, HL801, PG103, SC101 |
| 6 | `backend\routers\internal\hr_dashboard.py` | 16 | API101, HL102, HL303, HL801, PG102, SC101 |
| 7 | `backend\routers\admin\command_center.py` | 16 | API101, HL102, HL302, HL801, PG102, SC101 |
| 8 | `backend\middleware\country_context.py` | 15 | HL204, HL302, HL601, HL602, HL801, MR104 |
| 9 | `backend\services\country\country_ai_research.py` | 14 | HL302, HL601, HL602, HL801, MR104 |
| 10 | `backend\routers\media\ai_upload.py` | 14 | API101, HL303, HL801, PG103, SC101 |
| 11 | `backend\controllers\orders\returns_controller.py` | 14 | HL102, HL302, HL601, HL602, HL801 |
| 12 | `backend\utils\email_service.py` | 13 | HL102, HL303, HL601, HL602 |
| 13 | `backend\services\ai\ai_service.py` | 13 | HL101, HL102, HL302, HL501, HL801, MR104 |
| 14 | `backend\routers\supplier\supplier.py` | 13 | API101, HL101, HL102, HL302, HL801, PG103 |
| 15 | `backend\routers\country\country_maps.py` | 13 | API101, HL801, PG103, SC101 |
| 16 | `backend\routers\admin\admin_treasury.py` | 13 | API101, HL101, HL102, HL302, HL801, SC101 |
| 17 | `backend\services\country\country_detection.py` | 12 | HL302, HL601, HL602, HL801 |
| 18 | `backend\routers\security\fraud_detection.py` | 12 | API101, PG103, SC101 |
| 19 | `backend\routers\admin\country_communications.py` | 12 | API101, PG102, SC101 |
| 20 | `backend\providers\logistics\geo.py` | 12 | HL302, HL601, HL602, HL801 |
...
| HL101 | 30 | 🟡 P2 | 🟡 ADVISORY | oversized Python file |
| HL102 | 86 | 🟡 P2 | 🟡 ADVISORY | oversized Python function |
...
| HL501 | 16 | 🟠 P1 | 🟡 ADVISORY | heavy top-level import in web path (lazy-load recommended) |
| HL502 | 10 | 🟡 P2 | 🟡 ADVISORY | star import (from x import *) pollutes namespace |
| HL601 | 13 | 🟠 P1 | 🟡 ADVISORY | sequential external calls (concurrency opportunity) |
| HL602 | 17 | 🟠 P1 | 🟡 ADVISORY | missing timeout on external call |
| HL801 | 135 | 🟢 P3 | 🟡 ADVISORY |  |
| HL902 | 1 | 🟢 P3 | 🟡 ADVISORY |  |
| MR101 | 3 | 🟡 P2 | 🟡 ADVISORY | nested list comprehension (use generator) |
| MR104 | 19 | 🟡 P2 | 🟡 ADVISORY | global mutable state (breaks scaling) |
...
| 🟠 P1 | 🟡 | HL602 | concurrency | `backend\utils\config.py` | external call(s) missing timeout: _load_field_encryption_key_from_aws_ssm:396 | always set timeout; add retry + circuit breaker |
...
| 🟠 P1 | 🟡 | OB101 | observability | `backend/controllers/` | 53 modules missing structured logger | Add logger = logging.getLogger(__name__). Top: admin_controller.py, compliance_controller.py, expense_controller.py, mobile_controller.py, __init__.py +48 more |
...
| 🟠 P1 | 🟡 | OB101 | observability | `backend/services/` | 91 modules missing structured logger | Add logger = logging.getLogger(__name__). Top: __init__.py, badge_billing_service.py, bank_transaction_service.py, cash_management_write_service.py, treasury_service.py +86 more |
| 🟠 P1 | 🟡 | OB102 | observability | `backend/controllers/` | 71 modules missing request_id / correlation_id | Add X-Request-ID middleware in main.py (fixes all 71 at once). Top: admin_controller.py, ai_controller.py, compliance_controller.py, expense_controller.py, export_controller.py +66 more |
...
| 🟠 P1 | 🟡 | PG102 | polyglot | `backend\utils\realtime.py` | WebSocket handler in Python: connect_order, connect_partner, connect_user | Python for business logic; Node.js gateway for high-throughput real-time |
...
| 🟠 P1 | 🟡 | PG102 | polyglot | `backend\routers\communication\ws_chat.py` | WebSocket handler in Python: connect, websocket_user, websocket_chat | Python for business logic; Node.js gateway for high-throughput real-time |
...
- 🟡 🟡 **HL102** `backend\main.py` — oversized function(s): _load_routers (227L) → *extract smaller functions*
...
- 🟡 🟡 **HL101** `backend\routers\admin\admin.py` — oversized Python file (1980 lines) → *split by responsibility/domain*
- 🟡 🟡 **HL101** `backend\routers\admin\admin_treasury.py` — oversized Python file (1782 lines) → *split by responsibility/domain*
...
- 🟡 🟡 **HL101** `backend\routers\admin\command_center_api.py` — oversized Python file (909 lines) → *split by responsibility/domain*
...
- 🟡 🟡 **HL502** `backend\models\__init__.py` — star import(s) at lines: 8, 9, 10, 11, 12, 13 +25 more → *use explicit imports*
- 🟡 🟡 **HL101** `backend\models\treasury\finance.py` — oversized Python file (928 lines) → *split by responsibility/domain*
...
- 🟡 🟡 **HL101** `backend\controllers\supplier\supplier_controller.py` — oversized Python file (4664 lines) → *split by responsibility/domain*
- 🟡 🟡 **HL102** `backend\controllers\supplier\supplier_controller.py` — oversized function(s): _persist_supplier_product (99L), _parse_product_variants_payload (83L), get_supplier_orders (148L), get_supplier_label_payload (143L), upload_supplier_parcel_proof (158L), create_supplier_product_upload (132L) → *extract smaller functions*
...
- 🟡 🟡 **HL101** `backend\controllers\security\auth_controller.py` — oversized Python file (1972 lines) → *split by responsibility/domain*
...
- 🟡 🟡 **HL502** `backend\controllers\admin\__init__.py` — star import(s) at lines: 3, 4, 5, 6, 7, 8 +3 more → *use explicit imports*
...
- 🟠 🟡 **HL602** `backend\utils\config.py` — external call(s) missing timeout: _load_field_encryption_key_from_aws_ssm:396 → *always set timeout; add retry + circuit breaker*
...
- 🟠 🟡 **PG102** `backend\utils\realtime.py` — WebSocket handler in Python: connect_order, connect_partner, connect_user → *Python for business logic; Node.js gateway for high-throughput real-time*
...
- 🟠 🟡 **PG102** `backend\routers\communication\ws_chat.py` — WebSocket handler in Python: connect, websocket_user, websocket_chat → *Python for business logic; Node.js gateway for high-throughput real-time*
...
- 🟡 🟡 **API101** `backend\routers\admin\admin_payouts.py` — endpoint(s) missing response_model: list_payouts, list_pending_payouts, list_pending_payouts_by_country, verify_payout, run_auto_payout_sweep, process_payout → *add response_model for type safety and docs*
...
- 🟡 🟡 **API101** `backend\routers\admin\admin_suppliers.py` — endpoint(s) missing response_model: get_supplier_by_country, update_supplier_by_country, approve_supplier_kyc, reject_supplier_kyc, suspend_supplier, activate_supplier → *add response_model for type safety and docs*
...
- 🟢 🟡 **HL302** `backend\utils\config.py` — swallowed exception (lines: 362, 401) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟢 🟡 **HL302** `backend\utils\rls_interceptor.py` — swallowed exception (lines: 339, 352, 408) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟢 🟡 **HL302** `backend\routers\supplier\supplier_products.py` — swallowed exception (lines: 243) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟢 🟡 **HL302** `backend\routers\security\effective_permissions.py` — swallowed exception (lines: 153, 169, 180, 196, 212) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟢 🟡 **HL302** `backend\routers\admin\admin_treasury.py` — swallowed exception (lines: 1003) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟢 🟡 **HL302** `backend\routers\admin\command_center_api.py` — swallowed exception (lines: 57, 65, 177, 247, 503, 545 +1 more) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟢 🟡 **HL302** `backend\middleware\impossible_travel_middleware.py` — swallowed exception (lines: 111, 124, 136, 144, 151, 167) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟢 🟡 **HL302** `backend\db\database.py` — swallowed exception (lines: 168, 196, 214) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟢 🟡 **HL302** `backend\controllers\supplier\supplier_controller.py` — swallowed exception (lines: 808, 3315, 509, 1706, 2675, 3878 +7 more) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟢 🟡 **HL302** `backend\controllers\commerce\promotion_controller.py` — swallowed exception (lines: 237) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟢 🟡 **HL204** `backend\controllers\security\auth_controller.py` — possible secret in log (lines: 788, 1712) → *never log secrets; log only IDs/status*
...
- 🟢 🟡 **HL110** `backend/` — 2446 public functions missing docstrings across 300 files → *By layer: routers/ (1097), services/ (852), controllers/ (407), providers/ (90). Top files: automation_scheduler.py, bank_transaction_service.py, cash_management_service.py, cash_management_write_service.py, gateway_reconciliation_service.py +295 more. Add docstrings to service layer first.*
...
- 🟢 🟡 **HL801** `backend\services\commerce\promotion_engine_service.py` — function(s) need timing/metrics: calculate_order_tier_discount (calls=32) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟢 🟡 **HL801** `backend\controllers\commerce\promotion_controller.py` — function(s) need timing/metrics: _serialize_config (calls=45), update_promotion_config (calls=32), create_promotion_tier (calls=28), update_promotion_tier (calls=43) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟠 🟡 **OB101** `backend/controllers/` — 53 modules missing structured logger → *Add logger = logging.getLogger(__name__). Top: admin_controller.py, compliance_controller.py, expense_controller.py, mobile_controller.py, __init__.py +48 more*
...
- 🟠 🟡 **OB101** `backend/services/` — 91 modules missing structured logger → *Add logger = logging.getLogger(__name__). Top: __init__.py, badge_billing_service.py, bank_transaction_service.py, cash_management_write_service.py, treasury_service.py +86 more*
- 🟠 🟡 **OB102** `backend/controllers/` — 71 modules missing request_id / correlation_id → *Add X-Request-ID middleware in main.py (fixes all 71 at once). Top: admin_controller.py, ai_controller.py, compliance_controller.py, expense_controller.py, export_controller.py +66 more*
...
- 🟡 🟡 **MR101** `backend\controllers\supplier\supplier_controller.py` — nested list comprehension: get_supplier_orders:941 → *use generator expression for large datasets*
