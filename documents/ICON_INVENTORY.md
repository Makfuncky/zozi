# ZOZI Icon & Symbol Inventory → See DESIGN_SYSTEM.md

**This document has been consolidated.**

All icon catalogs, references, web app Lucide icons (139 total), mobile app Ionicons (68 total), and Feather icons (10 total) are now documented in the canonical [DESIGN_SYSTEM.md](DESIGN_SYSTEM.md).

## Quick Reference

- **Web App:** 139 unique Lucide icons from `frontend/web_app/src/lib/icons.ts`
- **Mobile (Ionicons):** 68 unique icons from `frontend/mobile_app/lib/icons.ts`
- **Mobile (Feather):** 10 unique icons from `frontend/mobile_app/lib/icons.ts`

For the complete icon catalog with usage by page and component, see [DESIGN_SYSTEM.md](DESIGN_SYSTEM.md).
