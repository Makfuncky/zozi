  ...
  return (
    <View style={{ marginHorizontal: theme.spacing.md }}>
      {/* ── Compact Mobile Banner Card ──
        ...
        >
          <Text style={{ color: banner.btn_text_color ?? "#1e293b", fontSize: 13, fontWeight: "800" }}>{ctaLabel}</Text>
          <Feather name={isRtl ? "chevron-left" : "chevron-right"} size={14} color={banner.btn_text_color ?? "#1e293b"} />
        </TouchableOpacity>
