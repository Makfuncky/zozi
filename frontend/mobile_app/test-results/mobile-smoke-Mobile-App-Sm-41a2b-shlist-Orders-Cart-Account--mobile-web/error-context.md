...
- Name: mobile-smoke.spec.ts >> Mobile App Smoke Tests >> bottom tab bar has exactly 5 tabs (Shop/Wishlist/Orders/Cart/Account)
- Location: e2e\mobile-smoke.spec.ts:44:7
