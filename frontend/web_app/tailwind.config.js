...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      /* -- Border Radius (DS09 — mirrors --zozi-radius-* tokens) ----- */
      borderRadius: {
        sm: "0.375rem",
        md: "0.5rem",
        lg: "0.75rem",
      ...
      transitionDuration: {
        ...
        350: "350ms",
        400: "400ms",
        120: "var(--zozi-duration-fast)",
        180: "var(--zozi-duration-base)",
        200: "var(--zozi-duration-normal)",
        300: "var(--zozi-duration-slow)",
        500: "var(--zozi-duration-slower)",
        700: "var(--zozi-duration-slowest)",
      },
