...
module.exports = {
  ...
  safelist: [
    ...
    "border-primary/10", "border-primary/20", "border-primary/40", "border-primary/5",
    "border-current/20",
    ...
    "text-primary/10", "text-primary/20", "text-primary/40", "text-primary/5",
    ...
    "to-primary/10", "to-primary/20", "to-primary/40", "to-primary/5",
