...
export default function LogisticsPartnerError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="max-w-md rounded-2xl border border-danger/40 bg-danger/10 p-6 text-center">
        <h2 className="text-lg font-bold text-danger">Logistics panel crashed</h2>
