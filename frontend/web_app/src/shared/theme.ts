...
export const gradients = {
  ...
  bannerLuxe: ["#e6ffed", "#d4f7c7", "#fef3c7"],
  bannerFestive: ["#efffe0", "#f0fdf0", "#fffbeb"],
  bannerNocturne: ["#111111", "#1a1a1a", "#222"],
  bannerRoyal: ["#123d28", "#2f7b42", "#ffd700"],
  bannerCoral: ["#fffbeb", "#fff0d1", "#ffd700"],
...
// ── Border radius (DS09 — keep ≤5 distinct values) ───────────────────────────
export const radius = {
  sm: 4,
  md: 8,
  lg: 12,
...
// ── Elevation / shadow (DS11 — keep ≤4 distinct values) ───────────────────────
// Expressed as rgba so they read correctly on dark surfaces.
export const elevation = {
  sm: "0 1px 2px rgb(0 0 0 / 0.08)",
  md: "0 4px 10px rgb(0 0 0 / 0.10)",
  lg: "0 12px 28px rgb(0 0 0 / 0.14)",
  xl: "0 24px 48px rgb(0 0 0 / 0.18)",
} as const;

// ── Motion duration (DS16 — keep ≤6 distinct values) ─────────────────────────
...
export function applyCssTheme(theme: ColorTheme) {
  ...
  root.style.setProperty("--color-on-warning", colors.onWarning ?? "#1a1a1a");
