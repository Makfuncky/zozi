...
export const SUPPLIER_NAV_ITEMS: PanelNavItem[] = [
  ...
  },
  {
    ...
    group: "operations",
    name: "BG Compare",
    href: "/supplier/upload/bg-compare",
    desc: "Compare all 6 bg removal strategies side by side with RGBA diff overlays",
    icon: Split,
    hideFromNav: true,
  },
  {
    ...
    group: "operations",
    name: "Batch Upload",
    href: "/supplier/batch-upload",
    desc: "AI-powered bulk upload — analyze, review, and publish 20 products in minutes",
    icon: Upload,
  },
  {
    key: "bulk",
