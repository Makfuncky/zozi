...
- Name: phase3-regression-employee-supplier-logistics.spec.ts >> Phase 3 — Logistics-partner Regression >> tickets/[id] loads (customer-side)
- Location: e2e\phase3-regression-employee-supplier-logistics.spec.ts:337:7
