...
- Name: phase3-regression-admin-customer.spec.ts >> Admin Regression (Phase 2A + 2B) >> admin/command-center WebSocket connects
- Location: e2e\phase3-regression-admin-customer.spec.ts:98:9
