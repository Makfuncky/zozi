...
- Name: phase3-regression-admin-customer.spec.ts >> Customer Regression (Phase 2C + 2D) >> checkout loads with corrected endpoints
- Location: e2e\phase3-regression-admin-customer.spec.ts:155:9
