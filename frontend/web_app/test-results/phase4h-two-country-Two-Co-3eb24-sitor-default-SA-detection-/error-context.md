...
- Name: phase4h-two-country.spec.ts >> Two-Country (KSA + UAE) Smoke >> home page renders for KSA visitor (default SA detection)
- Location: e2e\phase4h-two-country.spec.ts:66:7
