...
- Name: phase4h-architecture.spec.ts >> Architecture smoke >> no 5xx on any page in the 146-page sample
- Location: e2e\phase4h-architecture.spec.ts:60:7

# Error details

```
Error: no 5xx on /api/* or /auth/* rewrites
...
- generic:
  - generic [active]:
    - generic [ref=f31e3]:
      - generic [ref=f31e4]:
        - navigation [ref=f31e6]:
          - button [disabled] [ref=f31e7]:
            - img "previous" [ref=f31e8]
          - generic [ref=f31e10]:
            - generic [ref=f31e11]: 1/
            - generic [ref=f31e12]: "1"
          - button [disabled] [ref=f31e13]:
            - img "next" [ref=f31e14]
        - generic [ref=f31e17]:
          - generic "Latest available version is detected (16.3.4)." [ref=f31e20]: Next.js 16.3.4
          - generic [ref=f31e21]: Turbopack
      - dialog "Build Error" [ref=f31e23]:
        - generic [ref=f31e26]:
          - generic [ref=f31e28]:
            - generic [ref=f31e29]:
              - generic [ref=f31e30]: Build Error
              - generic [ref=f31e32]:
                - button "Copy Error Info" [ref=f31e33] [cursor=pointer]
                - link "Go to related documentation" [ref=f31e36] [cursor=pointer]:
                  - /url: https://nextjs.org/docs/messages/module-not-found
                - button "Attach Node.js inspector" [ref=f31e39] [cursor=pointer]
            - generic [ref=f31e48]: "Module not found: Can't resolve '@shared/adminPermissions'"
          - generic [ref=f31e51]:
            - generic [ref=f31e53]:
              - generic [ref=f31e58]: ./src/lib/useAuth.tsx (18:1)
              - button "Open in editor" [ref=f31e59] [cursor=pointer]
            - generic [ref=f31e64]:
              - generic [ref=f31e65]: "Error: Module not found: Can't resolve '@shared/adminPermissions'"
              - generic [ref=f31e66]: 16 |
              - text: import type
              - generic [ref=f31e67]: "{"
              - text: Locale
              - generic [ref=f31e68]: "}"
              - text: from "@/lib/i18n"
              - generic [ref=f31e69]: ;
              - generic [ref=f31e70]: 17 |
              - text: import
              - generic [ref=f31e71]: "{ normalizeLocale }"
              - text: from "@shared/localization"
              - generic [ref=f31e72]: ;
              - text: ">"
              - generic [ref=f31e73]: 18 |
              - text: import
              - generic [ref=f31e74]: "{"
              - generic [ref=f31e75]: "|"
              - text: ^^^^^^^ >
              - generic [ref=f31e76]: 19 |
              - generic [ref=f31e77]: clearAdminPermissionOverrides,
              - generic [ref=f31e78]: "|"
              - text: ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ >
              - generic [ref=f31e79]: 20 |
              - generic [ref=f31e80]: isAdminStaffRole,
              - generic [ref=f31e81]: "|"
              - text: ^^^^^^^^^^^^^^^^^^^ >
              - generic [ref=f31e82]: 21 |
              - generic [ref=f31e83]: setCurrentAdminPermissions,
              - generic [ref=f31e84]: "|"
              - text: ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ >
              - generic [ref=f31e85]: 22 |
              - generic [ref=f31e86]: setAdminPermissionOverrides,
              - generic [ref=f31e87]: "|"
              - text: ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ >
              - generic [ref=f31e88]: 23 |
              - generic [ref=f31e89]: "}"
              - text: from "@shared/adminPermissions"
              - generic [ref=f31e90]: ;
              - generic [ref=f31e91]: "|"
              - text: ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
              - generic [ref=f31e92]: 24 |
              - generic [ref=f31e93]: 25 |
              - generic [ref=f31e94]: /* ---------- Types ------------------------------------------- */
              - generic [ref=f31e95]: 26 |
              ...
              - generic [ref=f31e96]:
                ...
                - link "https://nextjs.org/docs/messages/module-not-found" [ref=f31e97] [cursor=pointer]:
                  - /url: https://nextjs.org/docs/messages/module-not-found
    - button "Open issues overlay" [ref=f31e104] [cursor=pointer]:
      - generic [ref=f31e108]:
        - generic [ref=f31e109]: "0"
        - generic [ref=f31e110]: "1"
      - generic [ref=f31e111]: Issue
  - alert [ref=f31e112]
```
...
```ts
  1   | /**
  2   |  * Phase 4H — Architecture / Cross-Domain Ports Smoke
  3   |  *
  4   |  * 1. Every page in the original 146-page audit scope returns < 500
  5   |  * 2. Backend emits no 500s on health/catalog/health endpoints during the run
