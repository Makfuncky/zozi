...
- Name: phase3-regression-admin-customer.spec.ts >> Admin Regression (Phase 2A + 2B) >> admin/command-center/headlines loads
- Location: e2e\phase3-regression-admin-customer.spec.ts:103:9
