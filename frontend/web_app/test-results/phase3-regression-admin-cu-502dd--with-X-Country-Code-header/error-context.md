...
- Name: phase3-regression-admin-customer.spec.ts >> Customer Regression (Phase 2C + 2D) >> home loads with X-Country-Code header
- Location: e2e\phase3-regression-admin-customer.spec.ts:118:9

# Error details

```
Error: homepage status
