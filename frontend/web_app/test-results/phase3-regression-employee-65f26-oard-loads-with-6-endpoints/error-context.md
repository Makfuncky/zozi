...
- Name: phase3-regression-employee-supplier-logistics.spec.ts >> Phase 3 — Employee Regression >> employee dashboard loads with 6 endpoints
- Location: e2e\phase3-regression-employee-supplier-logistics.spec.ts:64:7

# Error details

```
Error: [phase3-regression] dashboard status
