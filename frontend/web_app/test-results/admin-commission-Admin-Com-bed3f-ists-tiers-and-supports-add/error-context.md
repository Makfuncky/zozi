...
- Name: admin-commission.spec.ts >> Admin Commission Management >> badge tiers tab lists tiers and supports add
- Location: e2e\admin-commission.spec.ts:156:7
...
Call log:
  - waiting for getByRole('tab', { name: /badge tiers/i })
