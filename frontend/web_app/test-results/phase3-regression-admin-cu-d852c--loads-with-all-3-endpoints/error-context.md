...
- Name: phase3-regression-admin-customer.spec.ts >> Customer Regression (Phase 2C + 2D) >> profile loads with all 3 endpoints
- Location: e2e\phase3-regression-admin-customer.spec.ts:160:9

# Error details

```
Error: customer session bootstrap
