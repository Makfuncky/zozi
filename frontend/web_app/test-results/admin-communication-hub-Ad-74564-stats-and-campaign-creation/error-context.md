...
- Name: admin-communication-hub.spec.ts >> Admin Communication Hub >> Email panel: overview stats and campaign creation
- Location: e2e\admin-communication-hub.spec.ts:233:7
...
Call log:
  - waiting for getByRole('tab', { name: /email/i })
