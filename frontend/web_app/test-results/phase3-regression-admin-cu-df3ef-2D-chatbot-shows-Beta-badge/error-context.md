...
- Name: phase3-regression-admin-customer.spec.ts >> Customer Regression (Phase 2C + 2D) >> chatbot shows Beta badge
- Location: e2e\phase3-regression-admin-customer.spec.ts:197:9
