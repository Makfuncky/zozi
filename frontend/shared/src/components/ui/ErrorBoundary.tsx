...
export default class ErrorBoundary extends Component<ErrorBoundaryProps, State> {
  ...
  render() {
    if (this.state.hasError) {
      ...
      return (
        <div style={{ padding: 24, maxWidth: 720, margin: "48px auto", border: "1px solid #fecaca", borderRadius: 20, background: "#f8fafc", color: "#7f1d1d", fontFamily: "system-ui, sans-serif" }}>
