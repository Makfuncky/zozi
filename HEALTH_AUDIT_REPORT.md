...
| 🟢 P3 (fix when convenient) | 686 | Hygiene / style |

### Quick Wins (< 1 hour each)

- **SEC101** (1 files): raw SQL string concatenation (injection risk)
- **HL403** (1 files): sync file/OS I/O inside async function
- **OB102** (3 files): missing request_id / correlation_id
- **SEC105** (5 files): hardcoded credential/secret in source
- **OB101** (5 files): module missing structured logger
...
| # | File | Weight | Issues |
|---|---|---:|---|
| 1 | `backend\controllers\finance\payments_controller.py` | 19 | HL101, HL102, HL204, HL302, HL601, HL602, HL801, MR104 |
| 2 | `backend\routers\supplier\supplier_bg_ab_test.py` | 18 | API101, HL102, HL303, HL501, HL801, MR104, PG103 |
| 3 | `backend\routers\admin\command_center_api.py` | 18 | API101, HL101, HL102, HL302, HL801, PG102, SC101 |
| 4 | `backend\services\finance_transfer_service.py` | 16 | HL101, HL102, HL302, HL601, HL602, HL801 |
| 5 | `backend\services\finance\finance_transfer_service.py` | 16 | HL101, HL102, HL302, HL601, HL602, HL801 |
| 6 | `backend\routers\supplier\supplier_orders.py` | 16 | API101, HL102, HL302, HL801, PG103, SC101 |
| 7 | `backend\routers\internal\hr_dashboard.py` | 16 | API101, HL102, HL303, HL801, PG102, SC101 |
| 8 | `backend\routers\admin\command_center.py` | 16 | API101, HL102, HL302, HL801, PG102, SC101 |
| 9 | `backend\middleware\country_context.py` | 15 | HL204, HL302, HL601, HL602, HL801, MR104 |
| 10 | `backend\services\country\country_ai_research.py` | 14 | HL302, HL601, HL602, HL801, MR104 |
| 11 | `backend\routers\media\ai_upload.py` | 14 | API101, HL303, HL801, PG103, SC101 |
| 12 | `backend\controllers\orders\returns_controller.py` | 14 | HL102, HL302, HL601, HL602, HL801 |
| 13 | `backend\utils\email_service.py` | 13 | HL102, HL303, HL601, HL602 |
| 14 | `backend\services\ai\ai_service.py` | 13 | HL101, HL102, HL302, HL501, HL801, MR104 |
| 15 | `backend\routers\supplier\supplier.py` | 13 | API101, HL101, HL102, HL302, HL801, PG103 |
| 16 | `backend\routers\country\country_maps.py` | 13 | API101, HL801, PG103, SC101 |
| 17 | `backend\routers\admin\admin_treasury.py` | 13 | API101, HL101, HL102, HL302, HL801, SC101 |
| 18 | `backend\services\country\country_detection.py` | 12 | HL302, HL601, HL602, HL801 |
| 19 | `backend\routers\security\fraud_detection.py` | 12 | API101, PG103, SC101 |
| 20 | `backend\routers\admin\country_communications.py` | 12 | API101, PG102, SC101 |
...
|---|---:|---|---|---|
| API101 | 130 | 🟡 P2 | 🟡 ADVISORY | endpoint missing response_model |
...
| FEH301 | 12 | 🟡 P2 | 🟡 ADVISORY | missing React error boundary |
...
| HL101 | 35 | 🟡 P2 | 🟡 ADVISORY | oversized Python file |
| HL102 | 104 | 🟡 P2 | 🟡 ADVISORY | oversized Python function |
| HL110 | 1 | 🟢 P3 | 🟡 ADVISORY | missing docstring on public service/controller function |
| HL201 | 17 | 🟢 P3 | 🟡 ADVISORY | print() used instead of structured logging |
| HL203 | 13 | 🟢 P3 | 🟡 ADVISORY | logging.basicConfig() should be configured centrally |
| HL204 | 8 | 🟢 P3 | 🟡 ADVISORY | possible secret/token value in log/print statement |
| HL301 | 3 | 🟢 P3 | 🟡 ADVISORY | bare except hides failures |
| HL302 | 120 | 🟢 P3 | 🟡 ADVISORY | swallowed exception (except + pass / no logging) |
| HL303 | 87 | 🟢 P3 | 🟡 ADVISORY | broad except Exception should be narrowed or logged |
| HL403 | 1 | 🟠 P1 | 🟡 ADVISORY | sync file/OS I/O inside async function |
| HL501 | 18 | 🟠 P1 | 🟡 ADVISORY | heavy top-level import in web path (lazy-load recommended) |
| HL502 | 16 | 🟡 P2 | 🟡 ADVISORY | star import (from x import *) pollutes namespace |
| HL601 | 15 | 🟠 P1 | 🟡 ADVISORY | sequential external calls (concurrency opportunity) |
| HL602 | 18 | 🟠 P1 | 🟡 ADVISORY | missing timeout on external call |
| HL801 | 157 | 🟢 P3 | 🟡 ADVISORY |  |
| HL902 | 1 | 🟢 P3 | 🟡 ADVISORY |  |
| MR101 | 3 | 🟡 P2 | 🟡 ADVISORY | nested list comprehension (use generator) |
| MR104 | 22 | 🟡 P2 | 🟡 ADVISORY | global mutable state (breaks scaling) |
| OB101 | 5 | 🟠 P1 | 🟡 ADVISORY | module missing structured logger |
| OB102 | 3 | 🟠 P1 | 🟡 ADVISORY | missing request_id / correlation_id |
| PG102 | 10 | 🟠 P1 | 🟡 ADVISORY | WebSocket in Python (consider Node.js gateway) |
| PG103 | 9 | 🟠 P1 | 🟡 ADVISORY | CPU-bound work in request path (offload to worker) |
...
| SC101 | 46 | 🟠 P1 | 🟡 ADVISORY | list endpoint missing pagination |
| SEC101 | 1 | 🔴 P0 | 🔴 VIOLATION | raw SQL string concatenation (injection risk) |
| SEC105 | 5 | 🔴 P0 | 🔴 VIOLATION | hardcoded credential/secret in source |

## 🔥 Health Hotlist (P0 + P1 only)

| Pri | Sev | Rule | Domain | Location | Problem | Suggestion |
|---|---|---|---|---|---|---|
| 🔴 P0 | 🔴 | SEC101 | security | `backend\utils\error_handler.py` | raw SQL concatenation (lines: 149) | use parameterized queries / SQLAlchemy ORM |
| 🔴 P0 | 🔴 | SEC105 | security | `backend\tests\test_auth.py` | hardcoded credential (lines: 14, 34) | move to env vars / Vault / secrets manager |
| 🔴 P0 | 🔴 | SEC105 | security | `backend\tests\test_security.py` | hardcoded credential (lines: 24) | move to env vars / Vault / secrets manager |
| 🔴 P0 | 🔴 | SEC105 | security | `scripts\testing\ai_image_group_smoke.py` | hardcoded credential (lines: 472) | move to env vars / Vault / secrets manager |
| 🔴 P0 | 🔴 | SEC105 | security | `scripts\testing\finance_cycle_smoke.py` | hardcoded credential (lines: 105, 265) | move to env vars / Vault / secrets manager |
| 🔴 P0 | 🔴 | SEC105 | security | `scripts\testing\live_order_tracking_smoke.py` | hardcoded credential (lines: 200) | move to env vars / Vault / secrets manager |
...
| 🟠 P1 | 🟡 | HL501 | performance | `backend\services\bg_removal_presets.py` | heavy top-level import(s): PIL, numpy | lazy-import inside the function/job that needs them |
| 🟠 P1 | 🟡 | HL501 | performance | `backend\services\dei_auditor.py` | heavy top-level import(s): numpy | lazy-import inside the function/job that needs them |
| 🟠 P1 | 🟡 | HL501 | performance | `backend\services\supplier\onboarding_pipeline.py` | heavy top-level import(s): PIL | lazy-import inside the function/job that needs them |
| 🟠 P1 | 🟡 | HL501 | performance | `backend\services\media\free_image_tools.py` | heavy top-level import(s): PIL, numpy | lazy-import inside the function/job that needs them |
| 🟠 P1 | 🟡 | HL501 | performance | `backend\services\media\image_ai_service.py` | heavy top-level import(s): PIL | lazy-import inside the function/job that needs them |
| 🟠 P1 | 🟡 | HL501 | performance | `backend\services\ai\ai_service.py` | heavy top-level import(s): PIL | lazy-import inside the function/job that needs them |
| 🟠 P1 | 🟡 | HL501 | performance | `backend\services\ai\bg_removal_service.py` | heavy top-level import(s): PIL, numpy | lazy-import inside the function/job that needs them |
| 🟠 P1 | 🟡 | HL501 | performance | `backend\routers\supplier\supplier_bg_ab_test.py` | heavy top-level import(s): PIL, numpy | lazy-import inside the function/job that needs them |
| 🟠 P1 | 🟡 | HL501 | performance | `backend\providers\media\image.py` | heavy top-level import(s): PIL, numpy | lazy-import inside the function/job that needs them |
| 🟠 P1 | 🟡 | HL501 | performance | `backend\providers\legacy\br_05.py` | heavy top-level import(s): PIL, numpy | lazy-import inside the function/job that needs them |
| 🟠 P1 | 🟡 | HL501 | performance | `backend\providers\legacy\br_06.py` | heavy top-level import(s): PIL, numpy | lazy-import inside the function/job that needs them |
| 🟠 P1 | 🟡 | HL501 | performance | `backend\providers\legacy\br_08.py` | heavy top-level import(s): PIL, numpy | lazy-import inside the function/job that needs them |
| 🟠 P1 | 🟡 | HL501 | performance | `backend\providers\legacy\br_11.py` | heavy top-level import(s): PIL, cv2, numpy | lazy-import inside the function/job that needs them |
| 🟠 P1 | 🟡 | HL501 | performance | `backend\providers\legacy\br_12.py` | heavy top-level import(s): PIL, cv2, numpy | lazy-import inside the function/job that needs them |
| 🟠 P1 | 🟡 | HL501 | performance | `backend\providers\legacy\br_13.py` | heavy top-level import(s): PIL, cv2, numpy | lazy-import inside the function/job that needs them |
| 🟠 P1 | 🟡 | HL501 | performance | `backend\providers\hr\bg_remover.py` | heavy top-level import(s): PIL, numpy | lazy-import inside the function/job that needs them |
...
| 🟠 P1 | 🟡 | HL501 | performance | `backend\providers\ai\ocr.py` | heavy top-level import(s): PIL, numpy | lazy-import inside the function/job that needs them |
...
| 🟠 P1 | 🟡 | HL601 | concurrency | `backend\services\finance_transfer_service.py` | sequential external calls: execute_transfer_batch (3 calls) | use asyncio.gather or ThreadPoolExecutor; add timeout + retry |
...
| 🟠 P1 | 🟡 | HL601 | concurrency | `backend\controllers\finance\payments_controller.py` | sequential external calls: test_payment_gateway_connection (4 calls), create_payment_intent (2 calls), confirm_card_payment (2 calls) | use asyncio.gather or ThreadPoolExecutor; add timeout + retry |
...
| 🟠 P1 | 🟡 | HL602 | concurrency | `backend\services\finance_transfer_service.py` | external call(s) missing timeout: execute_transfer_batch:1016, execute_transfer_batch:996, execute_transfer_batch:1000 | always set timeout; add retry + circuit breaker |
...
| 🟠 P1 | 🟡 | HL602 | concurrency | `backend\providers\logistics\geo.py` | external call(s) missing timeout: _lookup_ipapi:108 | always set timeout; add retry + circuit breaker |
| 🟠 P1 | 🟡 | HL602 | concurrency | `backend\providers\logistics\map.py` | external call(s) missing timeout: resolve_ip:39, reverse_geocode:85 | always set timeout; add retry + circuit breaker |
| 🟠 P1 | 🟡 | HL602 | concurrency | `backend\providers\ai\text.py` | external call(s) missing timeout: _ollama_chat:65, _ollama_vision_chat:104, transcribe_audio:142, embed_text:187 | always set timeout; add retry + circuit breaker |
| 🟠 P1 | 🟡 | HL602 | concurrency | `backend\providers\ai\voice_to_text.py` | external call(s) missing timeout: transcribe_audio:58 | always set timeout; add retry + circuit breaker |
| 🟠 P1 | 🟡 | HL602 | concurrency | `backend\middleware\country_context.py` | external call(s) missing timeout: _lookup_country_from_ip:374 | always set timeout; add retry + circuit breaker |
| 🟠 P1 | 🟡 | HL602 | concurrency | `backend\jobs\threat_feed_updater.py` | external call(s) missing timeout: fetch_ip_list:29, update_threat_feeds:48 | always set timeout; add retry + circuit breaker |
...
| 🟠 P1 | 🟡 | HL602 | concurrency | `backend\controllers\finance\payments_controller.py` | external call(s) missing timeout: test_payment_gateway_connection:1545, create_payment_intent:2299, create_payment_intent:2245, create_stripe_checkout_session:2349, confirm_card_payment:2445, confirm_card_payment:2421 | always set timeout; add retry + circuit breaker |
...
| 🟠 P1 | 🟡 | OB101 | observability | `backend/controllers/` | 62 modules missing structured logger | Add logger = logging.getLogger(__name__). Top: address_controller.py, admin_controller.py, audit_controller.py, categories_controller.py, compliance_controller.py +57 more |
| 🟠 P1 | 🟡 | OB101 | observability | `backend/middleware/` | 5 modules missing structured logger | Add logger = logging.getLogger(__name__). Top: coi_middleware.py, ip_extraction_middleware.py, rls.py, rls_dependency.py, __init__.py |
| 🟠 P1 | 🟡 | OB101 | observability | `backend/providers/` | 5 modules missing structured logger | Add logger = logging.getLogger(__name__). Top: __init__.py, check_BiRefNet.py, __init__.py, config.py, __init__.py |
| 🟠 P1 | 🟡 | OB101 | observability | `backend/routers/` | 106 modules missing structured logger | Add logger = logging.getLogger(__name__). Top: __init__.py, commission.py, countries.py, finance.py, onboarding.py +101 more |
| 🟠 P1 | 🟡 | OB101 | observability | `backend/services/` | 117 modules missing structured logger | Add logger = logging.getLogger(__name__). Top: admin_analytics_service.py, audit_service.py, auth_write_service.py, bank_transaction_service.py, banner_write_service.py +112 more |
| 🟠 P1 | 🟡 | OB102 | observability | `backend/controllers/` | 82 modules missing request_id / correlation_id | Add X-Request-ID middleware in main.py (fixes all 82 at once). Top: address_controller.py, admin_controller.py, ai_controller.py, audit_controller.py, categories_controller.py +77 more |
| 🟠 P1 | 🟡 | OB102 | observability | `backend/middleware/` | 14 modules missing request_id / correlation_id | Add X-Request-ID middleware in main.py (fixes all 14 at once). Top: behavioral_analytics.py, coi_middleware.py, country_context.py, csrf_middleware.py, database_security.py +9 more |
| 🟠 P1 | 🟡 | OB102 | observability | `backend/routers/` | 148 modules missing request_id / correlation_id | Add X-Request-ID middleware in main.py (fixes all 148 at once). Top: __init__.py, payout_approval.py, commission.py, countries.py, finance.py +143 more |
...
| 🟠 P1 | 🟡 | PG102 | polyglot | `backend\utils\realtime.py` | WebSocket handler in Python: connect_order, connect_user, connect_partner | Python for business logic; Node.js gateway for high-throughput real-time |
...
| 🟠 P1 | 🟡 | PG102 | polyglot | `backend\routers\communication\ws_chat.py` | WebSocket handler in Python: websocket_chat, websocket_user, connect | Python for business logic; Node.js gateway for high-throughput real-time |
| 🟠 P1 | 🟡 | PG102 | polyglot | `backend\routers\admin\command_center.py` | WebSocket handler in Python: connect, websocket_endpoint | Python for business logic; Node.js gateway for high-throughput real-time |
| 🟠 P1 | 🟡 | PG102 | polyglot | `backend\routers\admin\command_center_api.py` | WebSocket handler in Python: connect, websocket_endpoint | Python for business logic; Node.js gateway for high-throughput real-time |
| 🟠 P1 | 🟡 | PG102 | polyglot | `backend\routers\admin\country_communications.py` | WebSocket handler in Python: websocket_country_notifications, websocket_country_communications | Python for business logic; Node.js gateway for high-throughput real-time |
...
| 🟠 P1 | 🟡 | PG103 | polyglot | `backend\routers\country\country_maps.py` | CPU-bound in request path: get_country_map | offload to worker (Celery/arq) or Node.js worker thread |
...
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\supplier\countries.py` | list endpoint(s) missing pagination: list_country_commission_rates | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\supplier\finance.py` | list endpoint(s) missing pagination: get_ledger, get_vat_liability, get_payout_batches, get_cash_position, supplier_earnings_report | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\supplier\supplier_documents.py` | list endpoint(s) missing pagination: list_my_documents, list_all_documents | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\supplier\supplier_finance.py` | list endpoint(s) missing pagination: get_supplier_payout_summary | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\supplier\supplier_health.py` | list endpoint(s) missing pagination: list_supplier_health | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\supplier\supplier_orders.py` | list endpoint(s) missing pagination: list_supplier_orders, get_supplier_label | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\supplier\supplier_payouts.py` | list endpoint(s) missing pagination: list_payouts | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\security\fraud_detection.py` | list endpoint(s) missing pagination: list_blacklist, list_rules, list_review_queue | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\orders\cart.py` | list endpoint(s) missing pagination: get_cart | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\orders\logistics_orders_v2.py` | list endpoint(s) missing pagination: list_my_pickups | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\media\ai_upload.py` | list endpoint(s) missing pagination: get_ai_upload_job | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\logistics\logistics_health.py` | list endpoint(s) missing pagination: list_logistics_health | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\logistics\logistics_locations.py` | list endpoint(s) missing pagination: list_logistics_partner_locations | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\internal\email.py` | list endpoint(s) missing pagination: list_templates, list_campaigns, list_suppressions | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\internal\finance_automation.py` | list endpoint(s) missing pagination: list_rules, statement_lines, list_assets, list_accruals | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\internal\flash_sales.py` | list endpoint(s) missing pagination: list_flash_sales | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\internal\geo.py` | list endpoint(s) missing pagination: list_geo_countries | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\internal\hr_dashboard.py` | list endpoint(s) missing pagination: get_hr_dashboard | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\internal\logistics_orders.py` | list endpoint(s) missing pagination: list_assigned_shipments | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\internal\shop_locations.py` | list endpoint(s) missing pagination: list_shop_locations | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\hr\ess.py` | list endpoint(s) missing pagination: ess_leave_balance, ess_leave_history, ess_payslips, ess_attendance, ess_okrs, ess_org_chart | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\hr\hr.py` | list endpoint(s) missing pagination: list_alumni | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\hr\payroll.py` | list endpoint(s) missing pagination: get_employee_payslips | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\hr\performance.py` | list endpoint(s) missing pagination: coi_check_endpoint | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\finance\finance_erp.py` | list endpoint(s) missing pagination: reconciliation_view, list_budgets | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\external\email_controller.py` | list endpoint(s) missing pagination: list_folders | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\country\country_dropdown.py` | list endpoint(s) missing pagination: get_countries_dropdown, get_categories_dropdown | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\country\country_maps.py` | list endpoint(s) missing pagination: get_country_map | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\country\country_staff.py` | list endpoint(s) missing pagination: list_country_staff, get_my_assigned_countries | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\country\hierarchy.py` | list endpoint(s) missing pagination: list_org_units, user_country_scope, country_localization | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\communication\email_router.py` | list endpoint(s) missing pagination: list_folders | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\communication\push_notifications.py` | list endpoint(s) missing pagination: list_push_tokens | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\communication\tickets.py` | list endpoint(s) missing pagination: get_ticket | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\admin\admin_cash.py` | list endpoint(s) missing pagination: list_accounts | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\admin\admin_fallback.py` | list endpoint(s) missing pagination: admin_logistics_fallback, admin_logistics_partners_fallback, admin_treasury_metrics_fallback | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\admin\admin_promotions.py` | list endpoint(s) missing pagination: list_coupons, list_flash_sales, list_coupons_by_country, list_flash_sales_by_country | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\admin\admin_suppliers.py` | list endpoint(s) missing pagination: list_suppliers_global | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\admin\admin_treasury.py` | list endpoint(s) missing pagination: admin_cash_position, country_cash_position, admin_supplier_earnings, country_supplier_earnings, payroll_equity, country_payroll | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\admin\command_center.py` | list endpoint(s) missing pagination: get_system_metrics | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\admin\command_center_api.py` | list endpoint(s) missing pagination: get_system_metrics | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\admin\country_admin.py` | list endpoint(s) missing pagination: list_staff, list_tax_rates | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\admin\country_communications.py` | list endpoint(s) missing pagination: list_legal_contracts, list_warehouses, list_partner_locations | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\admin\country_payouts.py` | list endpoint(s) missing pagination: list_payout_rule_categories, list_payout_rule_products | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\admin\cross_border.py` | list endpoint(s) missing pagination: get_cross_border_session | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\admin\employees.py` | list endpoint(s) missing pagination: list_employee_addresses, list_employee_dependents, list_leave_requests, list_shifts | add skip/limit or cursor pagination |
| 🟠 P1 | 🟡 | SC101 | scaling | `backend\routers\admin\proxy_communication.py` | list endpoint(s) missing pagination: get_user_channels, admin_list_channels | add skip/limit or cursor pagination |
...
- 🟡 **FEH101** `frontend\web_app\src\components\BannerCanvasEditor.tsx` — oversized frontend file (1792 lines) → *split into smaller components/hooks/features*
...
- 🟡 🟡 **HL101** `backend\services\finance_transfer_service.py` — oversized Python file (1159 lines) → *split by responsibility/domain*
...
- 🟡 🟡 **HL101** `backend\services\general_ledger_service.py` — oversized Python file (1090 lines) → *split by responsibility/domain*
...
- 🟡 🟡 **HL101** `backend\services\logistics_partner_pricing.py` — oversized Python file (1083 lines) → *split by responsibility/domain*
...
- 🟡 🟡 **HL102** `backend\services\supplier_badge_service.py` — oversized function(s): purchase_supplier_badge (91L) → *extract smaller functions*
- 🟡 🟡 **HL102** `backend\services\trading_service.py` — oversized function(s): auto_invoice_ecommerce_orders (100L) → *extract smaller functions*
- 🟡 🟡 **HL102** `backend\services\treasury_engine.py` — oversized function(s): post_journal_entry (115L) → *extract smaller functions*
- 🟡 🟡 **HL102** `backend\services\treasury\automation_scheduler.py` — oversized function(s): run_full_automation (111L) → *extract smaller functions*
...
- 🟡 🟡 **HL101** `backend\services\treasury\cash_management_service.py` — oversized Python file (2264 lines) → *split by responsibility/domain*
- 🟡 🟡 **HL102** `backend\services\treasury\cash_management_service.py` — oversized function(s): _build_order_logistics_allocations (128L), apply_shipment_vehicle_selection (112L), create_ledger_entries_for_order (167L), create_settlements_on_delivery (98L), _infer_transaction_links (82L) → *extract smaller functions*
...
- 🟡 🟡 **HL101** `backend\services\media\free_image_tools.py` — oversized Python file (967 lines) → *split by responsibility/domain*
- 🟡 🟡 **HL102** `backend\services\media\free_image_tools.py` — oversized function(s): auto_process_image (82L) → *extract smaller functions*
- 🟡 🟡 **HL101** `backend\services\logistics\logistics_partner_pricing.py` — oversized Python file (1083 lines) → *split by responsibility/domain*
...
- 🟡 🟡 **HL101** `backend\services\finance\cash_management_service.py` — oversized Python file (2248 lines) → *split by responsibility/domain*
- 🟡 🟡 **HL102** `backend\services\finance\cash_management_service.py` — oversized function(s): _build_order_logistics_allocations (128L), apply_shipment_vehicle_selection (112L), create_ledger_entries_for_order (167L), create_settlements_on_delivery (98L), _infer_transaction_links (82L) → *extract smaller functions*
...
- 🟡 🟡 **HL102** `backend\services\finance\credit_control_service.py` — oversized function(s): check_customer_credit (108L) → *extract smaller functions*
...
- 🟡 🟡 **HL102** `backend\services\finance\financial_reports_service.py` — oversized function(s): _get_account_balances_for_period (93L), generate_cash_flow_statement (111L) → *extract smaller functions*
...
- 🟡 🟡 **HL102** `backend\services\finance\payout_batch_service.py` — oversized function(s): generate_supplier_payout_batches (81L) → *extract smaller functions*
- 🟡 🟡 **HL102** `backend\services\finance\period_close_service.py` — oversized function(s): _transfer_pnl_to_retained_earnings (114L) → *extract smaller functions*
...
- 🟡 🟡 **HL102** `backend\services\analytics\financial_reports_service.py` — oversized function(s): _get_account_balances_for_period (93L), generate_cash_flow_statement (111L) → *extract smaller functions*
...
- 🟡 🟡 **HL101** `backend\services\ai\ai_service.py` — oversized Python file (1200 lines) → *split by responsibility/domain*
...
- 🟡 🟡 **HL101** `backend\services\ai\bg_removal_service.py` — oversized Python file (1145 lines) → *split by responsibility/domain*
- 🟡 🟡 **HL102** `backend\services\ai\ocr_parser.py` — oversized function(s): parse_bill_text (82L) → *extract smaller functions*
- 🟡 🟡 **HL101** `backend\routers\supplier\countries.py` — oversized Python file (919 lines) → *split by responsibility/domain*
- 🟡 🟡 **HL101** `backend\routers\supplier\supplier.py` — oversized Python file (1392 lines) → *split by responsibility/domain*
...
- 🟡 🟡 **HL102** `backend\routers\supplier\supplier_finance.py` — oversized function(s): get_order_payment_status (102L), list_supplier_orders_with_payout_status (90L) → *extract smaller functions*
- 🟡 🟡 **HL102** `backend\routers\supplier\supplier_orders.py` — oversized function(s): get_supplier_label (95L), verify_parcel_proof (149L) → *extract smaller functions*
...
- 🟡 🟡 **HL102** `backend\routers\internal\hr_dashboard.py` — oversized function(s): get_hr_dashboard (174L) → *extract smaller functions*
- 🟡 🟡 **HL102** `backend\routers\hr\performance.py` — oversized function(s): coi_check_endpoint (81L) → *extract smaller functions*
...
- 🟡 🟡 **HL101** `backend\routers\admin\admin_treasury.py` — oversized Python file (1786 lines) → *split by responsibility/domain*
...
- 🟡 🟡 **HL101** `backend\routers\admin\command_center_api.py` — oversized Python file (908 lines) → *split by responsibility/domain*
...
- 🟡 🟡 **HL502** `backend\models\__init__.py` — star import(s) at lines: 61, 62, 63, 64, 65, 66 +25 more → *use explicit imports*
- 🟡 🟡 **HL101** `backend\models\treasury\finance.py` — oversized Python file (926 lines) → *split by responsibility/domain*
- 🟡 🟡 **HL502** `backend\db\models_country_enhancements.py` — star import(s) at lines: 10 → *use explicit imports*
- 🟡 🟡 **HL101** `backend\db\schemas.py` — oversized Python file (2207 lines) → *split by responsibility/domain*
- 🟡 🟡 **HL502** `backend\controllers\address_controller.py` — star import(s) at lines: 5 → *use explicit imports*
...
- 🟡 🟡 **HL502** `backend\controllers\categories_controller.py` — star import(s) at lines: 5 → *use explicit imports*
- 🟡 🟡 **HL502** `backend\controllers\compliance_controller.py` — star import(s) at lines: 5 → *use explicit imports*
- 🟡 🟡 **HL502** `backend\controllers\expense_controller.py` — star import(s) at lines: 5 → *use explicit imports*
- 🟡 🟡 **HL502** `backend\controllers\financial_controller.py` — star import(s) at lines: 5 → *use explicit imports*
- 🟡 🟡 **HL502** `backend\controllers\mobile_controller.py` — star import(s) at lines: 5 → *use explicit imports*
- 🟡 🟡 **HL502** `backend\controllers\operational_controller.py` — star import(s) at lines: 5 → *use explicit imports*
- 🟡 🟡 **HL101** `backend\controllers\products_controller.py` — oversized Python file (1133 lines) → *split by responsibility/domain*
...
- 🟡 🟡 **HL502** `backend\controllers\reviews_controller.py` — star import(s) at lines: 5 → *use explicit imports*
- 🟡 🟡 **HL502** `backend\controllers\wishlist_controller.py` — star import(s) at lines: 5 → *use explicit imports*
- 🟡 🟡 **HL101** `backend\controllers\treasury\cash_management_controller.py` — oversized Python file (992 lines) → *split by responsibility/domain*
- 🟡 🟡 **HL102** `backend\controllers\treasury\cash_management_controller.py` — oversized function(s): admin_list_ledger_entries (81L) → *extract smaller functions*
...
- 🟡 🟡 **HL502** `backend\controllers\supplier\__init__.py` — star import(s) at lines: 11 → *use explicit imports*
...
- 🟡 🟡 **HL101** `backend\controllers\finance\payments_controller.py` — oversized Python file (4470 lines) → *split by responsibility/domain*
- 🟡 🟡 **HL102** `backend\controllers\finance\payments_controller.py` — oversized function(s): get_payment_methods_status (87L), _built_in_gateway_defaults (214L), _serialize_gateway_connection (108L), test_payment_gateway_connection (90L), _finalize_inventory_for_paid_order (88L), create_payment_intent (101L) → *extract smaller functions*
...
- 🟠 🟡 **HL501** `backend\services\bg_removal_presets.py` — heavy top-level import(s): PIL, numpy → *lazy-import inside the function/job that needs them*
- 🟠 🟡 **HL501** `backend\services\dei_auditor.py` — heavy top-level import(s): numpy → *lazy-import inside the function/job that needs them*
- 🟠 🟡 **HL501** `backend\services\supplier\onboarding_pipeline.py` — heavy top-level import(s): PIL → *lazy-import inside the function/job that needs them*
- 🟠 🟡 **HL501** `backend\services\media\free_image_tools.py` — heavy top-level import(s): PIL, numpy → *lazy-import inside the function/job that needs them*
- 🟠 🟡 **HL501** `backend\services\media\image_ai_service.py` — heavy top-level import(s): PIL → *lazy-import inside the function/job that needs them*
- 🟠 🟡 **HL501** `backend\services\ai\ai_service.py` — heavy top-level import(s): PIL → *lazy-import inside the function/job that needs them*
- 🟠 🟡 **HL501** `backend\services\ai\bg_removal_service.py` — heavy top-level import(s): PIL, numpy → *lazy-import inside the function/job that needs them*
- 🟠 🟡 **HL501** `backend\routers\supplier\supplier_bg_ab_test.py` — heavy top-level import(s): PIL, numpy → *lazy-import inside the function/job that needs them*
- 🟠 🟡 **HL501** `backend\providers\media\image.py` — heavy top-level import(s): PIL, numpy → *lazy-import inside the function/job that needs them*
- 🟠 🟡 **HL501** `backend\providers\legacy\br_05.py` — heavy top-level import(s): PIL, numpy → *lazy-import inside the function/job that needs them*
- 🟠 🟡 **HL501** `backend\providers\legacy\br_06.py` — heavy top-level import(s): PIL, numpy → *lazy-import inside the function/job that needs them*
- 🟠 🟡 **HL501** `backend\providers\legacy\br_08.py` — heavy top-level import(s): PIL, numpy → *lazy-import inside the function/job that needs them*
- 🟠 🟡 **HL501** `backend\providers\legacy\br_11.py` — heavy top-level import(s): PIL, cv2, numpy → *lazy-import inside the function/job that needs them*
- 🟠 🟡 **HL501** `backend\providers\legacy\br_12.py` — heavy top-level import(s): PIL, cv2, numpy → *lazy-import inside the function/job that needs them*
- 🟠 🟡 **HL501** `backend\providers\legacy\br_13.py` — heavy top-level import(s): PIL, cv2, numpy → *lazy-import inside the function/job that needs them*
- 🟠 🟡 **HL501** `backend\providers\hr\bg_remover.py` — heavy top-level import(s): PIL, numpy → *lazy-import inside the function/job that needs them*
...
- 🟠 🟡 **HL501** `backend\providers\ai\ocr.py` — heavy top-level import(s): PIL, numpy → *lazy-import inside the function/job that needs them*
...
- 🟠 🟡 **HL602** `backend\providers\logistics\geo.py` — external call(s) missing timeout: _lookup_ipapi:108 → *always set timeout; add retry + circuit breaker*
...
- 🟠 🟡 **HL602** `backend\providers\logistics\map.py` — external call(s) missing timeout: resolve_ip:39, reverse_geocode:85 → *always set timeout; add retry + circuit breaker*
...
- 🟠 🟡 **HL602** `backend\middleware\country_context.py` — external call(s) missing timeout: _lookup_country_from_ip:374 → *always set timeout; add retry + circuit breaker*
...
- 🟠 🟡 **HL601** `backend\controllers\finance\payments_controller.py` — sequential external calls: test_payment_gateway_connection (4 calls), create_payment_intent (2 calls), confirm_card_payment (2 calls) → *use asyncio.gather or ThreadPoolExecutor; add timeout + retry*
- 🟠 🟡 **HL602** `backend\controllers\finance\payments_controller.py` — external call(s) missing timeout: test_payment_gateway_connection:1545, create_payment_intent:2299, create_payment_intent:2245, create_stripe_checkout_session:2349, confirm_card_payment:2445, confirm_card_payment:2421 → *always set timeout; add retry + circuit breaker*
...
- 🟠 🟡 **PG102** `backend\utils\realtime.py` — WebSocket handler in Python: connect_order, connect_user, connect_partner → *Python for business logic; Node.js gateway for high-throughput real-time*
...
- 🟠 🟡 **PG103** `backend\routers\country\country_maps.py` — CPU-bound in request path: get_country_map → *offload to worker (Celery/arq) or Node.js worker thread*
...
- 🟠 🟡 **PG102** `backend\routers\communication\ws_chat.py` — WebSocket handler in Python: websocket_chat, websocket_user, connect → *Python for business logic; Node.js gateway for high-throughput real-time*
- 🟠 🟡 **PG102** `backend\routers\admin\command_center.py` — WebSocket handler in Python: connect, websocket_endpoint → *Python for business logic; Node.js gateway for high-throughput real-time*
- 🟠 🟡 **PG102** `backend\routers\admin\command_center_api.py` — WebSocket handler in Python: connect, websocket_endpoint → *Python for business logic; Node.js gateway for high-throughput real-time*
- 🟠 🟡 **PG102** `backend\routers\admin\country_communications.py` — WebSocket handler in Python: websocket_country_notifications, websocket_country_communications → *Python for business logic; Node.js gateway for high-throughput real-time*
...
- 🟠 🟡 **SC101** `backend\routers\supplier\countries.py` — list endpoint(s) missing pagination: list_country_commission_rates → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\supplier\finance.py` — list endpoint(s) missing pagination: get_ledger, get_vat_liability, get_payout_batches, get_cash_position, supplier_earnings_report → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\supplier\supplier_documents.py` — list endpoint(s) missing pagination: list_my_documents, list_all_documents → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\supplier\supplier_finance.py` — list endpoint(s) missing pagination: get_supplier_payout_summary → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\supplier\supplier_health.py` — list endpoint(s) missing pagination: list_supplier_health → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\supplier\supplier_orders.py` — list endpoint(s) missing pagination: list_supplier_orders, get_supplier_label → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\supplier\supplier_payouts.py` — list endpoint(s) missing pagination: list_payouts → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\security\fraud_detection.py` — list endpoint(s) missing pagination: list_blacklist, list_rules, list_review_queue → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\orders\cart.py` — list endpoint(s) missing pagination: get_cart → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\orders\logistics_orders_v2.py` — list endpoint(s) missing pagination: list_my_pickups → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\media\ai_upload.py` — list endpoint(s) missing pagination: get_ai_upload_job → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\logistics\logistics_health.py` — list endpoint(s) missing pagination: list_logistics_health → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\logistics\logistics_locations.py` — list endpoint(s) missing pagination: list_logistics_partner_locations → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\internal\email.py` — list endpoint(s) missing pagination: list_templates, list_campaigns, list_suppressions → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\internal\finance_automation.py` — list endpoint(s) missing pagination: list_rules, statement_lines, list_assets, list_accruals → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\internal\flash_sales.py` — list endpoint(s) missing pagination: list_flash_sales → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\internal\geo.py` — list endpoint(s) missing pagination: list_geo_countries → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\internal\hr_dashboard.py` — list endpoint(s) missing pagination: get_hr_dashboard → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\internal\logistics_orders.py` — list endpoint(s) missing pagination: list_assigned_shipments → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\internal\shop_locations.py` — list endpoint(s) missing pagination: list_shop_locations → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\hr\ess.py` — list endpoint(s) missing pagination: ess_leave_balance, ess_leave_history, ess_payslips, ess_attendance, ess_okrs, ess_org_chart → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\hr\hr.py` — list endpoint(s) missing pagination: list_alumni → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\hr\payroll.py` — list endpoint(s) missing pagination: get_employee_payslips → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\hr\performance.py` — list endpoint(s) missing pagination: coi_check_endpoint → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\finance\finance_erp.py` — list endpoint(s) missing pagination: reconciliation_view, list_budgets → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\external\email_controller.py` — list endpoint(s) missing pagination: list_folders → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\country\country_dropdown.py` — list endpoint(s) missing pagination: get_countries_dropdown, get_categories_dropdown → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\country\country_maps.py` — list endpoint(s) missing pagination: get_country_map → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\country\country_staff.py` — list endpoint(s) missing pagination: list_country_staff, get_my_assigned_countries → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\country\hierarchy.py` — list endpoint(s) missing pagination: list_org_units, user_country_scope, country_localization → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\communication\email_router.py` — list endpoint(s) missing pagination: list_folders → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\communication\push_notifications.py` — list endpoint(s) missing pagination: list_push_tokens → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\communication\tickets.py` — list endpoint(s) missing pagination: get_ticket → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\admin\admin_cash.py` — list endpoint(s) missing pagination: list_accounts → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\admin\admin_fallback.py` — list endpoint(s) missing pagination: admin_logistics_fallback, admin_logistics_partners_fallback, admin_treasury_metrics_fallback → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\admin\admin_promotions.py` — list endpoint(s) missing pagination: list_coupons, list_flash_sales, list_coupons_by_country, list_flash_sales_by_country → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\admin\admin_suppliers.py` — list endpoint(s) missing pagination: list_suppliers_global → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\admin\admin_treasury.py` — list endpoint(s) missing pagination: admin_cash_position, country_cash_position, admin_supplier_earnings, country_supplier_earnings, payroll_equity, country_payroll → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\admin\command_center.py` — list endpoint(s) missing pagination: get_system_metrics → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\admin\command_center_api.py` — list endpoint(s) missing pagination: get_system_metrics → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\admin\country_admin.py` — list endpoint(s) missing pagination: list_staff, list_tax_rates → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\admin\country_communications.py` — list endpoint(s) missing pagination: list_legal_contracts, list_warehouses, list_partner_locations → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\admin\country_payouts.py` — list endpoint(s) missing pagination: list_payout_rule_categories, list_payout_rule_products → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\admin\cross_border.py` — list endpoint(s) missing pagination: get_cross_border_session → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\admin\employees.py` — list endpoint(s) missing pagination: list_employee_addresses, list_employee_dependents, list_leave_requests, list_shifts → *add skip/limit or cursor pagination*
- 🟠 🟡 **SC101** `backend\routers\admin\proxy_communication.py` — list endpoint(s) missing pagination: get_user_channels, admin_list_channels → *add skip/limit or cursor pagination*
...
- 🟡 🟡 **API101** `backend\routers\supplier\supplier_finance.py` — endpoint(s) missing response_model: get_supplier_payout_summary, get_order_payment_status, list_supplier_orders_with_payout_status, get_supplier_bank_account, upsert_supplier_bank_account → *add response_model for type safety and docs*
- 🟡 🟡 **API101** `backend\routers\supplier\supplier_health.py` — endpoint(s) missing response_model: get_supplier_health, list_supplier_health → *add response_model for type safety and docs*
...
- 🟡 🟡 **API101** `backend\routers\supplier\supplier_products.py` — endpoint(s) missing response_model: get_supplier_product, update_product_discount, update_supplier_product, upload_supplier_product_image, delete_supplier_product → *add response_model for type safety and docs*
...
- 🟡 🟡 **API101** `backend\routers\security\risk.py` — endpoint(s) missing response_model: get_risk_score, ghost_employees, impossible_travel, update_risk, team_health, audit_timeline → *add response_model for type safety and docs*
...
- 🟡 🟡 **API101** `backend\routers\media\ai_image.py` — endpoint(s) missing response_model: analyze_image → *add response_model for type safety and docs*
...
- 🟡 🟡 **API101** `backend\routers\logistics\logistics_health.py` — endpoint(s) missing response_model: get_logistics_health, list_logistics_health → *add response_model for type safety and docs*
...
- 🟡 🟡 **API101** `backend\routers\internal\flash_sales.py` — endpoint(s) missing response_model: list_flash_sales, get_flash_sale, create_flash_sale → *add response_model for type safety and docs*
...
- 🟡 🟡 **API101** `backend\routers\internal\geo.py` — endpoint(s) missing response_model: get_geo_info, list_geo_countries → *add response_model for type safety and docs*
...
- 🟡 🟡 **API101** `backend\routers\customer\customer_health.py` — endpoint(s) missing response_model: get_customer_health, list_customer_health → *add response_model for type safety and docs*
...
- 🟡 🟡 **API101** `backend\routers\country\country_maps.py` — endpoint(s) missing response_model: get_country_map, get_country_map_config → *add response_model for type safety and docs*
- 🟡 🟡 **API101** `backend\routers\country\country_staff.py` — endpoint(s) missing response_model: list_country_staff, assign_staff_to_country, update_staff_assignment, remove_staff_from_country, get_my_assigned_countries, list_all_staff_assignments → *add response_model for type safety and docs*
...
- 🟡 🟡 **API101** `backend\routers\communication\tickets.py` — endpoint(s) missing response_model: list_tickets, create_ticket, get_ticket, reply_to_ticket, add_message → *add response_model for type safety and docs*
...
- 🟡 🟡 **API101** `backend\routers\commerce\coupons.py` — endpoint(s) missing response_model: validate_coupon, list_coupons, create_coupon, delete_coupon → *add response_model for type safety and docs*
...
- 🟡 🟡 **API101** `backend\routers\admin\admin_commission.py` — endpoint(s) missing response_model: list_rates, list_badge_tiers → *add response_model for type safety and docs*
- 🟡 🟡 **API101** `backend\routers\admin\admin_email.py` — endpoint(s) missing response_model: admin_email_metrics, list_campaigns, delete_campaign → *add response_model for type safety and docs*
- 🟡 🟡 **API101** `backend\routers\admin\admin_fallback.py` — endpoint(s) missing response_model: admin_dashboard_fallback, admin_stats_fallback, admin_suppliers_fallback, admin_payouts_fallback, admin_categories_fallback, admin_commission_fallback → *add response_model for type safety and docs*
- 🟡 🟡 **API101** `backend\routers\admin\admin_logistics.py` — endpoint(s) missing response_model: list_partners, approve_partner, reject_partner, toggle_partner_active, archive_partner, restore_partner → *add response_model for type safety and docs*
...
- 🟢 🟡 **HL203** `backend\utils\seed_all.py:43` — logging.basicConfig() in module code → *configure once in main; modules use getLogger()*
...
- 🟢 🟡 **HL203** `backend\tools\mcp\mcp_server.py:627` — logging.basicConfig() in module code → *configure once in main; modules use getLogger()*
- 🟢 🟡 **HL203** `backend\tasks\background_tasks.py:44` — logging.basicConfig() in module code → *configure once in main; modules use getLogger()*
...
- 🟢 🟡 **HL203** `backend\scripts\migrate_media_to_s3.py:200` — logging.basicConfig() in module code → *configure once in main; modules use getLogger()*
...
- 🟢 🟡 **HL203** `backend\providers\legacy\br_08.py:52` — logging.basicConfig() in module code → *configure once in main; modules use getLogger()*
...
- 🟢 🟡 **HL203** `backend\providers\legacy\br_11.py:36` — logging.basicConfig() in module code → *configure once in main; modules use getLogger()*
...
- 🟢 🟡 **HL203** `backend\providers\legacy\br_12.py:34` — logging.basicConfig() in module code → *configure once in main; modules use getLogger()*
...
- 🟢 🟡 **HL203** `backend\providers\legacy\br_13.py:29` — logging.basicConfig() in module code → *configure once in main; modules use getLogger()*
...
- 🟢 🟡 **HL203** `backend\location_service\main.py:34` — logging.basicConfig() in module code → *configure once in main; modules use getLogger()*
- 🟢 🟡 **HL203** `backend\jobs\threat_feed_updater.py:8` — logging.basicConfig() in module code → *configure once in main; modules use getLogger()*
...
- 🟢 🟡 **HL302** `backend\utils\seed_all.py` — swallowed exception (lines: 294) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟢 🟡 **HL302** `backend\services\bg_removal_presets.py` — swallowed exception (lines: 530) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟢 🟡 **HL302** `backend\services\finance_automation.py` — swallowed exception (lines: 437) → *log with logger.exception(...); re-raise or return controlled error*
- 🟢 🟡 **HL302** `backend\services\finance_transfer_service.py` — swallowed exception (lines: 1035) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟢 🟡 **HL303** `backend\services\import_service.py` — broad except Exception (lines: 212, 367, 440, 498, 557) → *narrow exception types; always log with context*
...
- 🟢 🟡 **HL302** `backend\services\supplier_badge_service.py` — swallowed exception (lines: 569) → *log with logger.exception(...); re-raise or return controlled error*
- 🟢 🟡 **HL303** `backend\services\trading_service.py` — broad except Exception (lines: 228, 475, 803, 520) → *narrow exception types; always log with context*
...
- 🟢 🟡 **HL303** `backend\services\treasury\automation_scheduler.py` — broad except Exception (lines: 53, 411, 464, 472, 489, 497 +7 more) → *narrow exception types; always log with context*
- 🟢 🟡 **HL303** `backend\services\treasury\auto_payout_scheduler.py` — broad except Exception (lines: 329, 603, 731, 836, 147, 295 +2 more) → *narrow exception types; always log with context*
- 🟢 🟡 **HL303** `backend\services\treasury\cash_management_service.py` — broad except Exception (lines: 1003, 1942, 2078, 738, 1402) → *narrow exception types; always log with context*
- 🟢 🟡 **HL303** `backend\services\treasury\command_center_background.py` — broad except Exception (lines: 368, 382, 56, 100, 155, 216 +3 more) → *narrow exception types; always log with context*
...
- 🟢 🟡 **HL303** `backend\services\supplier\onboarding_pipeline.py` — broad except Exception (lines: 57) → *narrow exception types; always log with context*
...
- 🟢 🟡 **HL302** `backend\services\media\free_image_tools.py` — swallowed exception (lines: 789, 847, 99, 360) → *log with logger.exception(...); re-raise or return controlled error*
- 🟢 🟡 **HL302** `backend\services\media\image_ai_service.py` — swallowed exception (lines: 314) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟢 🟡 **HL303** `backend\services\finance\cash_management_service.py` — broad except Exception (lines: 1003, 1942, 2078, 738, 1402) → *narrow exception types; always log with context*
- 🟢 🟡 **HL303** `backend\services\finance\credit_control_service.py` — broad except Exception (lines: 313, 330) → *narrow exception types; always log with context*
...
- 🟢 🟡 **HL303** `backend\services\finance\payout_batch_service.py` — broad except Exception (lines: 317, 109) → *narrow exception types; always log with context*
...
- 🟢 🟡 **HL303** `backend\services\finance\treasury_adapter.py` — broad except Exception (lines: 79) → *narrow exception types; always log with context*
...
- 🟢 🟡 **HL302** `backend\services\core\misc_write_service.py` — swallowed exception (lines: 81, 73) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟢 🟡 **HL303** `backend\services\communication\chat_enrichment.py` — broad except Exception (lines: 42, 414) → *narrow exception types; always log with context*
...
- 🟢 🟡 **HL302** `backend\services\ai\ai_service.py` — swallowed exception (lines: 809, 283) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟢 🟡 **HL302** `backend\services\ai\bg_removal_service.py` — swallowed exception (lines: 235, 296, 1064, 587) → *log with logger.exception(...); re-raise or return controlled error*
- 🟢 🟡 **HL302** `backend\routers\supplier\supplier.py` — swallowed exception (lines: 816, 1010, 57) → *log with logger.exception(...); re-raise or return controlled error*
- 🟢 🟡 **HL303** `backend\routers\supplier\supplier_bg_ab_test.py` — broad except Exception (lines: 193) → *narrow exception types; always log with context*
- 🟢 🟡 **HL302** `backend\routers\supplier\supplier_orders.py` — swallowed exception (lines: 447, 647, 513) → *log with logger.exception(...); re-raise or return controlled error*
- 🟢 🟡 **HL302** `backend\routers\supplier\supplier_products.py` — swallowed exception (lines: 223) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟢 🟡 **HL302** `backend\routers\internal\email.py` — swallowed exception (lines: 427) → *log with logger.exception(...); re-raise or return controlled error*
- 🟢 🟡 **HL302** `backend\routers\internal\health.py` — swallowed exception (lines: 49, 61, 71) → *log with logger.exception(...); re-raise or return controlled error*
- 🟢 🟡 **HL303** `backend\routers\internal\hr_dashboard.py` — broad except Exception (lines: 55, 115, 164, 213, 232) → *narrow exception types; always log with context*
...
- 🟢 🟡 **HL302** `backend\routers\internal\wishlist.py` — swallowed exception (lines: 26) → *log with logger.exception(...); re-raise or return controlled error*
- 🟢 🟡 **HL303** `backend\routers\hr\performance.py` — broad except Exception (lines: 253, 277) → *narrow exception types; always log with context*
...
- 🟢 🟡 **HL302** `backend\routers\admin\admin_treasury.py` — swallowed exception (lines: 1005) → *log with logger.exception(...); re-raise or return controlled error*
- 🟢 🟡 **HL302** `backend\routers\admin\command_center.py` — swallowed exception (lines: 44, 52, 151, 221, 477, 519 +1 more) → *log with logger.exception(...); re-raise or return controlled error*
- 🟢 🟡 **HL302** `backend\routers\admin\command_center_api.py` — swallowed exception (lines: 56, 64, 176, 246, 502, 544 +1 more) → *log with logger.exception(...); re-raise or return controlled error*
- 🟢 🟡 **HL302** `backend\routers\admin\employees.py` — swallowed exception (lines: 642) → *log with logger.exception(...); re-raise or return controlled error*
- 🟢 🟡 **HL303** `backend\providers\media\image.py` — broad except Exception (lines: 199, 184) → *narrow exception types; always log with context*
- 🟢 🟡 **HL302** `backend\providers\logistics\geo.py` — swallowed exception (lines: 101, 95) → *log with logger.exception(...); re-raise or return controlled error*
- 🟢 🟡 **HL303** `backend\providers\logistics\map.py` — broad except Exception (lines: 102, 53) → *narrow exception types; always log with context*
...
- 🟢 🟡 **HL302** `backend\providers\legacy\br_08.py` — swallowed exception (lines: 655) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟢 🟡 **HL302** `backend\providers\hr\bg_remover.py` — swallowed exception (lines: 86, 210, 297, 1145, 1265, 1613 +1 more) → *log with logger.exception(...); re-raise or return controlled error*
- 🟢 🟡 **HL303** `backend\providers\finance\finance_ai.py` — broad except Exception (lines: 132) → *narrow exception types; always log with context*
...
- 🟢 🟡 **HL302** `backend\providers\ai\ocr.py` — swallowed exception (lines: 45) → *log with logger.exception(...); re-raise or return controlled error*
- 🟢 🟡 **HL303** `backend\providers\ai\text.py` — broad except Exception (lines: 71, 110, 147, 161, 192) → *narrow exception types; always log with context*
- 🟢 🟡 **HL303** `backend\providers\ai\voice_to_text.py` — broad except Exception (lines: 63) → *narrow exception types; always log with context*
...
- 🟢 🟡 **HL302** `backend\middleware\country_context.py` — swallowed exception (lines: 197, 272, 357, 365) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟢 🟡 **HL302** `backend\dependencies\auth.py` — swallowed exception (lines: 192) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟢 🟡 **HL302** `backend\controllers\products_controller.py` — swallowed exception (lines: 139, 154, 164, 180, 189, 1102 +1 more) → *log with logger.exception(...); re-raise or return controlled error*
- 🟢 🟡 **HL302** `backend\controllers\treasury\cash_management_controller.py` — swallowed exception (lines: 872) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🟢 🟡 **HL302** `backend\controllers\finance\payments_controller.py` — swallowed exception (lines: 419, 435, 448, 817, 1592, 2314 +14 more) → *log with logger.exception(...); re-raise or return controlled error*
...
- 🔴 🔴 **SEC101** `backend\utils\error_handler.py` — raw SQL concatenation (lines: 149) → *use parameterized queries / SQLAlchemy ORM*
...
- 🔴 🔴 **SEC105** `backend\tests\test_auth.py` — hardcoded credential (lines: 14, 34) → *move to env vars / Vault / secrets manager*
- 🔴 🔴 **SEC105** `backend\tests\test_security.py` — hardcoded credential (lines: 24) → *move to env vars / Vault / secrets manager*
...
- 🟢 🟡 **HL204** `backend\controllers\finance\payments_controller.py` — possible secret in log (lines: 859) → *never log secrets; log only IDs/status*
- 🔴 🔴 **SEC105** `scripts\testing\ai_image_group_smoke.py` — hardcoded credential (lines: 472) → *move to env vars / Vault / secrets manager*
- 🔴 🔴 **SEC105** `scripts\testing\finance_cycle_smoke.py` — hardcoded credential (lines: 105, 265) → *move to env vars / Vault / secrets manager*
- 🔴 🔴 **SEC105** `scripts\testing\live_order_tracking_smoke.py` — hardcoded credential (lines: 200) → *move to env vars / Vault / secrets manager*

## Domain: documentation

- 🟢 🟡 **HL110** `backend/` — 2779 public functions missing docstrings across 336 files → *By layer: services/ (1149), routers/ (1097), controllers/ (443), providers/ (90). Top files: admin_analytics_service.py, audit_service.py, auth_write_service.py, automation_scheduler.py, banner_write_service.py +331 more. Add docstrings to service layer first.*
...
- 🟢 🟡 **HL801** `backend\services\general_ledger_service.py` — function(s) need timing/metrics: seed_chart_of_accounts (calls=36) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟢 🟡 **HL801** `backend\services\supplier_badge_service.py` — function(s) need timing/metrics: list_supplier_badge_catalog (calls=26), purchase_supplier_badge (calls=46), compute_credibility_score (calls=41), refresh_supplier_badge (calls=31) → *add timing decorator / Prometheus histogram / duration_ms logs*
- 🟢 🟡 **HL801** `backend\services\trading_service.py` — function(s) need timing/metrics: create_purchase_order (calls=38), receive_purchase_order (calls=41), three_way_match (calls=25), create_sales_order (calls=50), dispatch_sales_order (calls=25), auto_invoice_ecommerce_orders (calls=26) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟢 🟡 **HL801** `backend\services\treasury\automation_scheduler.py` — function(s) need timing/metrics: compute_vat_remittance (calls=33), run_full_automation (calls=46) → *add timing decorator / Prometheus histogram / duration_ms logs*
- 🟢 🟡 **HL801** `backend\services\treasury\auto_payout_scheduler.py` — function(s) need timing/metrics: run_auto_payout_sweep (calls=105), run_auto_logistics_payout_sweep (calls=104), _run_once_with_retry (calls=36) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟢 🟡 **HL801** `backend\services\finance\cash_management_service.py` — function(s) need timing/metrics: _record_payment_reconciliation_run (calls=28), _build_order_logistics_allocations (calls=96), _compute_allocation_pricing_breakdown_json (calls=29), apply_shipment_vehicle_selection (calls=97), create_ledger_entries_for_order (calls=91), create_settlements_on_delivery (calls=69) → *add timing decorator / Prometheus histogram / duration_ms logs*
- 🟢 🟡 **HL801** `backend\services\finance\commission_engine.py` — function(s) need timing/metrics: seed_defaults (calls=30), get_effective_rate (calls=36) → *add timing decorator / Prometheus histogram / duration_ms logs*
- 🟢 🟡 **HL801** `backend\services\finance\credit_control_service.py` — function(s) need timing/metrics: check_customer_credit (calls=29) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟢 🟡 **HL801** `backend\services\finance\period_close_service.py` — function(s) need timing/metrics: _transfer_pnl_to_retained_earnings (calls=35) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟢 🟡 **HL801** `backend\services\finance\treasury_service.py` — function(s) need timing/metrics: create_journal_entry (calls=25) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟢 🟡 **HL801** `backend\routers\supplier\finance.py` — function(s) need timing/metrics: get_dashboard_metrics (calls=40), get_vat_liability (calls=29) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟢 🟡 **HL801** `backend\routers\supplier\supplier_finance.py` — function(s) need timing/metrics: get_order_payment_status (calls=48), list_supplier_orders_with_payout_status (calls=47) → *add timing decorator / Prometheus histogram / duration_ms logs*
- 🟢 🟡 **HL801** `backend\routers\supplier\supplier_orders.py` — function(s) need timing/metrics: get_supplier_label (calls=54), upload_parcel_proof (calls=33), verify_parcel_proof (calls=53), replace_reference_image (calls=27), get_parcel_verification_history (calls=29) → *add timing decorator / Prometheus histogram / duration_ms logs*
- 🟢 🟡 **HL801** `backend\routers\supplier\supplier_products.py` — function(s) need timing/metrics: update_product_discount (calls=29), upload_supplier_product_image (calls=29) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟢 🟡 **HL801** `backend\routers\internal\hr_dashboard.py` — function(s) need timing/metrics: get_hr_dashboard (calls=50) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟢 🟡 **HL801** `backend\routers\country\country_maps.py` — function(s) need timing/metrics: get_country_map (calls=26) → *add timing decorator / Prometheus histogram / duration_ms logs*
- 🟢 🟡 **HL801** `backend\routers\country\country_staff.py` — function(s) need timing/metrics: assign_staff_to_country (calls=28) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟢 🟡 **HL801** `backend\routers\admin\command_center.py` — function(s) need timing/metrics: get_dashboard (calls=25), get_dashboard_stats (calls=43), websocket_endpoint (calls=36), get_comprehensive_dashboard (calls=113) → *add timing decorator / Prometheus histogram / duration_ms logs*
- 🟢 🟡 **HL801** `backend\routers\admin\command_center_api.py` — function(s) need timing/metrics: get_dashboard (calls=25), get_dashboard_stats (calls=43), websocket_endpoint (calls=36), get_comprehensive_dashboard (calls=113) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟢 🟡 **HL801** `backend\dependencies\auth.py` — function(s) need timing/metrics: get_current_user (calls=44), get_optional_user (calls=40) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟢 🟡 **HL801** `backend\controllers\treasury\cash_management_controller.py` — function(s) need timing/metrics: _decorate_supplier_settlement (calls=45), admin_list_ledger_entries (calls=44) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟢 🟡 **HL801** `backend\controllers\orders\cart_controller.py` — function(s) need timing/metrics: sync_cart (calls=39), upsert_cart_item (calls=25), get_cart_shipping_quote (calls=31) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟢 🟡 **HL801** `backend\controllers\finance\payments_controller.py` — function(s) need timing/metrics: get_customer_checkout_gateways (calls=25), _serialize_gateway_connection (calls=107), upsert_payment_gateway_connection (calls=38), test_payment_gateway_connection (calls=49), build_payment_finance_quote (calls=44), _build_tap_customer (calls=26) → *add timing decorator / Prometheus histogram / duration_ms logs*
...
- 🟠 🟡 **OB101** `backend/controllers/` — 62 modules missing structured logger → *Add logger = logging.getLogger(__name__). Top: address_controller.py, admin_controller.py, audit_controller.py, categories_controller.py, compliance_controller.py +57 more*
- 🟠 🟡 **OB101** `backend/middleware/` — 5 modules missing structured logger → *Add logger = logging.getLogger(__name__). Top: coi_middleware.py, ip_extraction_middleware.py, rls.py, rls_dependency.py, __init__.py*
- 🟠 🟡 **OB101** `backend/providers/` — 5 modules missing structured logger → *Add logger = logging.getLogger(__name__). Top: __init__.py, check_BiRefNet.py, __init__.py, config.py, __init__.py*
- 🟠 🟡 **OB101** `backend/routers/` — 106 modules missing structured logger → *Add logger = logging.getLogger(__name__). Top: __init__.py, commission.py, countries.py, finance.py, onboarding.py +101 more*
- 🟠 🟡 **OB101** `backend/services/` — 117 modules missing structured logger → *Add logger = logging.getLogger(__name__). Top: admin_analytics_service.py, audit_service.py, auth_write_service.py, bank_transaction_service.py, banner_write_service.py +112 more*
- 🟠 🟡 **OB102** `backend/controllers/` — 82 modules missing request_id / correlation_id → *Add X-Request-ID middleware in main.py (fixes all 82 at once). Top: address_controller.py, admin_controller.py, ai_controller.py, audit_controller.py, categories_controller.py +77 more*
...
- 🟠 🟡 **OB102** `backend/routers/` — 148 modules missing request_id / correlation_id → *Add X-Request-ID middleware in main.py (fixes all 148 at once). Top: __init__.py, payout_approval.py, commission.py, countries.py, finance.py +143 more*
...
- 🟡 🟡 **MR101** `backend\services\treasury\auto_payout_scheduler.py` — nested list comprehension: run_auto_payout_sweep:313, run_auto_logistics_payout_sweep:587 → *use generator expression for large datasets*
...
- 🟡 🟡 **MR104** `backend\controllers\finance\payments_controller.py` — global mutable state: ORDER_PAYMENT_METHOD_GATEWAY_MAP → *use dependency injection / singleton*
