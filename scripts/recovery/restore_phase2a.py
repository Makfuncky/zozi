"""
Recovery script Phase 2: Rebuild models.py, schemas.py, and other core files.
"""
import os, textwrap
...
# ============================================================
# backend/db/models.py  (The big one - all SQLAlchemy models)
# ============================================================
write_file("backend/db/models.py", '''\
